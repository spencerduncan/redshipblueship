...
void RegionTable_Init_ZoraRiver() {
    ...
    areaTable[RR_ZORAS_RIVER] = Region("Zora River", SCENE_ZORAS_RIVER, {
        ...
        Entrance(RR_ZR_ATOP_LADDER,      []{return /*(logic->IsAdult || str0) && */(logic->HasItem(RG_CLIMB) || (logic->IsAdult && logic->CanUse(RG_HOOKSHOT)) || CanPlantBean(RR_ZORAS_RIVER, RG_ZORAS_RIVER_BEAN_SOUL));}),
