...
// OoT build info - prefixed to avoid collision with MM
...
const char OoT_gGitBranch[] = "claude/mm-graphics-window-bridge-2hCzy";
const char OoT_gGitCommitHash[] = "858c0a2";
