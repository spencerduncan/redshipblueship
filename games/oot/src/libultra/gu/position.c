 ...
 */
void OoT_guPositionF(f32 mf[4][4], f32 rot, f32 pitch, f32 yaw, f32 scale, f32 x, f32 y, f32 z) {
 ...
 */
void OoT_guPosition(Mtx* m, f32 rot, f32 pitch, f32 yaw, f32 scale, f32 x, f32 y, f32 z) {
    f32 mf[4][4];

    OoT_guPositionF(mf, rot, pitch, yaw, scale, x, y, z);
