...
void OoT_OceffStorm_Draw2(Actor* thisx, PlayState* play) {
    ...
    gSPDisplayList(POLY_XLU_DISP++, OoT_Gfx_TwoTexScroll(play->state.gfxCtx, 0, scroll * 8, scroll * 4, 64, 64, 1,
...
void OoT_OceffStorm_Draw(Actor* thisx, PlayState* play) {
    ...
    gSPDisplayList(POLY_XLU_DISP++, OoT_Gfx_TwoTexScroll(play->state.gfxCtx, 0, scroll * 4, (0 - scroll) * 8, 32, 32, 1,
