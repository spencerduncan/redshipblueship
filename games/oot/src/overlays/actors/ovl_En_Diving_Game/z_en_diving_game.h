...
typedef struct EnDivingGame {
    ...
    /* 0x02AA */ s16 extraWinCount; // counts how many times you have beaten the minigame **after** you got the scale. ExRuppy will reset it to OoT_zero if a 500 rupee is spawned.
