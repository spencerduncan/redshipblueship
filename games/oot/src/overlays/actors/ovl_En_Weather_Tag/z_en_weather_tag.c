...
void OoT_EnWeatherTag_Init(Actor* thisx, PlayState* play);
void OoT_EnWeatherTag_Destroy(Actor* thisx, PlayState* play);
void OoT_EnWeatherTag_Update(Actor* thisx, PlayState* play);
...
const ActorInit En_Weather_Tag_InitVars = {
    ...
    sizeof(EnWeatherTag),
    (ActorFunc)OoT_EnWeatherTag_Init,
    (ActorFunc)OoT_EnWeatherTag_Destroy,
    (ActorFunc)OoT_EnWeatherTag_Update,
    NULL,
    NULL,
};

void OoT_EnWeatherTag_SetupAction(EnWeatherTag* this, EnWeatherTagActionFunc actionFunc) {
...
void OoT_EnWeatherTag_Init(Actor* thisx, PlayState* play) {
    ...
    switch (this->actor.params & 0xF) {
        case EN_WEATHER_TAG_TYPE_CLOUDY_MARKET:
            ...
            OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_DisabledCloudyHyruleMarket);
            break;
        case EN_WEATHER_TAG_TYPE_CLOUDY_LON_LON_RANCH:
            ...
            OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_DisabledCloudyLonLonRanch);
            break;
        case EN_WEATHER_TAG_TYPE_SNOW_ZORAS_DOMAIN:
            ...
            OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_DisabledCloudySnow);
            break;
        case EN_WEATHER_TAG_TYPE_RAIN_LAKE_HYLIA:
            ...
            OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_DisabledRainLakeHylia);
            break;
        case EN_WEATHER_TAG_TYPE_CLOUDY_DEATH_MOUNTAIN:
            ...
            OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_DisabledCloudyDeathMountain);
            break;
        case EN_WEATHER_TAG_TYPE_THUNDERSTORM_KAKARIKO:
            ...
            OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_DisabledCloudyRainThunderKakariko);
            break;
        case EN_WEATHER_TAG_TYPE_SANDSTORM_INTENSITY:
            osSyncPrintf("\n\n");
            // "☆☆☆☆☆ The desert becomes thicker ☆☆☆☆☆"
            osSyncPrintf(VT_FGCOL(YELLOW) "☆☆☆☆☆ 砂漠が濃くなります ☆☆☆☆☆ \n" VT_RST);
            OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_SetSandstormIntensity);
            break;
        case EN_WEATHER_TAG_TYPE_THUNDERSTORM_GRAVEYARD:
            ...
            OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_DisabledRainThunder);
            break;
    }
}
...
u8 WeatherTag_CheckEnableWeatherEffect(EnWeatherTag* this, PlayState* play, u8 arg2, u8 arg3, u8 arg4, u8 arg5,
    ...
    if (OoT_Actor_WorldDistXZToActor(&player->actor, &this->actor) < WEATHER_TAG_RANGE100(this->actor.params)) {
        if ((play->envCtx.indoors != 0) || !gSkyboxBlendingEnabled ||
            ...
            if (play->envCtx.gloomySkyMode == 0 &&
                ...
                D_8011FB38 = 0;
                if (OoT_gWeatherMode != weatherMode) {
                    OoT_gWeatherMode = weatherMode;
                    if (play->envCtx.gloomySkyMode == 0) {
...
u8 WeatherTag_CheckRestoreWeather(EnWeatherTag* this, PlayState* play, u8 arg2, u8 arg3, u8 arg4, u8 arg5, u16 arg6) {
    ...
    if ((WEATHER_TAG_RANGE100(this->actor.params) + 100.0f) < OoT_Actor_WorldDistXZToActor(&player->actor, &this->actor)) {
        if (play->envCtx.indoors != 0 || !gSkyboxBlendingEnabled ||
            (play->skyboxId != SKYBOX_NORMAL_SKY && play->envCtx.unk_1F == play->envCtx.unk_20)) {
            D_8011FB38 = 1;
            if ((play->envCtx.gloomySkyMode == 0) &&
...
void EnWeatherTag_DisabledCloudyHyruleMarket(EnWeatherTag* this, PlayState* play) {
    if (WeatherTag_CheckEnableWeatherEffect(this, play, 0, 1, 0, 3, 60, 1)) {
        OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_EnabledCloudyHyruleMarket);
    }
}
...
void EnWeatherTag_DisabledCloudyLonLonRanch(EnWeatherTag* this, PlayState* play) {
    if (WeatherTag_CheckEnableWeatherEffect(this, play, 0, 1, 0, 2, 100, 2)) {
        OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_EnabledCloudyLonLonRanch);
    }
}
...
void EnWeatherTag_DisabledCloudyDeathMountain(EnWeatherTag* this, PlayState* play) {
    if (WeatherTag_CheckEnableWeatherEffect(this, play, 0, 1, 0, 2, 60, 2)) {
        OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_EnabledCloudyDeathMountain);
    }
}
...
void EnWeatherTag_DisabledCloudySnow(EnWeatherTag* this, PlayState* play) {
    if (WeatherTag_CheckEnableWeatherEffect(this, play, 0, 1, 0, 2, 60, 3)) {
        ...
        OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_EnabledCloudySnow);
    }
}
...
void EnWeatherTag_DisabledRainLakeHylia(EnWeatherTag* this, PlayState* play) {
    if (WeatherTag_CheckEnableWeatherEffect(this, play, 0, 1, 0, 2, 100, 4)) {
        ...
        OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_EnabledRainLakeHylia);
    }
}
...
void EnWeatherTag_DisabledCloudyRainThunderKakariko(EnWeatherTag* this, PlayState* play) {
    if (WeatherTag_CheckEnableWeatherEffect(this, play, 0, 1, 0, 4, 100, 5)) {
        ...
        OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_EnabledCloudyRainThunderKakariko);
    }
}
...
void EnWeatherTag_SetSandstormIntensity(EnWeatherTag* this, PlayState* play) {
    ...
    if (OoT_Actor_WorldDistXZToActor(&player->actor, &this->actor) < WEATHER_TAG_RANGE100(this->actor.params)) {
        OoT_Math_SmoothStepToS(&play->envCtx.adjFogNear, -0x50, 1, 2, 1);
        OoT_Math_SmoothStepToS(&play->envCtx.adjFogFar, -0x7D0, 1, 50, 1);
    } else {
        OoT_Math_SmoothStepToS(&play->envCtx.adjFogNear, 0, 1, 1, 1);
        OoT_Math_SmoothStepToS(&play->envCtx.adjFogFar, 0, 1, 25, 1);
    }
}
...
void EnWeatherTag_DisabledRainThunder(EnWeatherTag* this, PlayState* play) {
    ...
    if (OoT_Actor_WorldDistXZToActor(&player->actor, &this->actor) < WEATHER_TAG_RANGE100(this->actor.params)) {
        ...
        play->envCtx.lightningMode = LIGHTNING_MODE_ON;
        play->envCtx.unk_EE[0] = 25;
        OoT_EnWeatherTag_SetupAction(this, EnWeatherTag_EnabledRainThunder);
    }
}
...
void EnWeatherTag_EnabledRainThunder(EnWeatherTag* this, PlayState* play) {
    ...
    if ((WEATHER_TAG_RANGE100(this->actor.params) + 10.0f) < OoT_Actor_WorldDistXZToActor(&player->actor, &this->actor)) {
        OoT_Environment_StopStormNatureAmbience(play);
        play->envCtx.lightningMode = LIGHTNING_MODE_LAST;
        play->envCtx.unk_EE[0] = 0;
