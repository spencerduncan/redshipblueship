...
void EnVbBall_Init(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.params >= 200) { // Volvagia's bones
        this->yRotVel = OoT_Rand_CenteredFloat(0x300);
        this->xRotVel = OoT_Rand_CenteredFloat(0x300);
        angle = OoT_Math_FAtan2F(this->actor.world.pos.x, this->actor.world.pos.z);
        this->actor.velocity.y = OoT_Rand_ZeroFloat(3.0f);
        ...
        OoT_Actor_SetScale(&this->actor, this->actor.world.rot.z / 10000.0f);
        ...
        this->xRotVel = OoT_Rand_CenteredFloat(0x2000);
        this->yRotVel = OoT_Rand_CenteredFloat(0x2000);
...
void EnVbBall_UpdateBones(EnVbBall* this, PlayState* play) {
    ...
    if ((this->actor.bgCheckFlags & 1) && (this->actor.velocity.y <= 0.0f)) {
        this->xRotVel = OoT_Rand_CenteredFloat((f32)0x4000);
        this->yRotVel = OoT_Rand_CenteredFloat((f32)0x4000);
        angle = OoT_Math_FAtan2F(this->actor.world.pos.x, this->actor.world.pos.z);
        this->actor.velocity.x = sinf(angle) * 10.0f;
        this->actor.velocity.z = cosf(angle) * 10.0f;
        this->actor.velocity.y *= -0.5f;
        if (this->actor.params & 1) {
            Audio_PlaySoundGeneral(NA_SE_EN_VALVAISA_LAND, &this->actor.projectedPos, 4, &OoT_gSfxDefaultFreqAndVolScale,
        ...
        for (i = 0; i < 10; i++) {
            ...
            dustVel.x = OoT_Rand_CenteredFloat(8.0f);
            dustVel.y = OoT_Rand_ZeroFloat(1.0f);
            dustVel.z = OoT_Rand_CenteredFloat(8.0f);

            dustAcc.y = 0.3f;

            dustPos.x = OoT_Rand_CenteredFloat(20.0f) + this->actor.world.pos.x;
            dustPos.y = this->actor.floorHeight + 10.0f;
            dustPos.z = OoT_Rand_CenteredFloat(20.0f) + this->actor.world.pos.z;

            EnVbBall_SpawnDust(play, bossFd->effects, &dustPos, &dustVel, &dustAcc, OoT_Rand_ZeroFloat(80.0f) + 200.0f);
        }
    }
...
void EnVbBall_Update(Actor* thisx, PlayState* play2) {
    ...
    if (this->actor.params >= 200) {
        ...
        OoT_Math_ApproachF(&this->shadowOpacity, 175.0f, 1.0f, 40.0f);
        ...
        if ((this->actor.bgCheckFlags & 1) && (this->actor.velocity.y <= 0.0f)) {
            if ((this->actor.params == 100) || (this->actor.params == 101)) {
                ...
                for (i = 0; i < spawnNum; i++) {
                    ...
                    if (this->actor.params == 100) {
                        spawnOffset.x = OoT_Rand_CenteredFloat(13.0f);
                        spawnOffset.y = OoT_Rand_ZeroFloat(5.0f) + 6.0f;
                        spawnOffset.z = OoT_Rand_CenteredFloat(13);
                    } else {
                        spawnOffset.x = OoT_Rand_CenteredFloat(10.0f);
                        spawnOffset.y = OoT_Rand_ZeroFloat(3.0f) + 4.0f;
                        spawnOffset.z = OoT_Rand_CenteredFloat(10.0f);
                    }
                    newActor = (EnVbBall*)OoT_Actor_SpawnAsChild(
                ...
                for (i = 0; i < 15; i++) {
                    ...
                    debrisVel1.x = OoT_Rand_CenteredFloat(25.0f);
                    debrisVel1.y = OoT_Rand_ZeroFloat(5.0f) + 8;
                    debrisVel1.z = OoT_Rand_CenteredFloat(25.0f);

                    debrisPos1.x = OoT_Rand_CenteredFloat(10.0f) + this->actor.world.pos.x;
                    debrisPos1.y = OoT_Rand_CenteredFloat(10.0f) + this->actor.world.pos.y;
                    debrisPos1.z = OoT_Rand_CenteredFloat(10.0f) + this->actor.world.pos.z;

                    EnVbBall_SpawnDebris(play, bossFd->effects, &debrisPos1, &debrisVel1, &debrisAcc1,
                                         (s16)OoT_Rand_ZeroFloat(12.0f) + 15);
                }
                for (i = 0; i < 10; i++) {
                    Vec3f dustVel = { 0.0f, 0.0f, 0.0f };
                    Vec3f dustAcc = { 0.0f, 0.0f, 0.0f };
                    ...
                    dustPos.x = OoT_Rand_CenteredFloat(30.0f) + this->actor.world.pos.x;
                    dustPos.y = OoT_Rand_CenteredFloat(30.0f) + this->actor.world.pos.y;
                    dustPos.z = OoT_Rand_CenteredFloat(30.0f) + this->actor.world.pos.z;

                    EnVbBall_SpawnDust(play, bossFd->effects, &dustPos, &dustVel, &dustAcc,
                                       OoT_Rand_ZeroFloat(100.0f) + 350.0f);
                }
            } else {
                for (i = 0; i < 5; i++) {
                    ...
                    debrisVel2.x = OoT_Rand_CenteredFloat(10.0f);
                    debrisVel2.y = OoT_Rand_ZeroFloat(3.0f) + 3.0f;
                    debrisVel2.z = OoT_Rand_CenteredFloat(10.0f);

                    debrisPos2.x = OoT_Rand_CenteredFloat(5.0f) + this->actor.world.pos.x;
                    debrisPos2.y = OoT_Rand_CenteredFloat(5.0f) + this->actor.world.pos.y;
                    debrisPos2.z = OoT_Rand_CenteredFloat(5.0f) + this->actor.world.pos.z;
...
void EnVbBall_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.params >= 200) {
        ...
        OoT_Matrix_Translate(this->actor.world.pos.x, 100.0f, this->actor.world.pos.z, MTXMODE_NEW);
        OoT_Matrix_Scale(this->shadowSize, 1.0f, this->shadowSize, MTXMODE_APPLY);
