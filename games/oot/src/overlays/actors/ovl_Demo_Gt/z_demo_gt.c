...
void DemoGt_Draw1(DemoGt* this, PlayState* play) {
    ...
    gSPSegment(POLY_OPA_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEnvColorEx(gfxCtx, 0, 0, unk198[0], 0x20, 0x40, 1, 0, unk198[1], 0x20, 0x40, unk178[0],
                                          unk178[1], unk178[2], 0x80, 0, unk198[0] < 0 ? -1 : 1, 0,
                                          unk198[1] < 0 ? -1 : 1));
    gSPSegment(POLY_OPA_DISP++, 0x0A,
               OoT_Gfx_TwoTexScrollEnvColorEx(gfxCtx, 0, 0, unk198[0], 0x20, 0x40, 1, 0, unk198[1], 0x20, 0x40, unk188[0],
    ...
    gSPSegment(POLY_XLU_DISP++, 0x09,
               OoT_Gfx_TwoTexScrollEx(gfxCtx, 0, 0, gameplayFrames * 0x14, 0x10, 0x200, 1, 0, gameplayFrames * 0x1E, 0x10,
                                  0x200, 0, 0x14, 0, 0x1E));
