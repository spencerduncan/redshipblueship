...
void func_808BA018(BgTokiHikari* this, PlayState* play) {
    ...
    if (LINK_IS_ADULT) {
        ...
        gSPSegment(POLY_XLU_DISP++, 8,
                   OoT_Gfx_TexScrollEx(play->state.gfxCtx, 0, play->gameplayFrames % 128, 64, 32, 0, 1));
...
void func_808BA2CC(BgTokiHikari* this, PlayState* play) {
    ...
    gSPSegment(POLY_XLU_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, -2 * (play->gameplayFrames & 0x7F), 0, 0x20, 0x40, 1,
