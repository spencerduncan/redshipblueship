...
void OoT_EnTorch_Init(Actor* thisx, PlayState* play);
...
void OoT_EnTorch_Init(Actor* thisx, PlayState* play) {
    ...
    OoT_Actor_Spawn(&play->actorCtx, play, ACTOR_EN_BOX, this->actor.world.pos.x, this->actor.world.pos.y,
                this->actor.world.pos.z, 0, this->actor.shape.rot.y, 0,
                (OoT_sChestContents[(returnData >> 0x5) & 0x7] << 0x5) | 0x5000 | (returnData & 0x1F), true);
