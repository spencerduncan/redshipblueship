...
void OoT_EnMThunder_Draw(Actor* thisx, PlayState* play2) {
    ...
    switch (this->unk_1C6) {
        ...
        case 1:
            gSPSegment(POLY_XLU_DISP++, 0x08,
                       OoT_Gfx_TwoTexScroll(play->state.gfxCtx, 0, 0xFF - ((u8)(s32)(this->unk_1B4 * 30) & 0xFF), 0, 0x40,
    ...
    gSPSegment(POLY_XLU_DISP++, 0x09,
               OoT_Gfx_TwoTexScroll(play->state.gfxCtx, 0, (play->gameplayFrames * 5) & 0xFF, 0, 0x20, 0x20, 1,
