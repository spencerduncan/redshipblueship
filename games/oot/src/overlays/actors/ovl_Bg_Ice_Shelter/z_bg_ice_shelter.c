    ...
    switch ((this->dyna.actor.params >> 8) & 7) {
        ...
        case 4:
            gSPSegment(POLY_XLU_DISP++, 0x08,
                       OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, -play->gameplayFrames & 0x7F,
        ...
        case 2:
            gSPSegment(POLY_XLU_DISP++, 0x08,
                       OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0, play->gameplayFrames & 0xFF, 0x40, 0x40, 1, 0,
                                          -play->gameplayFrames & 0xFF, 0x40, 0x40, 0, 1, 0, -1));
            gSPSegment(POLY_XLU_DISP++, 0x09,
                       OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, -play->gameplayFrames & 0xFF,
