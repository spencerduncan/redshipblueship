...
void EnBdfire_Init(Actor* thisx, PlayState* play) {
    ...
    OoT_Actor_SetScale(&this->actor, 0.6f);
    ...
    if (this->actor.params < 0) {
        ...
        this->lightNode = OoT_LightContext_InsertLight(play, &play->lightCtx, &this->lightInfoNoGlow);
    } else {
        ...
        this->unk_156 = (OoT_Rand_ZeroOne() * 8.0f);
    }
}
...
void func_809BC2A4(EnBdfire* this, PlayState* play) {
    ...
    if (kingDodongo->unk_1E2 == 0) {
        OoT_Math_SmoothStepToF(&this->actor.scale.x, 0.0f, 1.0f, 0.6f, 0.0f);
        if (OoT_Math_SmoothStepToF(&this->unk_18C, 0.0f, 1.0f, 20.0f, 0.0f) == 0.0f) {
            OoT_Actor_Kill(&this->actor);
        }
    } else {
        if (this->unk_154 < 70) {
            OoT_Math_SmoothStepToF(&this->unk_18C, 128.0f, 0.1f, 1.5f, 0.0f);
            OoT_Math_SmoothStepToF(&this->unk_190, 255.0f, 1.0f, 3.8249998f, 0.0f);
            OoT_Math_SmoothStepToF(&this->unk_194, 100.0f, 1.0f, 1.5f, 0.0f);
        }
        if (this->unk_154 == 0) {
            temp = 0;
        } else {
        ...
        if (temp == 0) {
            OoT_Math_SmoothStepToF(&this->actor.scale.x, 0.0f, 1.0f, 0.3f, 0.0f);
            OoT_Math_SmoothStepToF(&this->unk_190, 0.0f, 1.0f, 25.5f, 0.0f);
            OoT_Math_SmoothStepToF(&this->unk_194, 0.0f, 1.0f, 10.0f, 0.0f);
            if (OoT_Math_SmoothStepToF(&this->unk_18C, 0.0f, 1.0f, 10.0f, 0.0f) == 0.0f) {
                OoT_Actor_Kill(&this->actor);
            }
        }
        OoT_Actor_SetScale(&this->actor, this->actor.scale.x);
        OoT_Lights_PointSetColorAndRadius(&this->lightInfoNoGlow, this->unk_190, this->unk_194, 0, 300);
    }
}
...
void func_809BC598(EnBdfire* this, PlayState* play) {
    ...
    OoT_Math_SmoothStepToF(&this->actor.scale.x, this->unk_188, 0.3f, 0.5f, 0.0f);
    OoT_Actor_SetScale(&this->actor, this->actor.scale.x);
    ...
    if (temp == 0) {
        OoT_Math_SmoothStepToF(&this->unk_18C, 0.0f, 1.0f, 10.0f, 0.0f);
...
void EnBdfire_DrawFire(EnBdfire* this, PlayState* play) {
    ...
    OoT_Matrix_Translate(0.0f, 11.0f, 0.0f, MTXMODE_APPLY);
