...
s32 EnBw_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx, Gfx** gfx) {
    ...
    if (limbIndex == 1) {
        gSPSegment((*gfx)++, 0x09,
                   OoT_Gfx_TwoTexScroll(play->state.gfxCtx, 0, 0, 0, 0x20, 0x20, 1, 0, this->unk_23A, 0x20, 0x20));
...
void EnBw_Draw(Actor* thisx, PlayState* play2) {
    ...
    gSPSegment(POLY_XLU_DISP++, 0x08,
               OoT_Gfx_TwoTexScroll(play->state.gfxCtx, 0, 0, 0, 0x20, 0x40, 1, 0, (play->gameplayFrames * -20) % 0x200,
                                0x20, 0x80));
