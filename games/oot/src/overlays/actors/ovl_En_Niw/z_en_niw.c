...
void OoT_EnNiw_Init(Actor* thisx, PlayState* play);
void OoT_EnNiw_Destroy(Actor* thisx, PlayState* play);
void OoT_EnNiw_Update(Actor* thisx, PlayState* play);
void OoT_EnNiw_Draw(Actor* thisx, PlayState* play);
void OoT_EnNiw_Reset(void);
...
const ActorInit En_Niw_InitVars = {
    ...
    OBJECT_NIW,
    sizeof(EnNiw),
    (ActorFunc)OoT_EnNiw_Init,
    (ActorFunc)OoT_EnNiw_Destroy,
    (ActorFunc)OoT_EnNiw_Update,
    (ActorFunc)OoT_EnNiw_Draw,
    (ActorResetFunc)OoT_EnNiw_Reset,
};
...
void OoT_EnNiw_Init(Actor* thisx, PlayState* play) {
    ...
    OoT_Math_Vec3f_Copy(&this->unk_2AC, &this->actor.world.pos);
    OoT_Math_Vec3f_Copy(&this->unk_2B8, &this->actor.world.pos);
    this->unk_304 = 10.0f;
    OoT_Actor_SetScale(&this->actor, 0.01f);
    this->unk_2A4 = (s16)OoT_Rand_ZeroFloat(3.99f) + 5;
    ...
    switch (this->actor.params) {
        ...
        case 0xD:
        case 0xE:
            OoT_Collider_SetCylinder(play, &this->collider, &this->actor, &OoT_sCylinderInit2);
            if (play->sceneNum == SCENE_LINKS_HOUSE && !OoT_Flags_GetEventChkInf(EVENTCHKINF_WON_COW_IN_MALONS_RACE)) {
                OoT_Actor_Kill(&this->actor);
            }
            break;
        default:
            OoT_Collider_SetCylinder(play, &this->collider, &this->actor, &OoT_sCylinderInit1);
            break;
    }
...
void func_80AB5BF8(EnNiw* this, PlayState* play, s16 arg2) {
    ...
    if (this->timer1 == 0) {
        ...
        if (!(this->unk_298 & 1)) {
            ...
            if (arg2 == 0) {
                this->timer1 = OoT_Rand_ZeroFloat(30.0f);
            }
        }
    }
    if (this->timer2 == 0) {
    ...
    if (this->unk_2E0 != this->unk_26C[9]) {
        OoT_Math_ApproachF(&this->unk_2E0, this->unk_26C[9], 0.5f, 4000.0f);
    }
    if (this->unk_2DC != this->unk_26C[0]) {
        OoT_Math_ApproachF(&this->unk_2DC, this->unk_26C[0], 0.5f, 4000.0f);
    }
    if (this->unk_2C4 != this->unk_26C[2]) {
        OoT_Math_ApproachF(&this->unk_2C4, this->unk_26C[2], 0.8f, 7000.0f);
    }
    if (this->unk_2C8 != this->unk_26C[7]) {
        OoT_Math_ApproachF(&this->unk_2C8, this->unk_26C[7], 0.8f, 7000.0f);
    }
    if (this->unk_2CC != this->unk_26C[8]) {
        OoT_Math_ApproachF(&this->unk_2CC, this->unk_26C[8], 0.8f, 7000.0f);
    }
    if (this->unk_2D0 != this->unk_26C[1]) {
        OoT_Math_ApproachF(&this->unk_2D0, this->unk_26C[1], 0.8f, 7000.0f);
    }
    if (this->unk_2D4 != this->unk_26C[5]) {
        OoT_Math_ApproachF(&this->unk_2D4, this->unk_26C[5], 0.8f, 7000.0f);
    }
    if (this->unk_2D8 != this->unk_26C[6]) {
        OoT_Math_ApproachF(&this->unk_2D8, this->unk_26C[6], 0.8f, 7000.0f);
    }
}
...
void EnNiw_SpawnAttackCucco(EnNiw* this, PlayState* play) {
    ...
    if ((this->timer5 == 0) && (this->unk_296 < 7)) {
        ...
        attackCuccoPos.x = ((OoT_Rand_ZeroOne() - 0.5f) * viewX) + play->view.eye.x;
        attackCuccoPos.y = OoT_Rand_CenteredFloat(0.3f) + ((play->view.eye.y + 50.0f) + (viewY * 0.5f));
        attackCuccoPos.z = ((OoT_Rand_ZeroOne() - 0.5f) * viewZ) + play->view.eye.z;
        attackCucco = OoT_Actor_SpawnAsChild(&play->actorCtx, &this->actor, play, ACTOR_EN_ATTACK_NIW, attackCuccoPos.x,
...
void func_80AB6100(EnNiw* this, PlayState* play, s32 arg2) {
    ...
    OoT_Math_SmoothStepToS(&this->actor.world.rot.y, targetRotY, 3, this->unk_2FC, 0);
    OoT_Math_ApproachF(&this->unk_2FC, 3000.0f, 1.0f, 500.0f);
...
void func_80AB6324(EnNiw* this, PlayState* play) {
    if (this->unk_308 != 0) {
        this->actor.velocity.y = OoT_Rand_ZeroFloat(2.0f) + 4.0f;
        this->actor.speedXZ = OoT_Rand_ZeroFloat(2.0f) + 3.0f;
...
void func_80AB6450(EnNiw* this, PlayState* play) {
    ...
    if (this->actor.xzDistToPlayer < 30.0f && fabsf(this->actor.world.pos.y - player->actor.world.pos.y) < 5.0f) {
    ...
    } else if (OoT_Actor_HasParent(&this->actor, play)) {
        this->actor.gravity = -2.0f;
        ...
        OoT_Actor_OfferGetItem(&this->actor, play, GI_NONE, 25.0f, 10.0f);
        func_80AB5BF8(this, play, 1);
    }
}
...
void func_80AB6570(EnNiw* this, PlayState* play) {
    s32 pad[2];
    f32 posY = OoT_Rand_CenteredFloat(100.0f);
    f32 posZ = OoT_Rand_CenteredFloat(100.0f);
    s16 tmp;
    ...
    if (this->actor.params != 0xA) {
        ...
        if (this->path != 0) {
            ...
            this->unk_2A0 = OoT_Rand_ZeroFloat(1.99f);
    ...
    if (this->timer5 != 0) {
        ...
        OoT_Math_ApproachF(&this->unk_26C[9], D_80AB8604[this->unk_2E6], 0.5f, 4000.0f);
    }
    ...
    if (this->timer5 == 0 && this->timer4 == 0) {
        ...
        if (this->unk_29E >= 8) {
            this->timer5 = OoT_Rand_ZeroFloat(30.0f);
            this->unk_29E = OoT_Rand_ZeroFloat(3.99f);
            if (this->actor.params != 0xA && this->actor.params != 8) {
                ...
                posY = OoT_Rand_CenteredFloat(30.0f);
                posZ = OoT_Rand_CenteredFloat(30.0f);
                if (posY < 0.0f) {
                    posY -= 20.0f;
                } else {
                    posY += 20.0f;
    ...
    if (this->timer4 != 0) {
        OoT_Math_ApproachZeroF(&this->unk_26C[9], 0.5f, 4000.0f);
        tmp = 1;
        OoT_Math_ApproachF(&this->actor.world.pos.x, this->unk_2B8.x, 1.0f, this->unk_2FC);
        OoT_Math_ApproachF(&this->actor.world.pos.z, this->unk_2B8.z, 1.0f, this->unk_2FC);
        OoT_Math_ApproachF(&this->unk_2FC, 3.0f, 1.0f, 0.3f);
        ...
        OoT_Math_SmoothStepToS(&this->actor.world.rot.y, OoT_Math_FAtan2F(posY, posZ) * (0x8000 / M_PI), 3, this->unk_300, 0);
        OoT_Math_ApproachF(&this->unk_300, 10000.0f, 1.0f, 1000.0f);
    }
...
void func_80AB6A38(EnNiw* this, PlayState* play) {
    ...
    if (this->path == 0) {
        ...
        this->unk_2E4 = OoT_Math_FAtan2F(pathDiffX, pathDiffZ) * (0x8000 / M_PI);
...
void func_80AB6BF8(EnNiw* this, PlayState* play) {
    ...
    this->actor.shape.rot.x = OoT_Rand_CenteredFloat(5000.0f);
    this->actor.shape.rot.y = OoT_Rand_CenteredFloat(5000.0f);
    this->actor.shape.rot.z = OoT_Rand_CenteredFloat(5000.0f);
...
void func_80AB6F04(EnNiw* this, PlayState* play) {
    ...
    if (this->actor.bgCheckFlags & 0x20) {
        ...
        if (this->timer4 == 0) {
            ...
            OoT_EffectSsGRipple_Spawn(play, &pos, 100, 500, 30);
        }
...
void func_80AB7328(EnNiw* this, PlayState* play) {
    ...
    if (this->timer6 == 0) {
        ...
        this->unk_2E4 = OoT_Math_FAtan2F(this->actor.world.pos.x - player->actor.world.pos.x,
...
void OoT_EnNiw_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_2A6) {
        ...
        for (i = 0; i < featherCount; i++) {
            pos.x = OoT_Rand_CenteredFloat(10.0f) + thisx->world.pos.x;
            pos.y = OoT_Rand_CenteredFloat(10.0f) + (thisx->world.pos.y + this->unk_304);
            pos.z = OoT_Rand_CenteredFloat(10.0f) + thisx->world.pos.z;
            scale = OoT_Rand_ZeroFloat(6.0f) + 6.0f;

            if (this->unk_2A6 == 2 && this->unk_304 != 0) {
                pos.y += 10;
            }
            if (this->unk_304 == 0) {
                scale = OoT_Rand_ZeroFloat(2.0f) + 2;
            }

            vel.x = OoT_Rand_CenteredFloat(3.0f);
            vel.y = (OoT_Rand_ZeroFloat(2.0f) * 0.5f) + 2.0f;
            vel.z = OoT_Rand_CenteredFloat(3.0f);
            accel.x = 0.0f;
            accel.y = -0.15f;
            accel.z = 0.0f;
    ...
    OoT_Actor_SetFocus(&this->actor, this->unk_304);
    Actor_MoveXZGravity(&this->actor);

    if (this->actionFunc != func_80AB6EB4 && this->actionFunc != func_80AB6450 && play->sceneNum != SCENE_ZORAS_RIVER) {
        OoT_Actor_UpdateBgCheckInfo(play, &this->actor, 20.0f, 20.0f, 60.0f, 31);
    }
    if (play->sceneNum == SCENE_ZORAS_RIVER) {
        OoT_Actor_UpdateBgCheckInfo(play, &this->actor, 20.0f, 20.0f, 60.0f, 29);
    }
    if (thisx->floorHeight <= BGCHECK_Y_MIN || thisx->floorHeight >= 32000.0f) {
        ...
        thisx->speedXZ = 0.0f;
        thisx->gravity = -2.0f;
        OoT_Math_Vec3f_Copy(&this->unk_2AC, &thisx->home.pos);
        OoT_Math_Vec3f_Copy(&this->unk_2B8, &thisx->home.pos);
        this->unk_300 = 0.0f;
        this->unk_2FC = 0.0f;
        this->unk_2F0.z = 0.0f;
        this->unk_2F0.y = 0.0f;
    ...
    if (thisx->bgCheckFlags & 0x20 && thisx->yDistToWater > 15.0f && this->actionFunc != func_80AB6F04 &&
        ...
        thisx->gravity = 0.0f;
        OoT_Math_Vec3f_Copy(&pos, &thisx->world.pos);
...
s32 OoT_EnNiw_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx) {
    EnNiw* this = (EnNiw*)thisx;
...
void OoT_EnNiw_Draw(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_DrawSkeletonOpa(play, &this->skelAnime, OoT_EnNiw_OverrideLimbDraw, NULL, this);
...
void EnNiw_FeatherSpawn(EnNiw* this, Vec3f* pos, Vec3f* vel, Vec3f* accel, f32 scale) {
    ...
    for (i = 0; i < ARRAY_COUNT(this->feathers); i++, feather++) {
        if (feather->type == 0) {
            ...
            feather->life = (s16)OoT_Rand_ZeroFloat(20.0f) + 40;
            feather->unk_2A = OoT_Rand_ZeroFloat(1000.0f);
            break;
        }
    }
}
...
void EnNiw_FeatherUpdate(EnNiw* this, PlayState* play) {
    ...
    for (i = 0; i < ARRAY_COUNT(this->feathers); i++, feather++) {
        if (feather->type != 0) {
            ...
            if (feather->type == 1) {
                feather->unk_2A++;
                OoT_Math_ApproachF(&feather->vel.x, 0.0f, 1.0f, 0.05f);
                OoT_Math_ApproachF(&feather->vel.z, 0.0f, 1.0f, 0.05f);
                if (feather->vel.y < -0.5f) {
                    feather->vel.y = -0.5f;
                }

                feather->unk_30 = OoT_Math_SinS(feather->unk_2A * 0xBB8) * M_PI * 0.2f;
...
void EnNiw_FeatherDraw(EnNiw* this, PlayState* play) {
    ...
    for (i = 0; i < ARRAY_COUNT(this->feathers); i++, feather++) {
        if (feather->type == 1) {
            ...
            OoT_Matrix_Translate(feather->pos.x, feather->pos.y, feather->pos.z, MTXMODE_NEW);
            OoT_Matrix_ReplaceRotation(&play->billboardMtxF);
            OoT_Matrix_Scale(feather->scale, feather->scale, 1.0f, MTXMODE_APPLY);
