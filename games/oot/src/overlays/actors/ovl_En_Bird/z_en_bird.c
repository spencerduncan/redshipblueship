...
void EnBird_Init(Actor* thisx, PlayState* play) {
    ...
    OoT_SkelAnime_Init(play, &this->skelAnime, &gBirdSkel, &gBirdFlyAnim, NULL, NULL, 0);
    OoT_ActorShape_Init(&this->actor.shape, 5500, OoT_ActorShadow_DrawCircle, 4);
    this->unk_194 = 0;
    this->unk_198 = 0;
    this->unk_1C0 = 0x9C4;
...
void func_809C1CAC(EnBird* this, s16 params) {
    f32 frameCount = OoT_Animation_GetLastFrame(&gBirdFlyAnim);
    f32 playbackSpeed = this->unk_19C ? 0.0f : 1.0f;
    AnimationHeader* anim = &gBirdFlyAnim;

    this->unk_198 = OoT_Rand_S16Offset(5, 0x23);
    OoT_Animation_Change(&this->skelAnime, anim, playbackSpeed, 0.0f, frameCount, ANIMMODE_LOOP, 0.0f);
...
void func_809C1E00(EnBird* this, s16 params) {
    this->unk_198 = OoT_Rand_S16Offset(0x14, 0x2D);
...
void func_809C1E40(EnBird* this, PlayState* play) {
    ...
    OoT_Math_SmoothStepToF(&this->actor.speedXZ, this->unk_1A8, 0.1f, this->unk_1AC, 0.0f);

    if (this->unk_1B0 < OoT_Math_Vec3f_DistXZ(&this->actor.world.pos, &this->actor.home.pos) || this->unk_198 < 4) {
