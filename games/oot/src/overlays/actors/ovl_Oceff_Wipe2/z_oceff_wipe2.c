...
void OoT_OceffWipe2_Init(Actor* thisx, PlayState* play);
void OoT_OceffWipe2_Destroy(Actor* thisx, PlayState* play);
void OoT_OceffWipe2_Update(Actor* thisx, PlayState* play);
void OoT_OceffWipe2_Draw(Actor* thisx, PlayState* play);
...
const ActorInit Oceff_Wipe2_InitVars = {
    ...
    sizeof(OceffWipe2),
    (ActorFunc)OoT_OceffWipe2_Init,
    (ActorFunc)OoT_OceffWipe2_Destroy,
    (ActorFunc)OoT_OceffWipe2_Update,
    (ActorFunc)OoT_OceffWipe2_Draw,
    NULL,
};
...
void OoT_OceffWipe2_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->timer < 32) {
        z = OoT_Math_SinS(this->timer << 9) * (fastOcarinaPlayback ? 1200.0f : 1330.0f);
    } else {
