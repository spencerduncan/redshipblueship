...
void BossDodongo_RegisterBlendedLavaTextureUpdate() {
    ...
    if (OoT_gPlayState == NULL || OoT_gPlayState->sceneNum != SCENE_DODONGOS_CAVERN_BOSS) {
        return;
    }
    ...
    if (ResourceMgr_TexIsRaw(gDodongosCavernBossLavaFloorTex)) {
        ...
        if (floorSize != lavaSize || floorSize != rockSize) {
            uint8_t maskVal = !!OoT_Flags_GetClear(OoT_gPlayState, OoT_gPlayState->roomCtx.curRoom.num);
        ...
        if (OoT_Flags_GetClear(OoT_gPlayState, OoT_gPlayState->roomCtx.curRoom.num)) {
...
void func_808C17C8(PlayState* play, Vec3f* arg1, Vec3f* arg2, Vec3f* arg3, f32 arg4, s16 arg5) {
    ...
    for (i = 0; i < arg5; i++, eff++) {
        if (eff->unk_24 == 0) {
            ...
            eff->alpha = 255;
            eff->unk_25 = (s16)OoT_Rand_ZeroFloat(10.0f);
            break;
        }
    }
}
...
s32 BossDodongo_AteExplosive(BossDodongo* this, PlayState* play) {
    ...
    while (currentExplosive != NULL) {
        ...
        if ((fabsf(dx) < 40.0f) && (fabsf(dy) < 40.0f) && (fabsf(dz) < 40.0f)) {
            OoT_Actor_Kill(currentExplosive);
            return true;
        }
...
void BossDodongo_Init(Actor* thisx, PlayState* play) {
    ...
    OoT_ActorShape_Init(&this->actor.shape, 9200.0f, OoT_ActorShadow_DrawCircle, 250.0f);
    OoT_Actor_SetScale(&this->actor, 0.01f);
    OoT_SkelAnime_Init(play, &this->skelAnime, &object_kingdodongo_Skel_01B310, &object_kingdodongo_Anim_00F0D8, NULL, NULL,
                   0);
    OoT_Animation_PlayLoop(&this->skelAnime, &object_kingdodongo_Anim_00F0D8);
    this->unk_1F8 = 1.0f;
    ...
    OoT_Collider_SetJntSph(play, &this->collider, &this->actor, &OoT_sJntSphInit, this->items);

    if (OoT_Flags_GetClear(play, play->roomCtx.curRoom.num)) { // KD is dead
        // SOH [General]
        ...
        OoT_Actor_SpawnAsChild(&play->actorCtx, &this->actor, play, ACTOR_DOOR_WARP1, -890.0f, -1523.76f, -3304.0f, 0, 0, 0,
                           WARP_DUNGEON_CHILD);
        OoT_Actor_Spawn(&play->actorCtx, play, ACTOR_BG_BREAKWALL, -890.0f, -1523.76f, -3304.0f, 0, 0, 0, 0x6000, true);
        if (GameInteractor_Should(VB_SPAWN_HEART_CONTAINER, true)) {
            OoT_Actor_Spawn(&play->actorCtx, play, ACTOR_ITEM_B_HEART, -690.0f, -1523.76f, -3304.0f, 0, 0, 0, 0, true);
        }
    }
...
void BossDodongo_SetupIntroCutscene(BossDodongo* this, PlayState* play) {
    s16 frames = OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_00F0D8);

    OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_00F0D8, 1.0f, 0.0f, frames, ANIMMODE_LOOP, -10.0f);
...
void BossDodongo_IntroCutscene(BossDodongo* this, PlayState* play) {
    ...
    camera = OoT_Play_GetCamera(play, MAIN_CAM);
    ...
    switch (this->csState) {
        ...
        case 1:
            ...
            OoT_Play_ClearAllSubCameras(play);
            this->cutsceneCamera = OoT_Play_CreateSubCamera(play);
            OoT_Play_ChangeCameraStatus(play, 0, 1);
            OoT_Play_ChangeCameraStatus(play, this->cutsceneCamera, 7);
            this->csState = 2;
            this->unk_196 = 0x3C;
            this->unk_198 = 160;
        ...
        case 2:
            ...
            if (this->unk_198 == 110) {
                OoT_Player_SetCsActionWithHaltedActors(play, &this->actor, 9);
            }

            if (this->unk_198 == 5) {
                OoT_Player_SetCsActionWithHaltedActors(play, &this->actor, 12);
            }
            ...
            if (this->unk_196 == 0) {
                OoT_Math_SmoothStepToF(&this->cameraEye.x, this->vec.x + 30.0f, 0.2f, this->unk_204 * 20.0f, 0.0f);
                OoT_Math_SmoothStepToF(&this->cameraEye.y, this->vec.y, 0.2f, this->unk_204 * 20.0f, 0.0f);
                OoT_Math_SmoothStepToF(&this->cameraEye.z, this->vec.z + 10.0f, 0.2f, this->unk_204 * 20.0f, 0.0f);
                OoT_Math_SmoothStepToF(&this->unk_204, 1.0f, 1.0f, 0.02f, 0.0f);
            } else {
                this->cameraAt.x = player->actor.world.pos.x;
                this->cameraAt.y = player->actor.world.pos.y + 20.0f;
                this->cameraAt.z = player->actor.world.pos.z;
            ...
            if (OoT_Flags_GetEventChkInf(EVENTCHKINF_BEGAN_KING_DODONGO_BATTLE)) {
                if (this->unk_198 == 100) {
                    ...
                    this->unk_198 = 150;
                    this->unk_204 = 0.0f;
                    OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_008EEC, 1.0f, 0.0f,
                                     OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_008EEC), ANIMMODE_ONCE, 0.0f);
        ...
        case 3:
            BossDodongo_Walk(this, play);
            OoT_Math_SmoothStepToF(&this->unk_20C, sinf(this->unk_19E * 0.05f) * 0.1f, 1.0f, 0.01f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraEye.x, this->vec.x + 90.0f, 0.2f, this->unk_204 * 20.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraEye.y, this->vec.y + 50.0f, 0.2f, this->unk_204 * 20.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraEye.z, this->vec.z, 0.2f, this->unk_204 * 20.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraAt.y, this->vec.y - 10.0f, 0.2f, this->unk_204 * 20.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->unk_204, 1.0f, 1.0f, 0.02f, 0.0f);
            if (fabsf(player->actor.world.pos.x - this->actor.world.pos.x) < 200.0f) {
                ...
                this->unk_204 = 0.0f;
                OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_008EEC, 1.0f, 0.0f,
                                 OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_008EEC), ANIMMODE_ONCE, -5.0f);
            }
            break;
        case 4:
            OoT_Math_SmoothStepToF(&this->unk_20C, 0.0f, 1.0f, 0.01f, 0.0f);
            ...
            OoT_Math_SmoothStepToF(&this->cameraEye.x, player->actor.world.pos.x + phi_f0 + 70.0f, 0.2f,
                               this->unk_204 * 20.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraEye.y, player->actor.world.pos.y + 10.0f, 0.2f, this->unk_204 * 20.0f,
                               0.0f);
            OoT_Math_SmoothStepToF(&this->cameraEye.z, player->actor.world.pos.z - 60.0f, 0.2f, this->unk_204 * 20.0f,
                               0.0f);

            OoT_Math_SmoothStepToF(&this->cameraAt.x, this->vec.x, 0.2f, this->unk_204 * 20.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraAt.y, this->vec.y, 0.2f, this->unk_204 * 20.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraAt.z, this->vec.z, 0.2f, this->unk_204 * 20.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->unk_204, 1.0f, 1.0f, 0.02f, 0.0f);

            if (this->unk_196 == 0) {
                OoT_SkelAnime_Update(&this->skelAnime);
                OoT_Math_SmoothStepToF(&this->unk_208, 0.05f, 1.0f, 0.005f, 0.0f);
            }
...
void BossDodongo_SetupDamaged(BossDodongo* this) {
    if (this->actionFunc != BossDodongo_Damaged) {
        OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_001074, 1.0f, 0.0f,
                         OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_001074), ANIMMODE_ONCE, -5.0f);
...
void BossDodongo_SetupExplode(BossDodongo* this) {
    OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_00E848, 1.0f, 0.0f,
                     OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_00E848), ANIMMODE_ONCE, -5.0f);
...
void BossDodongo_SetupWalk(BossDodongo* this) {
    OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_01D934, 1.0f, 0.0f,
                     OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_01D934), ANIMMODE_ONCE, -10.0f);
    this->unk_1AA = 0;
...
void BossDodongo_SetupRoll(BossDodongo* this) {
    OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_00DF38, 1.0f, 0.0f, 59.0f, ANIMMODE_ONCE, -5.0f);
...
void BossDodongo_SetupBlowFire(BossDodongo* this) {
    ...
    this->unk_1E4 = 0.0f;
    OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_0061D4, 1.0f, 0.0f,
                     OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_0061D4), ANIMMODE_ONCE, 0.0f);
...
void BossDodongo_Damaged(BossDodongo* this, PlayState* play) {
    OoT_SkelAnime_Update(&this->skelAnime);
    OoT_Math_SmoothStepToF(&this->unk_1F8, 1.0f, 0.5f, 0.02f, 0.001f);
    OoT_Math_SmoothStepToF(&this->unk_208, 0.05f, 1.0f, 0.005f, 0.0f);

    if (OoT_Animation_OnFrame(&this->skelAnime, OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_001074))) {
...
void BossDodongo_Explode(BossDodongo* this, PlayState* play) {
    ...
    if (this->unk_1DA == 0) {
        for (i = 0; i < 30; i++) {
            dustVel.x = OoT_Rand_CenteredFloat(20.0f);
            dustVel.y = OoT_Rand_CenteredFloat(20.0f);
            dustVel.z = OoT_Rand_CenteredFloat(20.0f);
        ...
        OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_004E0C, 1.0f, 0.0f,
                         OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_004E0C), ANIMMODE_ONCE, -5.0f);
...
void BossDodongo_LayDown(BossDodongo* this, PlayState* play) {
    this->unk_1BE = 10;
    OoT_Math_SmoothStepToF(&this->unk_1F8, 1.3f, 1.0f, 0.1f, 0.001f);
    OoT_SkelAnime_Update(&this->skelAnime);

    if (OoT_Animation_OnFrame(&this->skelAnime, OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_004E0C))) {
        OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_0042A8, 1.0f, 0.0f,
                         OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_0042A8), ANIMMODE_LOOP, -5.0f);
...
void BossDodongo_Vulnerable(BossDodongo* this, PlayState* play) {
    ...
    if (this->unk_1DA == 0) {
        OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_009D10, 1.0f, 0.0f,
                         OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_009D10), ANIMMODE_ONCE, -5.0f);
...
void BossDodongo_GetUp(BossDodongo* this, PlayState* play) {
    ...
    if (OoT_Animation_OnFrame(&this->skelAnime, OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_009D10))) {
        BossDodongo_SetupRoll(this);
    }
}
...
void BossDodongo_BlowFire(BossDodongo* this, PlayState* play) {
    ...
    if (OoT_Animation_OnFrame(&this->skelAnime, 17.0f)) {
        this->unk_1C8 = 28;
    }
    ...
    if ((this->skelAnime.curFrame > 17.0f) && (this->skelAnime.curFrame < 35.0f)) {
        ...
        this->unk_1AE++;
        OoT_Math_SmoothStepToF(&this->unk_244, 0.0f, 1.0f, 8.0f, 0.0f);
    }
...
void BossDodongo_Walk(BossDodongo* this, PlayState* play) {
    ...
    if (this->unk_1AA == 0) {
        if (OoT_Animation_OnFrame(&this->skelAnime, 14.0f)) {
            OoT_Animation_PlayLoop(&this->skelAnime, &object_kingdodongo_Anim_01CAE0);
            this->unk_1AA = 1;
        }
    } else if (this->unk_1BC != 2) {
        if (((s32)this->skelAnime.curFrame == 1) || ((s32)this->skelAnime.curFrame == 31)) {
            if ((s32)this->skelAnime.curFrame == 1) {
                OoT_Actor_SpawnFloorDustRing(play, &this->actor, &this->unk_410, 25.0f, 10, 8.0f, 500, 10, false);
            } else {
                OoT_Actor_SpawnFloorDustRing(play, &this->actor, &this->unk_404, 25.0f, 10, 8.0f, 500, 10, false);
            }
    ...
    this->unk_1EC = 0.7f;
    OoT_Math_SmoothStepToF(&this->unk_1E4, this->unk_1EC * 4.0f, 1.0f, this->unk_1EC * 0.25f, 0.0f);
    OoT_Math_SmoothStepToF(&this->actor.world.pos.x, sp4C->x, 0.3f, this->unk_1E4, 0.0f);
    OoT_Math_SmoothStepToF(&this->actor.world.pos.z, sp4C->z, 0.3f, this->unk_1E4, 0.0f);
    sp48 = sp4C->x - this->actor.world.pos.x;
    sp44 = sp4C->z - this->actor.world.pos.z;
    OoT_Math_SmoothStepToF(&this->unk_1E8, 2000.0f, 1.0f, this->unk_1EC * 80.0f, 0.0f);
    OoT_Math_SmoothStepToS(&this->actor.world.rot.y, OoT_Math_FAtan2F(sp48, sp44) * (0x8000 / M_PI), 5,
                       (this->unk_1EC * this->unk_1E8), 5);
    OoT_Math_SmoothStepToS(&this->unk_1C4, 0, 2, 2000, 0);
...
void BossDodongo_Roll(BossDodongo* this, PlayState* play) {
    ...
    if (this->unk_1DA == 0) {
        ...
        OoT_Math_SmoothStepToF(&this->actor.world.pos.x, sp5C->x, 1.0f, this->unk_1E4, 0.0f);
        OoT_Math_SmoothStepToF(&this->actor.world.pos.z, sp5C->z, 1.0f, this->unk_1E4, 0.0f);
        this->unk_1C4 += 2000;
        ...
        if (this->actor.bgCheckFlags & 1) {
            ...
            if ((this->unk_19E & 7) == 0) {
                OoT_Camera_AddQuake(&play->mainCamera, 2, 1, 8);
            }

            if (!(this->unk_19E & 1)) {
                OoT_Actor_SpawnFloorDustRing(play, &this->actor, &this->actor.world.pos, 40.0f, 3, 8.0f, 500, 10, false);
            }
        }
    }
    ...
    OoT_Math_SmoothStepToF(&this->unk_1E8, 2000.0f, 1.0f, this->unk_1EC * 100.0f, 0.0f);
    OoT_Math_SmoothStepToS(&this->actor.world.rot.y, OoT_Math_FAtan2F(sp4C, sp48) * (0x8000 / M_PI), 5,
    ...
    if (fabsf(sp4C) <= 15.0f && fabsf(sp48) <= 15.0f) {
        ...
        if (this->numWallCollisions >= 2) {
            ...
            OoT_Camera_AddQuake(&play->mainCamera, 2, 6, 8);
...
void BossDodongo_Update(Actor* thisx, PlayState* play2) {
    ...
    OoT_Math_SmoothStepToF(&thisx->shape.yOffset, this->unk_228, 1.0f, 100.0f, 0.0f);
    Actor_MoveXZGravity(thisx);
    BossDodongo_UpdateDamage(this, play);
    OoT_Actor_UpdateBgCheckInfo(play, thisx, 10.0f, 10.0f, 20.0f, 4);
    OoT_Math_SmoothStepToF(&this->unk_208, 0, 1, 0.001f, 0.0);
    OoT_Math_SmoothStepToF(&this->unk_20C, 0, 1, 0.001f, 0.0);

    if ((this->unk_19E % 128) == 0) {
        for (i = 0; i < 50; i++) {
            this->unk_324[i] = (OoT_Rand_ZeroOne() * 0.25f) + 0.5f;
        }
    }
    ...
    if (this->unk_1C8 != 0) {
        if (this->unk_1C8 >= 11) {
            OoT_Math_SmoothStepToF(&this->unk_240, (this->unk_1C8 & 1) ? (40.0f) : (60.0f), 1.0f, 50.0f, 0.0f);
        } else {
            OoT_Math_SmoothStepToF(&this->unk_240, 0.0f, 1, 10.0f, 0.0);
        }
    ...
    if (this->unk_1BE != 0) {
        if (this->unk_1BE >= 1000) {
            OoT_Math_SmoothStepToF(&this->colorFilterR, 30.0f, 1, 20.0f, 0.0);
            OoT_Math_SmoothStepToF(&this->colorFilterG, 10.0f, 1, 20.0f, 0.0);
        } else {
            this->unk_1BE--;
            OoT_Math_SmoothStepToF(&this->colorFilterR, 255.0f, 1, 20.0f, 0.0);
            OoT_Math_SmoothStepToF(&this->colorFilterG, 0.0f, 1, 20.0f, 0.0);
        }

        OoT_Math_SmoothStepToF(&this->colorFilterB, 0.0f, 1, 20.0f, 0.0);
        OoT_Math_SmoothStepToF(&this->colorFilterMin, 900.0f, 1, 10.0f, 0.0);
        OoT_Math_SmoothStepToF(&this->colorFilterMax, 1099.0f, 1, 10.0f, 0.0);
    } else {
        OoT_Math_SmoothStepToF(&this->colorFilterR, play->lightCtx.fogColor[0], 1, 5.0f, 0.0);
        OoT_Math_SmoothStepToF(&this->colorFilterG, play->lightCtx.fogColor[1], 1.0f, 5.0f, 0.0);
        OoT_Math_SmoothStepToF(&this->colorFilterB, play->lightCtx.fogColor[2], 1.0f, 5.0f, 0.0);
        OoT_Math_SmoothStepToF(&this->colorFilterMin, play->lightCtx.fogNear, 1.0, 5.0f, 0.0);
        OoT_Math_SmoothStepToF(&this->colorFilterMax, 1000.0f, 1, 5.0f, 0.0);
    }
    ...
    if (player->actor.world.pos.y < -1000.0f) {
        ...
        if (this->unk_224 > 1.9f) {
            ...
            phi_s0_3 = 7;
            sp90 = 3;
            magma2DrawMode = OoT_Rand_ZeroOne() * 1.9f;
            ...
            sp90 = -1;
            magma2DrawMode = 1;
            magmaScale = ((s16)(OoT_Rand_ZeroOne() * 50)) - 50;
        }
        ...
        if ((this->unk_19E & phi_s0_3) == 0) {
            ...
            temp_f12 = OoT_Rand_ZeroOne() * 330.0f;
            temp_f10 = OoT_Rand_ZeroOne() * 6.28f;
        ...
        if ((this->unk_19E & sp90) == 0) {
            ...
            Vec3f sp54;
            f32 sp50 = OoT_Rand_ZeroOne() * 330.0f;
            f32 sp4C = OoT_Rand_ZeroOne() * 6.28f;
            ...
            for (i = 0; i < 4; i++) {
                sp60.y = 0.4f;
                sp60.x = OoT_Rand_CenteredFloat(0.5f);
                sp60.z = OoT_Rand_CenteredFloat(0.5f);
                sp50 = OoT_Rand_ZeroOne() * 330.0f;
                sp4C = OoT_Rand_ZeroOne() * 6.28f;
                sp54.x = sinf(sp4C) * sp50 + (-890.0f);
                sp54.y = -1513.76f;
                sp54.z = cosf(sp4C) * sp50 + (-3304.0f);
                func_808C17C8(play, &sp54, &sp6C, &sp60, ((s16)OoT_Rand_ZeroFloat(2.0f)) + 6, 0x50);
            }
        }
    ...
    if (this->unk_1C6 != 0) {
        ...
        OoT_Math_SmoothStepToF(&this->unk_224, 0.0f, 1.0f, 0.01f, 0.0f);
    }
    ...
    OoT_Math_SmoothStepToF(&this->unk_244, 0.0f, 1.0f, 2.0f, 0.0f);
...
block_1:
    ...
    if (*dList != NULL) {
        ...
        OoT_Matrix_Push();
        OoT_Matrix_Scale(1.0f, mtxScaleY, mtxScaleZ, MTXMODE_APPLY);
        ...
        if ((limbIndex != 6) && (limbIndex != 7)) {
            ...
            OoT_Matrix_Scale(1.0f - this->unk_208, this->unk_208 + 1.0f, 1.0f - this->unk_208, MTXMODE_APPLY);
            Matrix_RotateZ(-(this->unk_25C[limbIndex] * 0.1f), MTXMODE_APPLY);
            Matrix_RotateY(-(this->unk_25C[limbIndex] * 0.13f), MTXMODE_APPLY);
            Matrix_RotateX(-(this->unk_25C[limbIndex] * 0.115f), MTXMODE_APPLY);
        }
...
void BossDodongo_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if (limbIndex == 6) {
        OoT_Matrix_MultVec3f(&D_808CA45C, &this->vec);
        OoT_Matrix_MultVec3f(&D_808CA450, &this->actor.focus.pos);
        OoT_Matrix_MultVec3f(&D_808CA468, &this->firePos);
        OoT_Matrix_MultVec3f(&D_808CA474, &this->mouthPos);
    } else if (limbIndex == 39) {
        OoT_Matrix_MultVec3f(&D_808CA480, &this->unk_410);
    } else if (limbIndex == 46) {
        OoT_Matrix_MultVec3f(&D_808CA48C, &this->unk_404);
    }
...
void BossDodongo_Draw(Actor* thisx, PlayState* play) {
    ...
    if ((this->unk_1C0 >= 2) && (this->unk_1C0 & 1)) {
        ...
        POLY_OPA_DISP = OoT_Gfx_SetFog(POLY_OPA_DISP, (u32)this->colorFilterR, (u32)this->colorFilterG,
...
f32 func_808C4F6C(BossDodongo* this, PlayState* play) {
    ...
    rotation = OoT_Math_CosS(-this->actor.world.rot.y);
    sp2C = (OoT_Math_SinS(-this->actor.world.rot.y) * zDiff) + (rotation * xDiff);
    rotation = OoT_Math_SinS(-this->actor.world.rot.y);
    temp_f2 = (OoT_Math_CosS(-this->actor.world.rot.y) * zDiff) + (-rotation * xDiff);
...
f32 func_808C50A8(BossDodongo* this, PlayState* play) {
    ...
    rotation = OoT_Math_CosS(-0x8000 - this->actor.world.rot.y);
    sp2C = (OoT_Math_SinS(-0x8000 - this->actor.world.rot.y) * zDiff) + (rotation * xDiff);
    rotation = OoT_Math_SinS(-0x8000 - this->actor.world.rot.y);
    temp_f2 = (OoT_Math_CosS(-0x8000 - this->actor.world.rot.y) * zDiff) + (-rotation * xDiff);
...
void BossDodongo_PlayerYawCheck(BossDodongo* this, PlayState* play) {
    s16 yawDiff = OoT_Actor_WorldYawTowardActor(&this->actor, &GET_PLAYER(play)->actor) - this->actor.world.rot.y;
...
void BossDodongo_SpawnFire(BossDodongo* this, PlayState* play, s16 params) {
    OoT_Actor_SpawnAsChild(&play->actorCtx, &this->actor, play, ACTOR_EN_BDFIRE, this->vec.x, this->vec.y - 20.0f,
...
void BossDodongo_SetupDeathCutscene(BossDodongo* this) {
    this->actor.speedXZ = 0.0f;
    this->unk_1E4 = 0.0f;
    OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_002D0C, 1.0f, 0.0f,
                     OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_002D0C), ANIMMODE_ONCE, -5.0f);
...
void BossDodongo_DeathCutscene(BossDodongo* this, PlayState* play) {
    ...
    switch (this->csState) {
        case 0:
            ...
            OoT_Player_SetCsActionWithHaltedActors(play, &this->actor, 1);
            this->cutsceneCamera = OoT_Play_CreateSubCamera(play);
            OoT_Play_ChangeCameraStatus(play, MAIN_CAM, CAM_STAT_UNK3);
            OoT_Play_ChangeCameraStatus(play, this->cutsceneCamera, CAM_STAT_ACTIVE);
            camera = OoT_Play_GetCamera(play, MAIN_CAM);
            ...
            break;
        case 5:
            tempSin = OoT_Math_SinS(this->actor.shape.rot.y - 0x1388) * 150.0f;
            tempCos = OoT_Math_CosS(this->actor.shape.rot.y - 0x1388) * 150.0f;
            OoT_Math_SmoothStepToF(&player->actor.world.pos.x, this->actor.world.pos.x + tempSin, 0.5f, 5.0f, 0.0f);
            OoT_Math_SmoothStepToF(&player->actor.world.pos.z, this->actor.world.pos.z + tempCos, 0.5f, 5.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->unk_208, 0.07f, 1.0f, 0.005f, 0.0f);
            tempSin = OoT_Math_SinS(this->actor.world.rot.y) * 230.0f;
            tempCos = OoT_Math_CosS(this->actor.world.rot.y) * 230.0f;
            OoT_Math_SmoothStepToF(&this->cameraEye.x, this->actor.world.pos.x + tempSin, 0.2f, 50.0f, 0.1f);
            OoT_Math_SmoothStepToF(&this->cameraEye.y, this->actor.world.pos.y + 20.0f, 0.2f, 50.0f, 0.1f);
            OoT_Math_SmoothStepToF(&this->cameraEye.z, this->actor.world.pos.z + tempCos, 0.2f, 50.0f, 0.1f);
            OoT_Math_SmoothStepToF(&this->cameraAt.x, this->actor.world.pos.x, 0.2f, 30.0f, 0.1f);
            OoT_Math_SmoothStepToF(&this->cameraAt.y, this->actor.focus.pos.y - 70.0f, 0.2f, 30.0f, 0.1f);
            OoT_Math_SmoothStepToF(&this->cameraAt.z, this->actor.world.pos.z, 0.2f, 30.0f, 0.1f);
            if (OoT_Animation_OnFrame(&this->skelAnime, OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_002D0C))) {
                OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_003CF8, 1.0f, 0.0f,
                                 OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_003CF8), ANIMMODE_ONCE, -1.0f);
                this->csState = 6;
                OoT_Actor_Spawn(&play->actorCtx, play, ACTOR_BG_BREAKWALL, -890.0f, -1523.76f, -3304.0f, 0, 0, 0, 0x6000,
                            true);
            }
            break;
        case 6:
            OoT_Math_SmoothStepToF(&this->cameraAt.x, this->actor.world.pos.x, 0.2f, 30.0f, 0.1f);
            OoT_Math_SmoothStepToF(&this->cameraAt.y, (this->actor.world.pos.y - 70.0f) + 130.0f, 0.2f, 20.0f, 0.1f);
            OoT_Math_SmoothStepToF(&this->cameraAt.z, this->actor.world.pos.z, 0.2f, 30.0f, 0.1f);

            if (OoT_Animation_OnFrame(&this->skelAnime, OoT_Animation_GetLastFrame(&object_kingdodongo_Anim_003CF8))) {
                OoT_Animation_Change(&this->skelAnime, &object_kingdodongo_Anim_00DF38, 1.0f, 30.0f, 59.0f, ANIMMODE_ONCE,
                                 -1.0f);
                this->csState = 7;
                this->unk_228 = 7700.0f;
                this->unk_204 = 0.0f;
        ...
        case 7:
            this->unk_1C4 += 0x7D0;
            OoT_Math_SmoothStepToF(&this->cameraAt.x, this->actor.world.pos.x, 0.2f, 30.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraAt.y, (this->actor.world.pos.y - 70.0f) + 130.0f, 0.2f, 20.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraAt.z, this->actor.world.pos.z, 0.2f, 30.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraEye.x, -890.0f, 0.1f, this->unk_204 * 5.0f, 0.1f);
            OoT_Math_SmoothStepToF(&this->cameraEye.z, -3304.0f, 0.1f, this->unk_204 * 5.0f, 0.1f);
            OoT_Math_SmoothStepToF(&this->unk_204, 1.0f, 1.0f, 0.1f, 0.0f);
            if (this->unk_1DA == 1) {
                this->csState = 8;
                ...
                this->unk_23C = (OoT_Math_SinS(this->unk_19E * 1000) * -50.0f) / 100.0f;

                sp198.x = OoT_Math_SinS(this->unk_19E * 1000) * sp178;
                sp198.y = sp198.z = 0.0f;

                Matrix_RotateY(this->actor.shape.rot.y * (M_PI / 0x8000), MTXMODE_NEW);
                OoT_Matrix_MultVec3f(&sp198, &sp184);

                OoT_Math_SmoothStepToF(&this->actor.world.pos.x, cornerPos->x + sp184.x, 1.0f, this->unk_1E4, 0.0f);
                OoT_Math_SmoothStepToF(&this->actor.world.pos.z, cornerPos->z + sp184.z, 1.0f, this->unk_1E4, 0.0f);
                Audio_PlayActorSound2(&this->actor, NA_SE_EN_DODO_K_ROLL - SFX_FLAG);
                if ((this->unk_19E & 7) == 0) {
                    OoT_Camera_AddQuake(&play->mainCamera, 2, 1, 8);
                }
                if (!(this->unk_19E & 1)) {
                    OoT_Actor_SpawnFloorDustRing(play, &this->actor, &this->actor.world.pos, 40.0f, 3, 8.0f, 500, 10,
                                             false);
                }
                tempSin = cornerPos->x - this->actor.world.pos.x;
                tempCos = cornerPos->z - this->actor.world.pos.z;
                OoT_Math_SmoothStepToF(&this->unk_1E8, 1500.0f, 1.0f, this->unk_1EC * 100.0f, 0.0f);
                OoT_Math_SmoothStepToS(&this->actor.world.rot.y, (OoT_Math_FAtan2F(tempSin, tempCos) * (0x8000 / M_PI)), 5,
                                   (this->unk_1EC * this->unk_1E8), 0);
        ...
        case 9:
            ...
            if (this->unk_1DA < 984) {
                OoT_Math_SmoothStepToS(&this->unk_1C4, -0x4000, 0xA, 0x12C, 0);
            }
            if (this->unk_1DA == 904) {
            ...
            if (this->unk_1DA < 960) {
                OoT_Math_SmoothStepToF(&this->actor.shape.shadowScale, 0.0f, 1.0f, 10.0f, 0.0f);
                if (this->unk_1DA >= 710) {
                    ...
                    if (this->unk_1DA >= 885) {
                        OoT_Math_SmoothStepToF(&this->unk_228, 200.0, 0.2f, 100.0f, 0.0f);
                    } else {
                        OoT_Math_SmoothStepToF(&this->unk_228, -6600.0f, 0.2f, 30.0f, 0.0f);
                    }
                    {
                        ...
                        effectPos.x = OoT_Rand_CenteredFloat(120.0f) + this->actor.focus.pos.x;
                        effectPos.y = OoT_Rand_ZeroFloat(50.0f) + this->actor.world.pos.y;
                        effectPos.z = OoT_Rand_CenteredFloat(120.0f) + this->actor.focus.pos.z;
                        func_8002836C(play, &effectPos, &dustVel, &dustAcell, &dustPrimColor, &dustEnvColor, 0x1F4, 0xA,
                                      0xA);
                        effectPos.x = OoT_Rand_CenteredFloat(120.0f) + this->actor.focus.pos.x;
                        effectPos.y = -1498.76f;
                        effectPos.z = OoT_Rand_CenteredFloat(120.0f) + this->actor.focus.pos.z;
                        colorIndex = (OoT_Rand_ZeroOne() * 1.9f);
                        EffectSsGMagma2_Spawn(play, &effectPos, &magmaPrimColor2[colorIndex],
                                              &magmaEnvColor2[colorIndex], 10 - (colorIndex * 5), colorIndex,
                                              (s16)(OoT_Rand_ZeroOne() * 100.0f) + 100);
                    }
                }
            } else {
                Audio_PlayActorSound2(&this->actor, NA_SE_EN_DODO_K_ROLL - SFX_FLAG);
            ...
            OoT_Math_SmoothStepToF(&this->actor.speedXZ, 0.0f, 0.2f, 0.1f, 0.0f);
            ...
            if (this->unk_1DA >= 0x367) {
                ...
                OoT_Math_SmoothStepToF(&this->unk_238, 0.0f, 0.05f, 40.0f, 0.0f);
            }
            OoT_Math_SmoothStepToF(&this->unk_234, 0.0f, 0.2f, 17.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraAt.x, this->actor.world.pos.x, 0.2f, 30.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraAt.y, (this->actor.world.pos.y - 70.0f) + 130.0f, 0.2f, 20.0f, 0.0f);
            OoT_Math_SmoothStepToF(&this->cameraAt.z, this->actor.world.pos.z, 0.2f, 30.0f, 0.0f);
            if (this->csState == 9) {
                if (this->unk_1DA < 0x2C6) {
                    ...
                    OoT_Math_SmoothStepToF(&this->cameraEye.x, sp78->x, 0.2f, this->unk_204 * 20.0f, 0.0f);
                    OoT_Math_SmoothStepToF(&this->cameraEye.y, player->actor.world.pos.y + 30.0f, 0.1f,
                                       this->unk_204 * 20.0f, 0.0f);
                    OoT_Math_SmoothStepToF(&this->cameraEye.z, sp78->z, 0.1f, this->unk_204 * 20.0f, 0.0f);
                    OoT_Math_SmoothStepToF(&this->unk_204, 1.0f, 1.0f, 0.02f, 0.0f);
                } else {
                    if (this->unk_1A2 == 0) {
                        this->unk_230 += 0.01f;
                    ...
                    OoT_Math_SmoothStepToF(&this->unk_22C, 220.0f, 0.1f, 5.0f, 0.1f);
                    tempSin = sinf(this->unk_230) * (*this).unk_22C;
                    tempCos = cosf(this->unk_230) * (*this).unk_22C;
                    OoT_Math_SmoothStepToF(&this->cameraEye.x, this->actor.world.pos.x + tempSin, 0.2f, 50.0f, 0.0f);
                    OoT_Math_SmoothStepToF(&this->cameraEye.y, this->actor.world.pos.y + 20.0f, 0.2f, 50.0f, 0.0f);
                    OoT_Math_SmoothStepToF(&this->cameraEye.z, this->actor.world.pos.z + tempCos, 0.2f, 50.0f, 0.0f);
                    OoT_Math_SmoothStepToF(&this->unk_23C, 0.0f, 0.2f, 0.01f, 0.0f);
                }
            } else {

                if (this->unk_1A2 == 0) {
                    OoT_Math_SmoothStepToF(&this->unk_23C, -0.5f, 0.2f, 0.05f, 0.0f);
                } else {
                    OoT_Math_SmoothStepToF(&this->unk_23C, 0.5f, 0.2f, 0.05f, 0.0f);
                }
                ...
                OoT_Math_SmoothStepToF(&this->cameraEye.x, -890.0f, 0.1f, this->unk_204 * 5.0f, 0.1f);
                OoT_Math_SmoothStepToF(&this->cameraEye.z, -3304.0f, 0.1f, this->unk_204 * 5.0f, 0.1f);
                OoT_Math_SmoothStepToF(&this->unk_204, 1.0f, 1.0f, 0.05f, 0.0f);
            }
            ...
            if (this->unk_1DA == 820) {
                ...
                if (GameInteractor_Should(VB_SPAWN_HEART_CONTAINER, true)) {
                    OoT_Actor_Spawn(
                        ...
                        OoT_Math_SinS(this->actor.shape.rot.y) * -50.0f + this->actor.world.pos.x, this->actor.world.pos.y,
                        OoT_Math_CosS(this->actor.shape.rot.y) * -50.0f + this->actor.world.pos.z, 0, 0, 0, 0, true);
                }
            }
            if (this->unk_1DA == 600) {
                camera = OoT_Play_GetCamera(play, MAIN_CAM);
                ...
                if (GameInteractor_Should(VB_SPAWN_BLUE_WARP, true, this)) {
                    OoT_Actor_SpawnAsChild(&play->actorCtx, &this->actor, play, ACTOR_DOOR_WARP1, -890.0f, -1523.76f,
        ...
        case 100:
            if ((this->unk_1DA < 0x2C6) && (OoT_Rand_ZeroOne() < 0.5f)) {
                Vec3f sp68;
                Color_RGBA8 D_808CA568 = { 0, 0, 0, 100 };
                Color_RGBA8 D_808CA56C = { 0, 0, 0, 0 };

                sp68.x = OoT_Rand_CenteredFloat(60.0f) + this->actor.focus.pos.x;
                sp68.y = (OoT_Rand_ZeroOne() * 50.0f) + -1498.76f;
                sp68.z = OoT_Rand_CenteredFloat(60.0f) + this->actor.focus.pos.z;
                EffectSsGMagma2_Spawn(play, &sp68, &D_808CA568, &D_808CA56C, 5, 1, (s16)(OoT_Rand_ZeroOne() * 50.0f) + 50);
            }
            break;
    }
...
void BossDodongo_DrawEffects(PlayState* play) {
    ...
    for (i = 0; i < 80; i++, eff++) {
        ...
        if (eff->unk_24 == 1) {
            ...
            OoT_Matrix_Translate(eff->unk_00.x, eff->unk_00.y, eff->unk_00.z, MTXMODE_NEW);
            OoT_Matrix_ReplaceRotation(unkMtx);
            OoT_Matrix_Scale(eff->unk_2C, eff->unk_2C, 1.0f, MTXMODE_APPLY);
