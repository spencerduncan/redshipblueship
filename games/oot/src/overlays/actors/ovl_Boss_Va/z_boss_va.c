...
s32 BossVa_BodyOverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx) {
    ...
    if (limbIndex == 20) {
        ...
        gSPSegment(POLY_OPA_DISP++, 0x08,
                   OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0, 0, 8, 16, 1, 0, (play->gameplayFrames * -2) % 64, 16,
                                      16, 0, 0, 0, -2));
...
void BossVa_BodyPostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if (limbIndex == 6) {
        ...
        gSPSegment(POLY_XLU_DISP++, 0x09,
                   OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0, (play->gameplayFrames * 10) % 128, 16, 32, 1, 0,
...
void BossVa_BariPostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if (limbIndex == 2) {
        gSPSegment(POLY_XLU_DISP++, 0x0A,
                   OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0, (play->gameplayFrames * 10) % 32, 16, 32, 1, 0,
...
void BossVa_Draw(Actor* thisx, PlayState* play) {
    ...
    switch (this->actor.params) {
        case BOSSVA_BODY:
            ...
            if (!this->isDead) {
                gSPSegment(POLY_OPA_DISP++, 0x08,
                           OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0, 0, 8, 16, 1, 0,
                                              (play->gameplayFrames * -10) % 16, 16, 16, 0, 0, 0, -10));
                gSPSegment(POLY_OPA_DISP++, 0x09,
                           OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0, (play->gameplayFrames * -10) % 32, 16, 0x20, 1,
