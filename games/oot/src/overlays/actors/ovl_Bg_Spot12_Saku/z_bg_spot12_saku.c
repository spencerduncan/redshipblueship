...
void BgSpot12Saku_Init(Actor* thisx, PlayState* play) {
    ...
    if (GameInteractor_Should(VB_GTG_GATE_BE_OPEN, OoT_Flags_GetSwitch(play, this->dyna.actor.params & 0x3F))) {
        func_808B3714(this);
    } else {
        func_808B3550(this);
    }
...
void func_808B3604(BgSpot12Saku* this, PlayState* play) {
    f32 temp_ret = OoT_Math_SmoothStepToF(&this->dyna.actor.scale.x, 0.001f / 0.14f, 0.16f, 0.0022f, 0.001f);
    f32 temp_f18 = ((0.1f - this->dyna.actor.scale.x) * 840.0f);

    this->dyna.actor.world.pos.x =
        this->dyna.actor.home.pos.x - (OoT_Math_SinS(this->dyna.actor.shape.rot.y + 0x4000) * temp_f18);
    this->dyna.actor.world.pos.z =
        this->dyna.actor.home.pos.z - (OoT_Math_CosS(this->dyna.actor.shape.rot.y + 0x4000) * temp_f18);
...
void func_808B3714(BgSpot12Saku* this) {
    ...
    this->dyna.actor.world.pos.x =
        this->dyna.actor.home.pos.x - (OoT_Math_SinS(this->dyna.actor.shape.rot.y + 0x4000) * 78.0f);
    this->dyna.actor.world.pos.z =
        this->dyna.actor.home.pos.z - (OoT_Math_CosS(this->dyna.actor.shape.rot.y + 0x4000) * 78.0f);
}
...
void BgSpot12Saku_Draw(Actor* thisx, PlayState* play) {
    OoT_Gfx_DrawDListOpa(play, gGerudoFortressGTGShutterDL);
}
