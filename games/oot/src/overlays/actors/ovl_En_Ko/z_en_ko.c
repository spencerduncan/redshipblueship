...
static EnKoModelInfo OoT_sModelInfo[] = {
...
s32 EnKo_AreObjectsAvailable(EnKo* this, PlayState* play) {
    u8 headId = OoT_sModelInfo[ENKO_TYPE].headId;
    u8 bodyId = OoT_sModelInfo[ENKO_TYPE].bodyId;
    u8 legsId = OoT_sModelInfo[ENKO_TYPE].legsId;
...
s32 EnKo_AreObjectsLoaded(EnKo* this, PlayState* play) {
    if (!OoT_Object_IsLoaded(&play->objectCtx, this->legsObjectBankIdx)) {
        return false;
    }
    if (!OoT_Object_IsLoaded(&play->objectCtx, this->bodyObjectBankIdx)) {
        return false;
    }
    if (!OoT_Object_IsLoaded(&play->objectCtx, this->headObjectBankIdx)) {
        return false;
    }
    return true;
}
...
u16 func_80A96FD0(PlayState* play, Actor* thisx) {
    ...
    switch (ENKO_TYPE) {
        case ENKO_TYPE_CHILD_FADO:
            ...
            return (OoT_Flags_GetInfTable(INFTABLE_B7)) ? 0x10D8 : 0x10D7;
        ...
        case ENKO_TYPE_CHILD_3:
            ...
            if (OoT_Flags_GetInfTable(INFTABLE_22)) {
                return 0x1009;
            }
            return 0x1008;
        case ENKO_TYPE_CHILD_4:
            ...
            if (OoT_Flags_GetInfTable(INFTABLE_24)) {
                return 0x100B;
            }
            return 0x100A;
        case ENKO_TYPE_CHILD_5:
            ...
            if (OoT_Flags_GetInfTable(INFTABLE_26)) {
                return 0x100D;
            }
            return 0x100C;
        case ENKO_TYPE_CHILD_6:
            ...
            if (OoT_Flags_GetInfTable(INFTABLE_28)) {
                return 0x1019;
            }
            return 0x100E;
...
u16 func_80A97338(PlayState* play, Actor* thisx) {
    ...
    switch (ENKO_TYPE) {
        ...
        case ENKO_TYPE_CHILD_0:
            ...
            if (OoT_Flags_GetInfTable(INFTABLE_41)) {
                return 0x1056;
            }
            return 0x1055;
        case ENKO_TYPE_CHILD_1:
        ...
        case ENKO_TYPE_CHILD_2:
            ...
            if (OoT_Flags_GetInfTable(INFTABLE_47)) {
                return 0x105E;
            }
            return 0x105D;
        case ENKO_TYPE_CHILD_3:
        ...
        case ENKO_TYPE_CHILD_6:
            ...
            if (OoT_Flags_GetInfTable(INFTABLE_51)) {
                return 0x1059;
            }
            return 0x1058;
        case ENKO_TYPE_CHILD_7:
        ...
        case ENKO_TYPE_CHILD_8:
            ...
            if (OoT_Flags_GetInfTable(INFTABLE_59)) {
                return 0x1050;
            }
            return 0x104F;
        case ENKO_TYPE_CHILD_9:
        ...
        case ENKO_TYPE_CHILD_11:
            ...
            if (OoT_Flags_GetInfTable(INFTABLE_61)) {
                return 0x1054;
            }
            return 0x1053;
        default:
...
u16 func_80A97610(PlayState* play, Actor* thisx) {
    ...
    if (ENKO_TYPE == ENKO_TYPE_CHILD_0 || ENKO_TYPE == ENKO_TYPE_CHILD_2 || ENKO_TYPE == ENKO_TYPE_CHILD_3 ||
        ...
        faceReaction = OoT_Text_GetFaceReaction(play, 0x13);
    }
    if (ENKO_TYPE == ENKO_TYPE_CHILD_1 || ENKO_TYPE == ENKO_TYPE_CHILD_5 || ENKO_TYPE == ENKO_TYPE_CHILD_6 ||
        ...
        faceReaction = OoT_Text_GetFaceReaction(play, 0x14);
    }
    if (ENKO_TYPE == ENKO_TYPE_CHILD_FADO) {
        faceReaction = OoT_Text_GetFaceReaction(play, 0x12);
    }
    if (faceReaction != 0) {
        return faceReaction;
    }
        ...
        case TEXT_STATE_CLOSING:
            switch (this->actor.textId) {
                ...
                case 0x105D:
                    ...
                    break;
                case 0x10D7:
                    OoT_Flags_SetInfTable(INFTABLE_B7);
                    break;
                case 0x10BA:
            ...
            if (OoT_Message_ShouldAdvance(play)) {
                switch (this->actor.textId) {
                    ...
                    case 0x103E:
                        ...
                        break;
                    case 0x10B7:
                        OoT_Flags_SetInfTable(INFTABLE_BC);
...
s32 func_80A97D68(EnKo* this, PlayState* play) {
    ...
    if (this->interactInfo.talkState != NPC_TALK_STATE_IDLE) {
        if ((this->skelAnime.animation == &gKokiriWipingForeheadAnim) == false) {
            Animation_ChangeByInfo(&this->skelAnime, OoT_sAnimationInfo, ENKO_ANIM_32);
        }
        trackingMode = NPC_TRACKING_HEAD_AND_TORSO;
    } else {
        if ((this->skelAnime.animation == &gKokiriLiftingRockAnim) == false) {
            Animation_ChangeByInfo(&this->skelAnime, OoT_sAnimationInfo, ENKO_ANIM_33);
        }
...
s32 func_80A97F70(EnKo* this, PlayState* play) {
    ...
    if (this->interactInfo.talkState != NPC_TALK_STATE_IDLE) {
        if ((this->skelAnime.animation == &gKokiriBlockingAnim) == false) {
            Animation_ChangeByInfo(&this->skelAnime, OoT_sAnimationInfo, ENKO_ANIM_29);
        }
        func_80034F54(play, this->unk_2E4, this->unk_304, 16);
        trackingMode = NPC_TRACKING_HEAD_AND_TORSO;
    } else {
        if ((this->skelAnime.animation == &gKokiriCuttingGrassAnim) == false) {
            Animation_ChangeByInfo(&this->skelAnime, OoT_sAnimationInfo, ENKO_ANIM_30);
        }
        trackingMode = NPC_TRACKING_NONE;
    }
    OoT_Npc_TrackPoint(&this->actor, &this->interactInfo, 5, trackingMode);
    return EnKo_IsWithinTalkAngle(this);
}
...
s32 func_80A98034(EnKo* this, PlayState* play) {
    ...
    if (this->interactInfo.talkState != NPC_TALK_STATE_IDLE) {
        ...
        if ((this->skelAnime.animation == &gKokiriPunchingAnim) == false) {
            Animation_ChangeByInfo(&this->skelAnime, OoT_sAnimationInfo, ENKO_ANIM_31);
        }
        trackingMode = NPC_TRACKING_NONE;
        result = EnKo_IsWithinTalkAngle(this);
    }
...
s32 func_80A98174(EnKo* this, PlayState* play) {
    if (this->interactInfo.talkState != NPC_TALK_STATE_IDLE) {
        if (OoT_Animation_OnFrame(&this->skelAnime, 18.0f)) {
...
void func_80A9877C(EnKo* this, PlayState* play) {
    ...
    if (OoT_Npc_UpdateTalking(play, &this->actor, &this->interactInfo.talkState, this->lookDist, func_80A97610,
                          func_80A97738) &&
        ...
        if (func_8002F368(play) == ENKO_TYPE_CHILD_9) {
            this->actor.textId = (OoT_Flags_GetInfTable(INFTABLE_BC)) ? 0x10B8 : 0x10B7;
            this->unk_210 = 0;
        }
...
void EnKo_Blink(EnKo* this) {
    ...
    if (DECR(this->blinkTimer) == 0) {
        headId = OoT_sModelInfo[ENKO_TYPE].headId;
...
s32 EnKo_GetForestQuestState2(EnKo* this) {
    ...
    if (CHECK_QUEST_ITEM(QUEST_KOKIRI_EMERALD)) {
        return (OoT_Flags_GetEventChkInf(EVENTCHKINF_OBTAINED_ZELDAS_LETTER)) ? ENKO_FQS_CHILD_SARIA : ENKO_FQS_CHILD_STONE;
    }
    return ENKO_FQS_CHILD_START;
}
...
void func_80A98DB4(EnKo* this, PlayState* play) {
    ...
    if (play->csCtx.state != 0 || gDbgCamEnabled != 0) {
        dist = OoT_Math_Vec3f_DistXYZ(&this->actor.world.pos, &play->view.eye) * 0.25f;
    } else {
    ...
    if (CVarGetInteger(CVAR_ENHANCEMENT("DisableKokiriDrawDistance"), 0) != 0) {
        ...
        OoT_Math_SmoothStepToF(&this->modelAlpha, (this->appearDist < dist) ? 0.0f : 255.0f, 0.3f, 40.0f, 1.0f);
...
void func_80A99048(EnKo* this, PlayState* play) {
    if (EnKo_IsOsAnimeLoaded(this, play) && EnKo_AreObjectsLoaded(this, play)) {
        ...
        OoT_SkelAnime_InitFlex(play, &this->skelAnime, sSkeleton[OoT_sModelInfo[ENKO_TYPE].legsId].flexSkeletonHeader, NULL,
        ...
        Animation_ChangeByInfo(&this->skelAnime, OoT_sAnimationInfo, sOsAnimeLookup[ENKO_TYPE][this->forestQuestState]);
        OoT_Actor_SetScale(&this->actor, 0.01f);
        func_80A98CD8(this);
        this->modelAlpha = 0.0f;
        this->path = OoT_Path_GetByIndex(play, ENKO_PATH, 0xFF);
...
void func_80A99384(EnKo* this, PlayState* play) {
    if (ENKO_TYPE == ENKO_TYPE_CHILD_FADO && this->interactInfo.talkState != NPC_TALK_STATE_IDLE &&
        ...
        Animation_ChangeByInfo(&this->skelAnime, OoT_sAnimationInfo, ENKO_ANIM_7);
...
void func_80A99438(EnKo* this, PlayState* play) {
    if (ENKO_TYPE == ENKO_TYPE_CHILD_FADO && this->interactInfo.talkState == NPC_TALK_STATE_ACTION) {
        Animation_ChangeByInfo(&this->skelAnime, OoT_sAnimationInfo, ENKO_ANIM_6);
        this->actionFunc = func_80A99504;
        play->msgCtx.stateTimer = 4;
        play->msgCtx.msgMode = MSGMODE_TEXT_CLOSING;
...
void func_80A99504(EnKo* this, PlayState* play) {
    if (OoT_Actor_HasParent(&this->actor, play) || !GameInteractor_Should(VB_TRADE_ODD_POTION, true, this)) {
        this->actor.parent = NULL;
        this->actionFunc = func_80A99560;
    } else {
        OoT_Actor_OfferGetItem(&this->actor, play, GI_SAW, 120.0f, 10.0f);
    }
}
...
void func_80A995CC(EnKo* this, PlayState* play) {
    ...
    f32 temp_f2;
    f32 phi_f0;
    s16 homeYawToPlayer = OoT_Math_Vec3f_Yaw(&this->actor.home.pos, &player->actor.world.pos);

    this->actor.world.pos.x = this->actor.home.pos.x;
    this->actor.world.pos.x += 80.0f * OoT_Math_SinS(homeYawToPlayer);
    this->actor.world.pos.z = this->actor.home.pos.z;
    this->actor.world.pos.z += 80.0f * OoT_Math_CosS(homeYawToPlayer);
...
s32 EnKo_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx, Gfx** gfx) {
    ...
    if (limbIndex == 15) {
        ...
        OoT_gSegments[6] = VIRTUAL_TO_PHYSICAL(play->objectCtx.status[this->headObjectBankIdx].segment);
        ...
        *dList = sHead[headId].dList;
        ...
        OoT_gSegments[6] = VIRTUAL_TO_PHYSICAL(play->objectCtx.status[this->legsObjectBankIdx].segment);
    }
    if (limbIndex == 8) {
    ...
    if (limbIndex == 15) {
        OoT_Matrix_Translate(1200.0f, 0.0f, 0.0f, MTXMODE_APPLY);
    ...
    if (limbIndex == 8 || limbIndex == 9 || limbIndex == 12) {
        rot->y += OoT_Math_SinS(this->unk_2E4[limbIndex]) * 200.0f;
        rot->z += OoT_Math_CosS(this->unk_304[limbIndex]) * 200.0f;
    }
    return false;
}
...
void EnKo_PostLimbDraw(PlayState* play2, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx, Gfx** gfx) {
    ...
    if (limbIndex == 7) {
        ...
        OoT_gSegments[6] = VIRTUAL_TO_PHYSICAL(play->objectCtx.status[this->bodyObjectBankIdx].segment);
    }
    if (limbIndex == 15) {
        OoT_Matrix_MultVec3f(&D_80A9A774, &this->actor.focus.pos);
    }
}
...
void EnKo_Draw(Actor* thisx, PlayState* play) {
    EnKo* this = (EnKo*)thisx;
    Color_RGBA8 tunicColor = OoT_sModelInfo[ENKO_TYPE].tunicColor;
    Color_RGBA8 bootsColor = OoT_sModelInfo[ENKO_TYPE].bootsColor;

    if (CVarGetInteger(CVAR_COSMETIC("NPC.Kokiri.Changed"), 0)) {
        tunicColor = CVarGetColor(CVAR_COSMETIC("NPC.Kokiri.Value"), OoT_sModelInfo[ENKO_TYPE].tunicColor);
        bootsColor = CVarGetColor(CVAR_COSMETIC("NPC.Kokiri.Value"), OoT_sModelInfo[ENKO_TYPE].bootsColor);
    }
