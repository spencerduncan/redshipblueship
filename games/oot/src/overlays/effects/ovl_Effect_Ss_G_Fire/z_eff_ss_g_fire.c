...
u32 OoT_EffectSsGFire_Init(PlayState* play, u32 index, EffectSs* this, void* initParamsx);
void OoT_EffectSsGFire_Draw(PlayState* play, u32 index, EffectSs* this);
void OoT_EffectSsGFire_Update(PlayState* play, u32 index, EffectSs* this);

EffectSsInit Effect_Ss_G_Fire_InitVars = {
    EFFECT_SS_G_FIRE,
    OoT_EffectSsGFire_Init,
};
...
u32 OoT_EffectSsGFire_Init(PlayState* play, u32 index, EffectSs* this, void* initParamsx) {
    ...
    this->draw = OoT_EffectSsGFire_Draw;
    this->update = OoT_EffectSsGFire_Update;
...
void OoT_EffectSsGFire_Draw(PlayState* play, u32 index, EffectSs* this) {
    ...
    OoT_EffectSs_DrawGEffect(play, this, fireFootprintTextures[texIdx]);
}
