...
u32 OoT_EffectSsDFire_Init(PlayState* play, u32 index, EffectSs* this, void* initParamsx);
void OoT_EffectSsDFire_Draw(PlayState* play, u32 index, EffectSs* this);
void OoT_EffectSsDFire_Update(PlayState* play, u32 index, EffectSs* this);

EffectSsInit Effect_Ss_D_Fire_InitVars = {
    EFFECT_SS_D_FIRE,
    OoT_EffectSsDFire_Init,
};
...
u32 OoT_EffectSsDFire_Init(PlayState* play, u32 index, EffectSs* this, void* initParamsx) {
    ...
    if (objBankIndex >= 0) {
        ...
        this->draw = OoT_EffectSsDFire_Draw;
        this->update = OoT_EffectSsDFire_Update;
...
static void* OoT_sTextures[] = { gDodongoFire0Tex, gDodongoFire1Tex, gDodongoFire2Tex, gDodongoFire3Tex };
