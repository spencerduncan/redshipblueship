...
void GetItem_DrawJewel(PlayState* play, s16 drawId) {
    ...
    gSPSegment(POLY_XLU_DISP++, 9,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0 % 256, (256 - (0 % 256)) - 1, 64, 64, 1, 0 % 256,
                                  (256 - (0 % 256)) - 1, 16, 16, 0, 0, 0, 0));

    gSPSegment(POLY_OPA_DISP++, 8, OoT_Gfx_TexScrollEx(play->state.gfxCtx, (u8)0, (u8)0, 16, 16, 0, 0));
...
void GetItem_DrawBlueFire(PlayState* play, s16 drawId) {
    ...
    gSPSegment(POLY_XLU_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0 * (play->state.frames * 0), 0 * (play->state.frames * 0), 16,
...
void GetItem_DrawFairy(PlayState* play, s16 drawId) {
    ...
    gSPDisplayList(POLY_XLU_DISP++, OoT_sDrawItemTable[drawId].dlists[1]);
    gSPSegment(POLY_XLU_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0 * (play->state.frames * 0), 0 * (play->state.frames * 0), 32,
...
void GetItem_DrawMirrorShield(PlayState* play, s16 drawId) {
    ...
    gSPSegment(POLY_OPA_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0 * (play->state.frames * 0) % 256,
...
void OoT_GetItem_DrawSkullToken(PlayState* play, s16 drawId) {
    ...
    Gfx_SetupDL_25Xlu(play->state.gfxCtx);
    gSPSegment(POLY_XLU_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0 * (play->state.frames * 0), 1 * -(play->state.frames * 5),
...
void OoT_GetItem_DrawPotion(PlayState* play, s16 drawId) {
    ...
    Gfx_SetupDL_25Opa(play->state.gfxCtx);
    gSPSegment(POLY_OPA_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, -1 * (play->state.frames * 1), 1 * (play->state.frames * 1),
...
void OoT_GetItem_DrawGoronSword(PlayState* play, s16 drawId) {
    ...
    Gfx_SetupDL_25Opa(play->state.gfxCtx);
    gSPSegment(POLY_OPA_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 1 * (play->state.frames * 1), 0 * (play->state.frames * 1), 32,
...
void OoT_GetItem_DrawDekuNuts(PlayState* play, s16 drawId) {
    ...
    Gfx_SetupDL_25Opa(play->state.gfxCtx);
    gSPSegment(POLY_OPA_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 1 * (play->state.frames * 6), 1 * (play->state.frames * 6), 32,
...
void OoT_GetItem_DrawRecoveryHeart(PlayState* play, s16 drawId) {
    ...
    Gfx_SetupDL_25Xlu(play->state.gfxCtx);
    gSPSegment(POLY_XLU_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0 * (play->state.frames * 1), 1 * -(play->state.frames * 3),
...
void OoT_GetItem_DrawFish(PlayState* play, s16 drawId) {
    ...
    Gfx_SetupDL_25Xlu(play->state.gfxCtx);
    gSPSegment(POLY_XLU_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 0 * (play->state.frames * 0), 1 * (play->state.frames * 1), 32,
...
void GetItem_DrawMagicSpell(PlayState* play, s16 drawId) {
    ...
    Gfx_SetupDL_25Xlu(play->state.gfxCtx);
    gSPSegment(POLY_XLU_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 1 * (play->state.frames * 2), 1 * -(play->state.frames * 6),
...
void GetItem_DrawScale(PlayState* play, s16 drawId) {
    ...
    Gfx_SetupDL_25Xlu(play->state.gfxCtx);
    gSPSegment(POLY_XLU_DISP++, 0x08,
               OoT_Gfx_TwoTexScrollEx(play->state.gfxCtx, 0, 1 * (play->state.frames * 2), -1 * (play->state.frames * 2),
