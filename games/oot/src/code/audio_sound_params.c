...
SoundParams OoT_sEnemyBankParams[] = {
...
SoundParams OoT_sPlayerBankParams[] = {
...
SoundParams OoT_sItemBankParams[] = {
...
SoundParams OoT_sEnvBankParams[] = {
...
SoundParams OoT_sSystemBankParams[] = {
...
SoundParams* gSoundParams[7] = {
    OoT_sPlayerBankParams, OoT_sItemBankParams,    OoT_sEnvBankParams,   OoT_sEnemyBankParams,
    OoT_sSystemBankParams, OoT_sOcarinaBankParams, OoT_sVoiceBankParams,
};
