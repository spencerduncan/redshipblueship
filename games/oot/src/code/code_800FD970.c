...
u32 OoT_Rand_Next(void) {
    return OoT_sRandInt = (OoT_sRandInt * 1664525) + 1013904223;
}
...
f32 OoT_Rand_ZeroOne(void) {
    OoT_sRandInt = (OoT_sRandInt * 1664525) + 1013904223;
    sRandFloat = ((OoT_sRandInt >> 9) | 0x3F800000);
    return *((f32*)&sRandFloat) - 1.0f;
}

/**
 * Returns a pseudo-random floating-point number between -0.5f and 0.5f by the same
 * manner in which OoT_Rand_ZeroOne generates its result.
 */
