...
f32 OoT_Math_CosS(s16 angle) {
    return OoT_coss(angle) * SHT_MINV;
}

f32 OoT_Math_SinS(s16 angle) {
    return OoT_sins(angle) * SHT_MINV;
}
...
s16 OoT_Rand_S16Offset(s16 base, s16 range) {
    return (s16)(OoT_Rand_ZeroOne() * range) + base;
}

s16 OoT_Rand_S16OffsetStride(s16 base, s16 stride, s16 range) {
    return (s16)(OoT_Rand_ZeroOne() * range) * stride + base;
}
...
s16 OoT_Math_Vec3f_Yaw(Vec3f* a, Vec3f* b) {
    ...
    return OoT_Math_Atan2S(dz, dx);
}

s16 OoT_Math_Vec3f_Pitch(Vec3f* a, Vec3f* b) {
    return OoT_Math_Atan2S(OoT_Math_Vec3f_DistXZ(a, b), a->y - b->y);
}

void OoT_IChain_Apply_u8(u8* ptr, InitChainEntry* ichain);
void OoT_IChain_Apply_s8(u8* ptr, InitChainEntry* ichain);
void OoT_IChain_Apply_u16(u8* ptr, InitChainEntry* ichain);
void OoT_IChain_Apply_s16(u8* ptr, InitChainEntry* ichain);
void OoT_IChain_Apply_u32(u8* ptr, InitChainEntry* ichain);
void OoT_IChain_Apply_s32(u8* ptr, InitChainEntry* ichain);
void OoT_IChain_Apply_f32(u8* ptr, InitChainEntry* ichain);
void OoT_IChain_Apply_f32div1000(u8* ptr, InitChainEntry* ichain);
void OoT_IChain_Apply_Vec3f(u8* ptr, InitChainEntry* ichain);
void OoT_IChain_Apply_Vec3fdiv1000(u8* ptr, InitChainEntry* ichain);
void OoT_IChain_Apply_Vec3s(u8* ptr, InitChainEntry* ichain);

void (*sInitChainHandlers[])(u8* ptr, InitChainEntry* ichain) = {
    OoT_IChain_Apply_u8,    OoT_IChain_Apply_s8,           OoT_IChain_Apply_u16,   OoT_IChain_Apply_s16,
    OoT_IChain_Apply_u32,   OoT_IChain_Apply_s32,          OoT_IChain_Apply_f32,   OoT_IChain_Apply_f32div1000,
    OoT_IChain_Apply_Vec3f, OoT_IChain_Apply_Vec3fdiv1000, OoT_IChain_Apply_Vec3s,
};

void OoT_Actor_ProcessInitChain(Actor* actor, InitChainEntry* ichain) {
    do {
...
/**
 * Changes pValue by step towards OoT_zero. If step is more than fraction of the remaining distance, step by that instead.
 */
 ...
 */
void OoT_Math_ApproachS(s16* pValue, s16 target, s16 scale, s16 maxStep) {
    s16 diff = target - *pValue;
...
void Sfx_PlaySfxCentered(u16 sfxId) {
    Audio_PlaySoundGeneral(sfxId, &OoT_gSfxDefaultPos, 4, &OoT_gSfxDefaultFreqAndVolScale, &OoT_gSfxDefaultFreqAndVolScale,
...
void Sfx_PlaySfxAtPos(Vec3f* arg0, u16 sfxId) {
    Audio_PlaySoundGeneral(sfxId, arg0, 4, &OoT_gSfxDefaultFreqAndVolScale, &OoT_gSfxDefaultFreqAndVolScale,
                           &OoT_gSfxDefaultReverb);
}
