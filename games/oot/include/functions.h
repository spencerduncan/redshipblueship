...
#else
#define osSyncPrintf(fmt, ...) OoT_osSyncPrintfUnused(fmt, ##__VA_ARGS__)
#endif
...
s32 OoT_osJamMesg(OSMesgQueue* mq, OSMesg mesg, s32 flag);
...
s32 OoT_osContInit(OSMesgQueue* mq, u8* ctl_present_bitfield, OSContStatus* status);
void __osContGetInitData(u8* ctl_present_bitfield, OSContStatus* status);
void __osPackRequestData(u8 poll);
s32 OoT_osContStartReadData(OSMesgQueue* mq);
void OoT_osContGetReadData(OSContPad* pad);
...
void OoT_guLookAt(Mtx*, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt, f32 xUp, f32 yUp, f32 zUp);
...
void OoT_guPosition(Mtx*, f32, f32, f32, f32, f32, f32, f32);
OSYieldResult OoT_osSpTaskYielded(OSTask* task);
void OoT_guRotateF(f32 m[4][4], f32 a, f32 x, f32 y, f32 z);
void OoT_guRotate(Mtx*, f32 angle, f32 x, f32 y, f32 z);
...
void OoT_guOrthoF(f32[4][4], f32, f32, f32, f32, f32, f32, f32);
void OoT_guOrtho(Mtx*, f32, f32, f32, f32, f32, f32, f32);
s16 OoT_coss(u16);
void OoT_osViSetEvent(OSMesgQueue* mq, OSMesg m, u32 retraceCount);
