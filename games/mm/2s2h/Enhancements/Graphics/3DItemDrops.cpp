    ...
    if (!(enItem00->unk14E & enItem00->unk150)) {
        ...
        switch (enItem00->actor.params) {
            case ITEM00_RUPEE_GREEN:
                MM_Matrix_Scale(25.0f, 25.0f, 25.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_RUPEE_GREEN);
                break;
            case ITEM00_RUPEE_BLUE:
                MM_Matrix_Scale(25.0f, 25.0f, 25.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_RUPEE_BLUE);
                break;
            case ITEM00_RUPEE_RED:
                MM_Matrix_Scale(25.0f, 25.0f, 25.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_RUPEE_RED);
                break;
            case ITEM00_RUPEE_HUGE:
                MM_Matrix_Scale(17.5f, 17.5f, 17.5f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_RUPEE_HUGE);
                break;
            case ITEM00_RUPEE_PURPLE:
                MM_Matrix_Scale(17.5f, 17.5f, 17.5f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_RUPEE_PURPLE);
                break;
            case ITEM00_HEART_PIECE:
                MM_Matrix_Scale(16.0f, 16.0f, 16.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_HEART_PIECE);
                break;
            case ITEM00_HEART_CONTAINER:
                MM_Matrix_Scale(16.0f, 16.0f, 16.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_HEART_CONTAINER);
                break;
            ...
            case ITEM00_BOMBS_B:
            case ITEM00_BOMBS_0:
                MM_Matrix_Scale(8.0f, 8.0f, 8.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_BOMB);
                break;
            case ITEM00_ARROWS_10:
                MM_Matrix_Scale(7.0f, 7.0f, 7.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_ARROWS_SMALL);
                break;
            case ITEM00_ARROWS_30:
                MM_Matrix_Scale(7.0f, 7.0f, 7.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_ARROWS_MEDIUM);
                break;
            case ITEM00_ARROWS_40:
            case ITEM00_ARROWS_50:
                MM_Matrix_Scale(7.0f, 7.0f, 7.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_ARROWS_LARGE);
                break;
            case ITEM00_MAGIC_JAR_SMALL:
                MM_Matrix_Scale(8.0f, 8.0f, 8.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_MAGIC_JAR_SMALL);
                break;
            case ITEM00_MAGIC_JAR_BIG:
                MM_Matrix_Scale(8.0f, 8.0f, 8.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_MAGIC_JAR_BIG);
                break;
            case ITEM00_DEKU_STICK:
                MM_Matrix_Scale(7.5f, 7.5f, 7.5f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_DEKU_STICK);
                break;
            case ITEM00_SMALL_KEY:
                MM_Matrix_Scale(8.0f, 8.0f, 8.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_KEY_SMALL);
                break;
            case ITEM00_DEKU_NUTS_1:
            case ITEM00_DEKU_NUTS_10:
                MM_Matrix_Scale(9.0f, 9.0f, 9.0f, MTXMODE_APPLY);
                MM_GetItem_Draw(play, GID_DEKU_NUTS);
                break;
    ...
    *should = false;
    ...
    switch (slime->actor.params) {
        case EN_SLIME_TYPE_RED:
            MM_GetItem_Draw(MM_gPlayState, GID_RECOVERY_HEART);
            break;
        case EN_SLIME_TYPE_GREEN:
            MM_GetItem_Draw(MM_gPlayState, GID_MAGIC_JAR_SMALL);
            break;
        case EN_SLIME_TYPE_YELLOW:
            MM_GetItem_Draw(MM_gPlayState, GID_ARROWS_SMALL);
            break;
    }
}
...
void Register3DItemDrops() {
    if (MM_gPlayState != NULL) {
        // Regular item drops
        Actor* actor = MM_gPlayState->actorCtx.actorLists[ACTORCAT_MISC].first;

        while (actor != NULL) {
            if (actor->id == ACTOR_EN_ITEM00) {
                if (CVAR && (actor->draw == MM_EnItem00_Draw)) {
                    actor->draw = EnItem00_3DItemsDraw;
                } else if (actor->draw == EnItem00_3DItemsDraw) {
                    actor->draw = MM_EnItem00_Draw;
        ...
        actor = MM_gPlayState->actorCtx.actorLists[ACTORCAT_BOSS].first;
    ...
    COND_ID_HOOK(OnActorInit, ACTOR_EN_ITEM00, CVAR, [](Actor* actor) {
        if (actor->draw == MM_EnItem00_Draw) {
            actor->draw = EnItem00_3DItemsDraw;
        }
    });
