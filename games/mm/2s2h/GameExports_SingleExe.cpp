 ...
 */
/**
 * Decide what an owl save / pause save-and-quit should do at its EXIT, and if
 * this is a cross-game session, drive the launcher instead of MM's boot chain.
 *
 ...
 * to go back to". A standalone MM session has none, and for it the vanilla
