...
const char* GetIconTexturePath(RandoItemId randoItemId) {
    switch (randoItemId) {
        ...
        case RI_SOUL_BOSS_GOHT:
            return (const char*)MM_gItemIcons[ITEM_REMAINS_GOHT];
        case RI_SOUL_BOSS_GYORG:
            return (const char*)MM_gItemIcons[ITEM_REMAINS_GYORG];
        case RI_SOUL_BOSS_ODOLWA:
            return (const char*)MM_gItemIcons[ITEM_REMAINS_ODOLWA];
        case RI_SOUL_BOSS_TWINMOLD:
            return (const char*)MM_gItemIcons[ITEM_REMAINS_TWINMOLD];
        ...
        case RI_ABILITY_SWIM:
            return (const char*)MM_gItemIcons[ITEM_MASK_ZORA];
        default:
            break;
    }
