...
void* MM_TransitionTriforce_Init(void* thisx);
void MM_TransitionTriforce_Destroy(void* thisx);
void MM_TransitionTriforce_Update(void* thisx, s32 updateRate);
void MM_TransitionTriforce_Draw(void* thisx, Gfx** gfxP);
void MM_TransitionTriforce_Start(void* thisx);
void MM_TransitionTriforce_SetType(void* thisx, s32 type);
void MM_TransitionTriforce_SetColor(void* thisx, u32 color);
s32 MM_TransitionTriforce_IsDone(void* thisx);

TransitionProfile TransitionTriforce_Profile = {
    MM_TransitionTriforce_Init,   MM_TransitionTriforce_Destroy, MM_TransitionTriforce_Update,   MM_TransitionTriforce_Draw,
    MM_TransitionTriforce_Start,  MM_TransitionTriforce_SetType, MM_TransitionTriforce_SetColor, NULL,
    MM_TransitionTriforce_IsDone,
};
...
void MM_TransitionTriforce_SetState(void* thisx, s32 state) {
    TransitionTriforce* this = (TransitionTriforce*)thisx;
