...
void EnPr2_Init(Actor* thisx, PlayState* play) {
    ...
    MM_SkelAnime_InitFlex(play, &this->skelAnime, &object_pr_Skel_004188, &object_pr_Anim_004340, this->jointTable,
                       this->morphTable, OBJECT_PR_2_LIMB_MAX);
    this->unk_1E0 = ENPR2_GET_F(&this->actor);
    this->actor.colChkInfo.mass = 10;
    MM_Math_Vec3f_Copy(&this->unk_228, &this->actor.home.pos);
    ...
    MM_Actor_UpdateBgCheckInfo(play, &this->actor, 0.0f, 20.0f, 20.0f,
...
void func_80A7436C(EnPr2* this, s16 arg1) {
    ...
    MM_Math_ApproachF(&this->actor.world.pos.y, this->unk_21C.y, 0.3f, 5.0f);

    if (fabsf(this->actor.world.pos.y - this->unk_21C.y) > 10.0f) {
        MM_Math_SmoothStepToS(&this->actor.world.rot.x, MM_Math_Vec3f_Pitch(&this->actor.world.pos, &this->unk_21C) * 0.3f,
                           20, 0x1388, 0x1F4);
    } else {
        MM_Math_SmoothStepToS(&this->actor.world.rot.x, 0, 20, 0x1388, 0x1F4);
    }

    if (fabsf(this->actor.world.rot.y - arg1) < 30.0f) {
        MM_Math_ApproachZeroF(&this->unk_1FC, 0.5f, 20.0f);
    } else {
        MM_Math_ApproachF(&this->unk_1FC, sp2E, 0.5f, 3000.0f);
    }

    MM_Math_SmoothStepToS(&this->actor.world.rot.y, arg1, 1, 0x7D0, 300);
}
...
void EnPr2_ChangeAnim(EnPr2* this, s32 animIndex) {
    ...
    MM_Animation_Change(&this->skelAnime, MM_sAnimations[animIndex], playSpeed, 0.0f, this->animEndFrame,
                     MM_sAnimationModes[animIndex], 0.0f);
}
...
void func_80A745FC(EnPr2* this, PlayState* play) {
    ...
    MM_Math_ApproachF(&this->unk_204, 0.02f, 0.1f, 0.005f);

    if (this->path->customValue < this->unk_1D0) {
        MM_Math_ApproachF(&this->actor.speed, 5.0f, 0.3f, 1.0f);
    } else {
    ...
    this->unk_1EE = MM_Math_Vec3f_Yaw(&this->actor.world.pos, &this->unk_21C);
...
void func_80A74888(EnPr2* this) {
    ...
    this->unk_1DA = 2;
    this->unk_1D8 = 0;
    MM_Math_Vec3f_Copy(&this->unk_21C, &this->unk_228);
    this->unk_1D4 = 1;
...
void func_80A748E8(EnPr2* this, PlayState* play) {
    ...
    if (this->unk_1F4 != 255) {
        ...
        MM_Math_SmoothStepToS(&this->unk_1F4, 0, 1, 30, 100);
        if (this->unk_1F4 < 2) {
            MM_Actor_Kill(&this->actor);
        }
    } else {
            ...
            case 2:
                if (this->unk_1DE == 0) {
                    ...
                    if (sqrtXZ > 20.0f) {
                        ...
                        this->unk_1DC = 0;
                        MM_Math_Vec3f_Copy(&this->unk_21C, &this->unk_228);
                        MM_Math_ApproachF(&this->actor.speed, 3.0f, 0.3f, 0.2f);
                    }
                }
                break;
        ...
        if (!sp4C) {
            ...
            if (this->unk_1DA != 0) {
                if ((MM_Rand_ZeroOne() < 0.3f) && !this->unk_1D6) {
                    this->unk_1D6 = true;
                }

                MM_Math_ApproachZeroF(&this->actor.speed, 0.1f, 0.2f);

                if (this->unk_1DA == 1) {
                    this->unk_1D8 = MM_Rand_S16Offset(100, 100);
                    MM_Math_Vec3f_Copy(&sp3C, &this->unk_228);
                    sp3C.x += MM_Rand_CenteredFloat(300.0f);
                    sp3C.z += MM_Rand_CenteredFloat(300.0f);
                    MM_Math_Vec3f_Copy(&this->unk_21C, &sp3C);
                }
            } else {
                MM_Math_ApproachF(&this->actor.speed, 2.0f, 0.3f, 0.2f);
                MM_Math_Vec3f_Copy(&sp3C, &this->actor.world.pos);
                sp3C.x += MM_Math_SinS(this->actor.world.rot.y) * 20.0f;
                sp3C.z += MM_Math_CosS(this->actor.world.rot.y) * 20.0f;
                if (fabsf(this->actor.world.rot.y - this->unk_1EE) < 100.0f) {
                    if (MM_BgCheck_SphVsFirstPoly(&play->colCtx, &sp3C, 20.0f) ||
                        ...
                        MM_Math_SmoothStepToS(&this->unk_1F0, 0, 1, 0x3E8, 0x64);
                        this->unk_1F2 = 0;
                    }
                }
                ...
                if ((this->unk_1D8 == 0) || ((fabsf(this->unk_21C.x - this->actor.world.pos.x) < 10.0f) &&
                    ...
                    this->unk_1DA = MM_Rand_S16Offset(20, 30);
                }
            }
        }

        if (this->unk_1DA == 0) {
            this->unk_1EE = MM_Math_Vec3f_Yaw(&this->actor.world.pos, &this->unk_21C) + this->unk_1F0;
            func_80A7436C(this, this->unk_1EE);
        }
    }
}
...
void func_80A74DEC(EnPr2* this, PlayState* play) {
    ...
    MM_Math_Vec3f_Copy(&this->unk_21C, &player->actor.world.pos);

    this->unk_1EE = MM_Math_Vec3f_Yaw(&this->actor.world.pos, &this->unk_21C);
    this->unk_20C = MM_Rand_ZeroFloat(30.0f);
    this->unk_1DC = 0;
    this->unk_1D8 = 70;
    this->unk_1D4 = 2;
...
void func_80A74E90(EnPr2* this, PlayState* play) {
    ...
    if (this->unk_1F4 != 255) {
        ...
        if (MM_WaterBox_GetSurface1(play, &play->colCtx, this->actor.world.pos.x, this->actor.world.pos.z, &this->unk_200,
                                 &waterBox)) {
        ...
        if ((this->unk_1E0 == 1) && !func_80A7429C(this, play)) {
            ...
            if (this->collider.base.atFlags & AT_HIT) {
                this->unk_1DC = MM_Rand_S16Offset(30, 30);
                this->unk_1D8 = 100;
                if (this->unk_1E0 != 2) {
                    func_80A74888(this);
                }
...
void func_80A751B4(EnPr2* this) {
    ...
    if (this->unk_1E0 < 10) {
        ...
        this->animEndFrame = MM_Animation_GetLastFrame(&object_pr_Anim_003904);
        MM_Animation_Change(&this->skelAnime, &object_pr_Anim_003904, 1.0f, this->animEndFrame, this->animEndFrame,
                         ANIMMODE_ONCE, 0.0f);
        this->unk_1D8 = MM_Rand_S16Offset(20, 30);
        this->unk_1E4 = 0x4000;
        ...
        this->unk_1D8 = 30;
        this->actor.speed = MM_Rand_ZeroFloat(0.5f);
        this->actor.world.rot.y = MM_Rand_CenteredFloat(0x8000);
    }
    MM_Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_RED, 255, COLORFILTER_BUFFLAG_OPA, 10);
    this->unk_1D4 = 3;
    ...
    if (this->unk_1E0 < 10) {
        ...
        if (curFrame >= this->animEndFrame) {
            for (i = 0; i < ARRAY_COUNT(this->unk_234); i++) {
                MM_Actor_Spawn(&play->actorCtx, play, ACTOR_EN_PR2, this->unk_234[i].x, this->unk_234[i].y,
        ...
        temp = false;
        MM_Math_SmoothStepToS(&this->actor.shape.rot.x, 0, 5, 0x2710, 0x3E8);
        MM_Math_SmoothStepToS(&this->actor.shape.rot.z, this->unk_1E4, 5, 0x2710, 0x3E8);
        MM_Math_SmoothStepToS(&this->actor.shape.rot.y, this->unk_1E6, 5, 0x2710, 0x3E8);
        ...
        if (MM_WaterBox_GetSurface1(play, &play->colCtx, this->actor.world.pos.x, this->actor.world.pos.z, &this->unk_200,
            ...
            if (this->actor.world.pos.y >= (this->unk_200 - 15.0f)) {
                ...
                MM_Math_ApproachF(&this->actor.world.pos.y, this->unk_200 - 15.0f, 0.3f, 1.0f);
            }
        }
        ...
        if ((this->unk_1D8 == 0) || temp) {
            ...
            MM_Math_SmoothStepToS(&this->unk_1F4, 0, 1, 15, 50);

            if (this->unk_1F4 < 2) {
                for (i = 0; i < 10; i++) {
                    MM_Math_Vec3f_Copy(&sp64, &this->actor.world.pos);

                    sp64.x += MM_Rand_CenteredFloat(20.0f);
                    sp64.y += MM_Rand_CenteredFloat(5.0f);
                    sp64.z += MM_Rand_CenteredFloat(20.0f);

                    MM_EffectSsBubble_Spawn(play, &sp64, 0.0f, 5.0f, 5.0f, MM_Rand_ZeroFloat(0.03f) + 0.07f);
                }
...
void func_80A755D8(EnPr2* this, PlayState* play) {
    ...
    if (this->collider.base.acFlags & AC_HIT) {
        ...
        if ((this->actor.colChkInfo.health <= 0) && (this->unk_1D4 != 3)) {
            ...
            if (this->unk_218 >= 0) {
                MM_Item_DropCollectibleRandom(play, NULL, &this->actor.world.pos, D_80A75C3C[this->unk_218]);
            }
...
void EnPr2_Update(Actor* thisx, PlayState* play) {
    ...
    MM_Actor_SetScale(&this->actor, this->unk_204);
    ...
    MM_Actor_UpdateBgCheckInfo(play, &this->actor, 0, 10.0f, 20.0f,
    ...
    if (this->unk_1D6) {
        ...
        MM_Math_Vec3f_Copy(&sp58, &this->unk_270);
        this->unk_1D6 = false;

        sp58.x += MM_Rand_CenteredFloat(20.0f);
        sp58.y += MM_Rand_CenteredFloat(5.0f);
        sp58.z += MM_Rand_CenteredFloat(20.0f);

        for (i = 0; i < 2; i++) {
            rand = MM_Rand_ZeroFloat(0.03f) + 0.07f;
            MM_EffectSsBubble_Spawn(play, &sp58, 0, 5.0f, 5.0f, rand);
        }
    }
