...
void func_80BD6A8C(EnScRuppe* this, PlayState* play) {
    if (this->collider.base.ocFlags1 & OC1_HIT) {
        ...
        MM_Rupees_ChangeBy(sRupeeInfo[this->ruppeIndex].amount);
...
void EnScRuppe_Init(Actor* thisx, PlayState* play) {
    ...
    Collider_InitAndSetCylinder(play, collider, &this->actor, &MM_sCylinderInit);
...
void EnScRuppe_Draw(Actor* thisx, PlayState* play) {
    ...
    MM_gSPSegment(POLY_OPA_DISP++, 0x08, Lib_SegmentedToVirtual(sRupeeInfo[this->ruppeIndex].tex));
