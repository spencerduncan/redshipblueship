...
void EnTsn_Init(Actor* thisx, PlayState* play) {
    ...
    MM_SkelAnime_InitFlex(play, &this->skelAnime, &object_tsn_Skel_008AB8, &object_tsn_Anim_0092FC, NULL, NULL, 0);
    MM_Animation_PlayLoop(&this->skelAnime, &object_tsn_Anim_0092FC);
...
void func_80AE0010(EnTsn* this, PlayState* play) {
    ...
    if ((MM_Message_GetState(&play->msgCtx) == TEXT_STATE_EVENT) && MM_Message_ShouldAdvance(play)) {
        switch (play->msgCtx.currentTextId) {
            ...
            case 0x1080:
                MM_Message_ContinueTextbox(play, play->msgCtx.currentTextId + 1);
                MM_Animation_MorphToLoop(&this->skelAnime, &object_tsn_Anim_001198, -10.0f);
                break;

            case 0x1082:
                MM_Animation_MorphToLoop(&this->skelAnime, &object_tsn_Anim_0092FC, -10.0f);
            ...
            case 0x1084:
                MM_Message_ContinueTextbox(play, play->msgCtx.currentTextId + 1);
                MM_Animation_MorphToLoop(&this->skelAnime, &object_tsn_Anim_000964, -10.0f);
                break;
            ...
            case 0x1088:
                ...
                if (GameInteractor_Should(VB_CONSIDER_MIKAU_HEALED, INV_CONTENT(ITEM_MASK_ZORA) == ITEM_MASK_ZORA,
                    ...
                    MM_Message_ContinueTextbox(play, 0x1093);
                    MM_Animation_MorphToLoop(&this->skelAnime, &object_tsn_Anim_0092FC, -10.0f);
                }
                break;
...
void func_80AE0304(EnTsn* this, PlayState* play) {
    ...
    } else if ((this->actor.xzDistToPlayer < 150.0f) && MM_Player_IsFacingActor(&this->actor, 0x3000, play)) {
    ...
    if (ENTSN_GET_Z(&this->actor)) {
        ...
        MM_Math_SmoothStepToS(&this->actor.world.rot.y, this->actor.home.rot.y, 6, 0x1838, 0x64);
    }
    this->actor.shape.rot.y = this->actor.world.rot.y;
}
...
void func_80AE0418(EnTsn* this, PlayState* play) {
    if (MM_Actor_TextboxIsClosing(&this->actor, play)) {
        MM_Message_StartTextbox(play, 0x107D, NULL);
        MM_Actor_Kill(&this->actor);
    }
}
...
void func_80AE0460(EnTsn* this, PlayState* play) {
    if (MM_Actor_HasParent(&this->actor, play)) {
        ...
        MM_Actor_OfferGetItem(&this->actor, play, GI_SEAHORSE_CAUGHT, 2000.0f, 1000.0f);
    }
}
...
void func_80AE04FC(EnTsn* this, PlayState* play) {
    ...
    if (MM_Message_GetState(&play->msgCtx) == TEXT_STATE_PAUSE_MENU) {
        ...
        if (itemAction <= PLAYER_IA_MINUS1) {
            MM_Message_ContinueTextbox(play, 0x1078);
            MM_Animation_MorphToLoop(&this->unk_1D8->skelAnime, &object_tsn_Anim_001198, -10.0f);
            this->actionFunc = func_80AE0704;
        }
    }
}
...
void func_80AE0704(EnTsn* this, PlayState* play) {
                ...
                switch (play->msgCtx.currentTextId) {
                    case 0x106E:
                        if (CHECK_WEEKEVENTREG(WEEKEVENTREG_25_40)) {
                            MM_Message_ContinueTextbox(play, 0x1074);
                        } else {
                            MM_Message_ContinueTextbox(play, 0x106F);
                        }
                        this->unk_220 |= 2;
                    ...
                    case 0x1076:
                    case 0x1079:
                        MM_Animation_MorphToLoop(&this->unk_1D8->skelAnime, &object_tsn_Anim_000964, -10.0f);
                        MM_Message_ContinueTextbox(play, play->msgCtx.currentTextId + 1);
                        break;

                    case 0x107A:
                        MM_Message_ContinueTextbox(play, 0x10A6);
                        break;
                    ...
                    case 0x1078:
                        ...
                        MM_Message_ContinueTextbox(play, play->msgCtx.currentTextId + 1);
                        MM_Animation_MorphToLoop(&this->unk_1D8->skelAnime, &object_tsn_Anim_0092FC, -10.0f);
                        break;
                    ...
                    case 0x107C:
                        if (MM_Inventory_HasEmptyBottle()) {
                            ...
                            MM_Message_ContinueTextbox(play, 0x10A8);
                        }
                        break;
                    ...
                    case 0x1092:
                        if (CHECK_WEEKEVENTREG(WEEKEVENTREG_26_08)) {
                            ...
                            MM_Message_ContinueTextbox(play, 0x10A7);
                            MM_Animation_MorphToLoop(&this->unk_1D8->skelAnime, &object_tsn_Anim_000964, -10.0f);
                        }
                        break;
    ...
    if (this->unk_220 & 2) {
        if (this->unk_1D8 != NULL) {
            MM_Math_SmoothStepToF(&this->actor.focus.pos.x, this->unk_1D8->actor.focus.pos.x, 0.8f, 100.0f, 5.0f);
            MM_Math_SmoothStepToF(&this->actor.focus.pos.y, this->unk_1D8->actor.focus.pos.y, 0.8f, 100.0f, 5.0f);
            MM_Math_SmoothStepToF(&this->actor.focus.pos.z, this->unk_1D8->actor.focus.pos.z, 0.8f, 100.0f, 5.0f);
        }
    }
...
void EnTsn_Update(Actor* thisx, PlayState* play) {
    ...
    MM_Actor_UpdateBgCheckInfo(play, &this->actor, 20.0f, 25.0f, 0.0f, UPDBGCHECKINFO_FLAG_4);
    ...
    if (DECR(this->unk_230) == 0) {
        this->unk_230 = MM_Rand_S16Offset(60, 60);
    }
