...
static AnimationInfoS MM_sAnimationInfo[ENSELLNUTS_ANIM_MAX] = {
...
void MM_func_80ADAFC0(EnSellnuts* this) {
    s16 curFrame = this->skelAnime.curFrame;
...
f32 func_80ADB08C(PlayState* play) {
    ...
    if (sp18 != NULL) {
        return MM_Math_Vec3f_DistXZ(&player->actor.world.pos, &sp18->home.pos);
    }
    ...
    if (curFrame == endFrame) {
        switch (this->unk_340) {
            ...
            case 0x62A:
                ...
                SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_0);
            ...
            case 0x618:
                if (this->animIndex == ENSELLNUTS_ANIM_1) {
                    ...
                    SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_1);
                    this->actionFunc = func_80ADBFA0;
                }
                break;
            ...
            case 0x619:
                ...
                SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_7);
...
void func_80ADB254(EnSellnuts* this, PlayState* play) {
    ...
    if (((this->actor.playerHeightRel < 50.0f) && (this->actor.playerHeightRel > -50.0f) ? true : false) &&
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_3);
        ...
        if ((this->animIndex == ENSELLNUTS_ANIM_4) || (this->animIndex == ENSELLNUTS_ANIM_18)) {
            ...
            SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_17);
        } else if (this->animIndex == ENSELLNUTS_ANIM_2) {
            this->animIndex = ENSELLNUTS_ANIM_16;
            this->collider.dim.height = 32;
            Actor_PlaySfx(&this->actor, NA_SE_EN_NUTS_UP);
            SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_16);
        } else if (this->animIndex == ENSELLNUTS_ANIM_17) {
            if (DECR(this->unk_34E) == 0) {
                this->unk_34E = MM_Rand_ZeroOne() * 10.0f;
                this->animIndex = ENSELLNUTS_ANIM_2;
                this->collider.dim.height = 32;
                SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_2);
            }
        } else if (this->animIndex == ENSELLNUTS_ANIM_16) {
            if (DECR(this->unk_34E) == 0) {
                this->unk_34E = MM_Rand_S16Offset(40, 40);
                this->animIndex = ENSELLNUTS_ANIM_18;
                this->collider.dim.height = 32;
                SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_18);
            }
        }
    }
}
...
void func_80ADB544(EnSellnuts* this, PlayState* play) {
    ...
    MM_Math_SmoothStepToS(&this->actor.shape.rot.y, this->actor.yawTowardsPlayer, 3, 0x7D0, 0);
        ...
        if (Player_GetExchangeItemAction(play) == PLAYER_IA_MOONS_TEAR) {
            ...
            switch (this->unk_340) {
                case 0x60E:
                    ...
                    MM_Message_StartTextbox(play, this->unk_340, &this->actor);
    ...
    if (!(((this->actor.playerHeightRel < 50.0f) && (this->actor.playerHeightRel > -50.0f)) ? true : false) ||
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_4);
...
void func_80ADB924(EnSellnuts* this, PlayState* play) {
    ...
    if (talkState == TEXT_STATE_PAUSE_MENU) {
        ...
        if (itemAction > PLAYER_IA_NONE) {
            ...
            MM_Message_ContinueTextbox(play, this->unk_340);
            this->actionFunc = func_80ADB0D8;
        }
...
void func_80ADBAB8(EnSellnuts* this, PlayState* play) {
    ...
    if (this->unk_368 == 0x28) {
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_5);
    }
    ...
    if ((curFrame == endFrame) && (this->animIndex == ENSELLNUTS_ANIM_5)) {
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_6);
    }
...
void func_80ADBBEC(EnSellnuts* this, PlayState* play) {
    if (MM_Actor_HasParent(&this->actor, play)) {
        ...
        MM_Actor_OfferGetItem(&this->actor, play, GI_DEED_LAND, 300.0f, 300.0f);
    }
}
...
void func_80ADBD64(EnSellnuts* this, PlayState* play) {
    ...
    if ((talkState == TEXT_STATE_EVENT) && MM_Message_ShouldAdvance(play)) {
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_8);
...
void func_80ADBE80(EnSellnuts* this, PlayState* play) {
    ...
    if (curFrame == endFrame) {
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_19);
        Actor_PlaySfx(&this->actor, NA_SE_EN_NUTS_DOWN);
        this->unk_338 &= ~1;
        this->unk_338 |= 8;
...
void MM_func_80ADC034(EnSellnuts* this, PlayState* play) {
    ...
    if ((this->actor.home.pos.y + 200.0f) < this->actor.world.pos.y) {
        MM_Math_ApproachF(&this->actor.velocity.y, 0.0f, 0.2f, 1.0f);
        this->animIndex = ENSELLNUTS_ANIM_10;
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_10);
        this->unk_368 = 0;
...
void func_80ADC118(EnSellnuts* this, PlayState* play) {
    ...
    if (curFrame == endFrame) {
        MM_Math_SmoothStepToS(&this->unk_364, 0x1C71, 3, 0x100, 0);
        this->unk_344 += this->unk_364;
        this->actor.shape.yOffset = 1500.0f;
        MM_Math_SmoothStepToS(&this->actor.shape.rot.y, 0x4000, 3, 0x7D0, 0);
    }
    ...
    if ((this->actor.home.pos.y + 22.5f) < this->actor.world.pos.y) {
        ...
        this->unk_360 = 0.3f;
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSELLNUTS_ANIM_9);
        Actor_PlaySfx(&this->actor, NA_SE_EN_AKINDONUTS_HIDE);
        this->actionFunc = MM_func_80ADC034;
    }
}
...
void func_80ADC37C(EnSellnuts* this, PlayState* play) {
    ...
    if (this->path != NULL) {
        ...
        MM_Math_SmoothStepToS(&this->actor.world.rot.y, sp30.y, 0xA, 0x12C, 0);
...
void func_80ADC7B4(EnSellnuts* this, PlayState* play) {
    ...
    } else if ((this->unk_366 == 1) && (talkState == TEXT_STATE_EVENT) && MM_Message_ShouldAdvance(play)) {
        play->msgCtx.msgMode = MSGMODE_TEXT_CLOSING;
        play->msgCtx.stateTimer = 4;
        this->unk_366 = 0;
        CutsceneManager_Stop(this->csId);
...
void func_80ADCA64(EnSellnuts* this, PlayState* play) {
    ...
    if (this->animIndex == ENSELLNUTS_ANIM_22) {
        MM_Math_SmoothStepToS(&this->unk_364, 0, 3, 0x100, 0);
...
f32 func_80ADCFE8(Path* path, s32 arg1, Vec3f* pos, Vec3s* arg3) {
    ...
    arg3->y = MM_Math_Vec3f_Yaw(pos, &sp20);
    arg3->x = MM_Math_Vec3f_Pitch(pos, &sp20);
    return sp20.y - pos->y;
}
...
void EnSellnuts_Init(Actor* thisx, PlayState* play) {
    ...
    MM_SkelAnime_InitFlex(play, &this->skelAnime, &gBusinessScrubSkel, &gBusinessScrubStandingAnim, this->jointTable,
...
void EnSellnuts_TransformLimbDraw(PlayState* play, s32 limbIndex, Actor* thisx) {
    ...
    if (((this->unk_350 == 1) || (this->unk_350 == 3)) &&
        ...
        MM_Matrix_Scale(this->unk_354, this->unk_358, this->unk_35C, MTXMODE_APPLY);
    }
    ...
    if (((this->animIndex == ENSELLNUTS_ANIM_9) || (this->animIndex == ENSELLNUTS_ANIM_20) ||
        ...
        ((limbIndex == BUSINESS_SCRUB_LIMB_RIGHT_HAND_BAG) || (limbIndex == BUSINESS_SCRUB_LIMB_LEFT_HAND_BAG) ||
         (limbIndex == BUSINESS_SCRUB_LIMB_LEFT_ARM_BAG))) {
        MM_Matrix_Scale(this->unk_360, this->unk_360, this->unk_360, MTXMODE_APPLY);
    }
