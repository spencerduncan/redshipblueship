...
void func_80A9AD18(BgHakuginPost* this, PlayState* play, BgHakuginPostUnkStruct* unkStruct) {
    ...
    for (i = 0; i < unkStruct->count; i++) {
        ...
        if ((unkStruct3->unk_04) && (D_80A9DDC0.count < 8)) {
            ...
            MM_Collider_SetCylinder(play, collider, &this->dyna.actor, &MM_sCylinderInit);
...
void func_80A9AE3C(BgHakuginPost* this, PlayState* play) {
    while (D_80A9DDC0.count != 0) {
        D_80A9DDC0.count--;
        MM_Collider_DestroyCylinder(play, &D_80A9DDC0.colliders[D_80A9DDC0.count]);
    }
}
...
void func_80A9AFB4(BgHakuginPost* this, PlayState* play, BgHakuginPostUnkStruct* unkStruct) {
    ...
    if (unkStruct->count < ARRAY_COUNT(unkStruct->unk_0000)) {
        ...
        MM_Math_Vec3f_Copy(&unkStruct->unk_0000[i].unk_08, &this->dyna.actor.world.pos);
        MM_Math_Vec3f_Copy(&unkStruct->unk_0000[i].unk_14, &this->dyna.actor.world.pos);
        ...
        if (D_80A9D880[unkStruct->unk_0000[i].unk_00].unk_04) {
            if (MM_Flags_GetSwitch(play, unkStruct->unk_0000[i].switchFlag)) {
...
void func_80A9B160(BgHakuginPostUnkStruct* unkStruct, PlayState* play) {
    ...
    for (i = 0; i < unkStruct->count; i++) {
        MM_Math_Vec3f_Copy(&unkStruct->unk_0000[i].unk_14, &unkStruct->unk_0000[i].unk_08);
        unkStruct->unk_0000[i].unk_20 = 0.0f;
        unkStruct->unk_0000[i].unk_24 = 0.0f;
        unkStruct->unk_0000[i].unk_34 = 1;
        if (D_80A9D880[unkStruct->unk_0000[i].unk_00].unk_04 != 0) {
            MM_Flags_UnsetSwitch(play, unkStruct->unk_0000[i].switchFlag);
        }
    }
}
...
void func_80A9B3BC(BgHakuginPost* this, PlayState* play) {
    ...
    if (MM_Flags_GetSwitch(play, switchFlag1)) {
        sp20 = true;
    } else {
        sp20 = false;
    }

    if (MM_Flags_GetSwitch(play, switchFlag2)) {
        sp1C = true;
    } else {
        sp1C = false;
    }
...
void func_80A9B554(BgHakuginPost* this, PlayState* play, BgHakuginPostUnkStruct* unkStruct,
    ...
    spAC.x = MM_Math_SinS(unkStruct1->unk_28) * unkStruct1->unk_20;
    spAC.y = unkStruct1->unk_24;
    spAC.z = MM_Math_CosS(unkStruct1->unk_28) * unkStruct1->unk_20;

    for (i = 0, val = 0; i < 65; i++, val += 0x3F0) {
        unkStruct2 = &unkStruct->unk_02A4[i];
        unkStruct2->unk_00 = MM_Rand_ZeroOne() * 0.038f + 0.002f;
        temp_f24 = MM_Math_SinS(val);
        temp_f28 = MM_Math_CosS(val);
        temp_f20 = MM_Rand_ZeroOne();
        temp_f20 = (1.0f - SQ(temp_f20)) * 198.0f;
        unkStruct2->unk_04.x = temp_f24 * temp_f20 + spB8.x;
        unkStruct2->unk_04.y = MM_Rand_ZeroOne() * spE4 + spB8.y;
        unkStruct2->unk_04.z = temp_f28 * temp_f20 + spB8.z;

        temp_f0 = unkStruct2->unk_00 - 0.002f;
        temp_f22 = temp_f0 * -(450.0f / 19.0f) + 1.0f;
        unkStruct2->unk_10.x = MM_Rand_ZeroOne() * 60.0f;
        temp_f20 = temp_f0 * (10.0f / 19.0f) + 0.06f;

        unkStruct2->unk_10.x = ((unkStruct2->unk_10.x - 30.0f) + temp_f24 * 50.0f) * temp_f22 + spAC.x * temp_f20;
        unkStruct2->unk_10.y = (MM_Rand_ZeroOne() * 102.0f + 18.0f) * temp_f22 + spAC.y * temp_f20;
        temp_f0 = spAC.z;
        unkStruct2->unk_10.z = ((MM_Rand_ZeroOne() * 60.0f - 30.0f) + temp_f28 * 50.0f) * temp_f22 + temp_f0 * temp_f20;
        unkStruct2->unk_1C = 0.90999997f - (0.04f - unkStruct2->unk_00) * (500.0f / 19.0f) * 0.02f;
        unkStruct2->unk_20.x = (s32)MM_Rand_Next() >> 0x10;
        unkStruct2->unk_20.y = (s32)MM_Rand_Next() >> 0x10;
        unkStruct2->unk_20.z = (s32)MM_Rand_Next() >> 0x10;
        unkStruct2->unk_26 = (MM_Rand_Next() & 0x3FFF) - 0x1FFF;
        unkStruct2->unk_28 = (MM_Rand_Next() & 0x1FFF) - 0xFFF;
        unkStruct2->unk_2A = (MM_Rand_Next() & 0x1FFF) - 0xFFF;
        unkStruct2->unk_2C = (MM_Rand_Next() & 0x1F) + 0x4B;
        unkStruct2->unk_2D = 2;
    }

    for (i = 0, val = 0; i < 22; i++, val += 0xBA2) {
        temp_f20 = MM_Rand_ZeroOne() * 60.0f + 220.0f;
        spA0.x = MM_Math_SinS(val) * temp_f20 + spB8.x;
        spA0.y = (MM_Rand_ZeroOne() * 1.2f - 0.1f) * spE4 + spB8.y;
        spA0.z = MM_Math_CosS(val) * temp_f20 + spB8.z;
        func_800B0E48(play, &spA0, &gZeroVec3f, &D_80A9D8EC, &D_80A9D8E4, &D_80A9D8E8,
                      ((s32)MM_Rand_Next() >> 0x1A) + 0x82, ((s32)MM_Rand_Next() >> 0x1A) + 0x6E);
    }
    ...
    if (unkStruct1Temp != NULL) {
        ...
        for (i = 65, val = 0; i < ARRAY_COUNT(unkStruct->unk_02A4); i++, val += 0x4A7) {
            unkStruct2 = &unkStruct->unk_02A4[i];
            unkStruct2->unk_00 = MM_Rand_ZeroOne() * 0.007f + 0.002f;
            temp_s1_3 = (MM_Rand_Next() & 0x7FF) + val;
            temp_f24 = MM_Math_SinS(temp_s1_3);
            temp_f28 = MM_Math_CosS(temp_s1_3);
            unkStruct2->unk_04.x = temp_f24 * 225.5f + spB8.x;
            if (i & 1) {
                unkStruct2->unk_04.y = MM_Rand_ZeroOne() * D_80A9D880[unkStruct1Temp->unk_00].unk_00 + spB8.y;
            } else {
                unkStruct2->unk_04.y = temp_f6 - MM_Rand_ZeroOne() * 350.0f;
            }
            unkStruct2->unk_04.z = temp_f28 * 225.5f + spB8.z;
            unkStruct2->unk_10.x = MM_Rand_ZeroOne() + temp_f24 * 7.0f;
            unkStruct2->unk_10.y = 0.0f;
            unkStruct2->unk_10.z = MM_Rand_ZeroOne() + temp_f28 * 7.0f;
            unkStruct2->unk_1C = 0.90999997f - (0.04f - unkStruct2->unk_00) * (500.0f / 19.0f) * 0.075f;
            unkStruct2->unk_20.x = (s32)MM_Rand_Next() >> 0x10;
            unkStruct2->unk_20.y = (s32)MM_Rand_Next() >> 0x10;
            unkStruct2->unk_20.z = (s32)MM_Rand_Next() >> 0x10;
            unkStruct2->unk_26 = (MM_Rand_Next() & 0x1FFF) - 0xFFF;
            unkStruct2->unk_28 = (MM_Rand_Next() & 0x1FFF) - 0xFFF;
            unkStruct2->unk_2A = (MM_Rand_Next() & 0x1FFF) - 0xFFF;
            unkStruct2->unk_2C = (MM_Rand_Next() & 0x1F) + 0x41;
            unkStruct2->unk_2D = 0;
        }
    }
    ...
    if (unkStruct->unk_1924) {
        ...
        for (i = 0; i < ARRAY_COUNT(unkStruct->unk_02A4); i++) {
            ...
            if (unkStruct2->unk_2C > 0) {
                ...
                MM_Math_Vec3f_Scale(&unkStruct2->unk_10, unkStruct2->unk_1C);
...
void func_80A9BD24(BgHakuginPost* this, PlayState* play, BgHakuginPostUnkStruct* unkStruct) {
    ...
    for (i = 0; i < unkStruct->count; i++) {
        ...
        unkStruct->unk_0000[i].unk_14.x += MM_Math_SinS(unkStruct->unk_0000[i].unk_28) * unkStruct->unk_0000[i].unk_20;
        unkStruct->unk_0000[i].unk_14.z =
            MM_Math_CosS(unkStruct->unk_0000[i].unk_28) * unkStruct->unk_0000[i].unk_20 + unkStruct->unk_0000[i].unk_14.z;
        ...
        if (unkStruct->unk_0000[i].unk_34 == 2) {
            if (MM_Math3D_Dist1DSq(unkStruct->unk_0000[i].unk_14.x, unkStruct->unk_0000[i].unk_14.z) >
                SQ(440.0f) + 0.02f) {
                unkStruct->unk_0000[i].unk_34 = 3;
            }
        } else if (unkStruct->unk_0000[i].unk_34 == 3) {
            if (MM_Math3D_Dist1DSq(unkStruct->unk_0000[i].unk_14.x, unkStruct->unk_0000[i].unk_14.z) > 278784.03f) {
    ...
    if (this->unk_170 == 0) {
        for (i = 0; i < unkStruct->count; i++) {
            ...
            if (unkStruct1->unk_2F & 2) {
                ...
                Rumble_Request(MM_Math3D_Vec3fDistSq(&sp44, &GET_PLAYER(play)->actor.world.pos), 255, 20, 150);
...
void BgHakuginPost_RequestQuakeAndRumble(BgHakuginPost* this, PlayState* play) {
    ...
    Rumble_Request(MM_Math3D_Dist2DSq(player->actor.world.pos.x, player->actor.world.pos.z, this->dyna.actor.home.pos.x,
    ...
    for (i = 0; i < unkStruct->count; i++) {
        ...
        if (unkStruct->unk_0000[i].unk_34 == 2) {
            for (j = 0, val = 0; j < 3; j++, val += 0x5555) {
                temp_f20 = MM_Rand_ZeroOne() * 264.0f;
                temp_s0 = (MM_Rand_Next() & 0xFFF) + val;
                spB8.x = MM_Math_SinS(temp_s0) * temp_f20 + spC8->unk_14.x;
                spB8.z = MM_Math_CosS(temp_s0) * temp_f20 + spC8->unk_14.z;

                if (MM_Math3D_Dist1DSq(spB8.x, spB8.z) < SQ(550.0f) + 0.03f) {
                    spB8.x += this->dyna.actor.home.pos.x;
                    spB8.y = spC8->unk_14.y + this->unk_16C + 20.0f;
                    spB8.z += this->dyna.actor.home.pos.z;

                    spAC.x = MM_Math_SinS(spC8->unk_28) * 3.0f;
                    spAC.y = 0.0f;
                    spAC.z = MM_Math_CosS(spC8->unk_28) * 3.0f;
        ...
        if ((unkStruct->unk_0000[i].unk_2F & 2) && (spC4 != NULL) && ((spC4->unk_34 == 3) || (spC4->unk_34 == 4))) {
            for (j = 0, val = 0; j < 18; j++, val += 0xE38) {
                temp_f20 = (MM_Rand_ZeroOne() * 0.3f + 1.0f) * 220.0f;
                temp_s0 = (MM_Rand_Next() & 0xFFF) + val;
                spB8.x = MM_Math_SinS(temp_s0) * temp_f20;
                spB8.z = MM_Math_CosS(temp_s0) * temp_f20;
...
void func_80A9C634(BgHakuginPost* this, PlayState* play) {
    ...
    for (i = 0; i < 70; i++) {
        temp_s4 = (s32)(MM_Rand_ZeroOne() * 6553.0f) + i * 0x1999;
        temp_f20 = ((MM_Rand_ZeroOne() * 0.3f) + 1.0f) * 220.0f;

        spB8.x = MM_Math_SinS(temp_s4);
        spB8.y = i * -(60.0f / 7.0f);
        spB8.z = MM_Math_CosS(temp_s4);
        ...
        spA0.y = 0.8f;
        spA0.z = spAC.z * -0.08f;
        func_800B0DE0(play, &spB8, &spAC, &spA0, &D_80A9D8E4, &D_80A9D8E8, (s32)(MM_Rand_ZeroOne() * 400.0f) + 2500, -250);
    }
}
...
void func_80A9C854(BgHakuginPost* this, PlayState* play) {
    ...
    if (this->unk_174 != 0) {
        if (MM_Flags_GetSwitch(play, this->dyna.actor.home.rot.z & 0x7F)) {
            sp28 = true;

            for (i = 0; i < D_80A9E028.count; i++) {
                ColliderCylinder* collider = D_80A9E028.unk_0000[i].collider;

                if ((collider != NULL) && MM_Flags_GetSwitch(play, D_80A9E028.unk_0000[i].switchFlag)) {
                    sp28 = false;
                    break;
                }
            }
    ...
    if (sp38) {
        MM_Flags_SetSwitch(play, BGHAKUGINPOST_GET_SWITCH_FLAG_2(&this->dyna.actor));
    } else {
        MM_Flags_UnsetSwitch(play, BGHAKUGINPOST_GET_SWITCH_FLAG_2(&this->dyna.actor));
    }
}
...
void func_80A9CAA8(BgHakuginPost* this, PlayState* play) {
    ...
    MM_Math_Vec3f_Copy(&this->dyna.actor.home.pos, &D_80A9E028.unk_0000[0].unk_08);
...
void func_80A9CD14(BgHakuginPost* this, PlayState* play) {
    f32 temp_f12 =
        MM_Math_SinS((this->unk_16C - this->unk_164) * 0x8000 / (this->unk_168 - this->unk_164)) * 140.0f + 4.0f;
    ...
    for (i = 0; i < D_80A9E028.count; i++) {
        ...
        if ((collider != NULL) && (collider->base.acFlags & AC_HIT) && (D_80A9E028.unk_0000[i].unk_34 == 1)) {
            ...
            if ((yDiff > 0x5000) && ((temp_f0 - 60.0f) < player->actor.world.pos.y) &&
                ...
                MM_Player_PlaySfx(player, NA_SE_IT_HAMMER_HIT);
                Audio_PlaySfx_2(NA_SE_EV_SLIDE_DOOR_OPEN);
                MM_Flags_SetSwitch(play, D_80A9E028.unk_0000[i].switchFlag);
                this->unk_178 = 20;
...
void func_80A9D0B4(BgHakuginPost* this, PlayState* play) {
    ...
    f32 temp_f14 = MM_Math_SinS((this->unk_16C - sp24) * 0x8000 / (this->unk_168 - sp24)) * 140.0f + 4.0f;
...
void func_80A9D61C(Actor* thisx, PlayState* play) {
    ...
    if (D_80A9E028.unk_1924) {
        for (i = 0; i < ARRAY_COUNT(D_80A9E028.unk_02A4); i++) {
            ...
            if (unkStruct2->unk_2C > 0) {
                MM_Matrix_SetTranslateRotateYXZ(unkStruct2->unk_04.x, unkStruct2->unk_04.y, unkStruct2->unk_04.z,
                                             &unkStruct2->unk_20);
