...
void MM_EnTorch_Init(Actor* thisx, PlayState* play);
...
void MM_EnTorch_Init(Actor* thisx, PlayState* play) {
    ...
    MM_Actor_Spawn(&play->actorCtx, play, ACTOR_EN_BOX, this->actor.world.pos.x, this->actor.world.pos.y,
                this->actor.world.pos.z, 0, this->actor.shape.rot.y, 0,
                ENBOX_PARAMS(ENBOX_TYPE_SMALL, MM_sChestContents[(returnData >> 0x5) & 0x7], returnData));
