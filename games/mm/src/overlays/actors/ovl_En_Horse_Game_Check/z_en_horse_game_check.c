...
void MM_EnHorseGameCheck_Init(Actor* thisx, PlayState* play);
void MM_EnHorseGameCheck_Destroy(Actor* thisx, PlayState* play);
void MM_EnHorseGameCheck_Update(Actor* thisx, PlayState* play);
void MM_EnHorseGameCheck_Draw(Actor* thisx, PlayState* play);
...
ActorProfile En_Horse_Game_Check_Profile = {
    ...
    /**/ MM_EnHorseGameCheck_Init,
    /**/ MM_EnHorseGameCheck_Destroy,
    /**/ MM_EnHorseGameCheck_Update,
    /**/ MM_EnHorseGameCheck_Draw,
};
...
s32 func_808F8AA0(EnHorseGameCheck* this, PlayState* play) {
    ...
    MM_CollisionHeader_GetVirtual(&object_horse_game_check_Colheader_003918, &sp78);

    this->dyna.bgId = MM_DynaPoly_SetBgActor(play, &play->colCtx.dyna, &this->dyna.actor, sp78);
    this->unk_15C = ENHORSEGAMECHECK_FF_5;
    this->dyna.actor.floorPoly = NULL;
    this->dyna.actor.world.pos.y += 100.0f;

    this->dyna.actor.floorHeight =
        MM_BgCheck_EntityRaycastFloor2(play, &play->colCtx, &this->dyna.actor.floorPoly, &this->dyna.actor.world.pos);
    ...
    MM_Matrix_Scale(this->dyna.actor.scale.x, this->dyna.actor.scale.y, this->dyna.actor.scale.y, MTXMODE_APPLY);
    MM_Matrix_Get(&sp38);
...
s32 func_808F8C70(EnHorseGameCheck* this, PlayState* play) {
    if (Matrix_Finalize(play->state.gfxCtx) == NULL) {
        ...
        MM_Gfx_DrawDListXlu(play, object_horse_game_check_DL_003030);
        MM_Gfx_DrawDListOpa(play, object_horse_game_check_DL_0030C0);
    }
    return true;
}
...
s32 func_808F8CCC(EnHorseGameCheck* this, PlayState* play2) {
    ...
    this->horse1 = (EnHorse*)MM_Actor_Spawn(&play->actorCtx, play, ACTOR_EN_HORSE, -1149.0f, -106.0f, 470.0f, 0, 0x7FFF, 0,
                                         ENHORSE_PARAMS(ENHORSE_PARAM_BANDIT, ENHORSE_4));
    if (this->horse1 == NULL) {
        _dbg_hungup("../z_en_horse_game_check.c", 1517);
    }

    this->horse2 = (EnHorse*)MM_Actor_Spawn(&play->actorCtx, play, ACTOR_EN_HORSE, -1376.0f, -106.0f, 470.0f, 0, 0x7FFF, 0,
    ...
    this->unk_17C = -1;
    MM_Camera_ChangeSetting(play->cameraPtrs[CAM_ID_MAIN], CAM_SET_FREE0);
...
s32 func_808F8FAC(EnHorseGameCheck* this, PlayState* play) {
    ...
    if ((this->unk_17C != -1) && ((this->unk_168 - this->unk_17C) > 10)) {
        this->unk_17C = -1;
        MM_Camera_ChangeSetting(play->cameraPtrs[CAM_ID_MAIN], CAM_SET_HORSE);
    }
    ...
    if (!(this->unk_164 & 0x1000)) {
        if (MM_Math3D_PointInSquare2D(D_808F9BAC[0], D_808F9BAC[1], D_808F9BAC[2], D_808F9BAC[3],
    ...
    if (!(this->unk_164 & 0x2000) && (this->unk_164 & 0x1000)) {
        if (MM_Math3D_PointInSquare2D(D_808F9BBC[0], D_808F9BBC[1], D_808F9BBC[2], D_808F9BBC[3],
                                   this->horse1->actor.world.pos.x, this->horse1->actor.world.pos.z)) {
            this->unk_164 |= 0x2000;
        }
    }
    ...
    if (!(this->unk_164 & 0x4000) && (this->unk_164 & 0x2000)) {
        if (MM_Math3D_PointInSquare2D(D_808F9BCC[0], D_808F9BCC[1], D_808F9BCC[2], D_808F9BCC[3],
                                   this->horse1->actor.world.pos.x, this->horse1->actor.world.pos.z)) {
            this->unk_164 |= 0x4000;
        }
    }

    horseGameCheck = (EnHorseGameCheck*)MM_DynaPoly_GetActor(&play->colCtx, this->horse1->unk_24C);
    ...
    horseGameCheck = (EnHorseGameCheck*)MM_DynaPoly_GetActor(&play->colCtx, this->horse2->unk_24C);
    ...
    if (!(this->unk_164 & 0x20) && MM_Math3D_PointInSquare2D(D_808F9BAC[0], D_808F9BAC[1], D_808F9BAC[2], D_808F9BAC[3],
                                                          horse->actor.world.pos.x, horse->actor.world.pos.z)) {
        this->unk_164 |= 0x20;
    }

    if (!(this->unk_164 & 0x40) && (this->unk_164 & 0x20) &&
        MM_Math3D_PointInSquare2D(D_808F9BBC[0], D_808F9BBC[1], D_808F9BBC[2], D_808F9BBC[3], horse->actor.world.pos.x,
                               horse->actor.world.pos.z)) {
        this->unk_164 |= 0x40;
    }

    if (!(this->unk_164 & 0x80) && (this->unk_164 & 0x40) &&
        MM_Math3D_PointInSquare2D(D_808F9BCC[0], D_808F9BCC[1], D_808F9BCC[2], D_808F9BCC[3], horse->actor.world.pos.x,
                               horse->actor.world.pos.z)) {
        this->unk_164 |= 0x80;
    }

    horseGameCheck = (EnHorseGameCheck*)MM_DynaPoly_GetActor(&play->colCtx, horse->unk_24C);
...
s32 func_808F96E4(EnHorseGameCheck* this, PlayState* play) {
    ...
    MM_DynaPolyActor_Init(&this->dyna, 0);
    MM_CollisionHeader_GetVirtual(&ovl_En_Horse_Game_Check_Colheader_0010C8, &sp78);
...
s32 func_808F987C(EnHorseGameCheck* this, PlayState* play) {
    ...
    MM_DynaPolyActor_Init(&this->dyna, 0);
    MM_CollisionHeader_GetVirtual(&object_horse_game_check_Colheader_002FB8, &sp28);
    this->dyna.bgId = MM_DynaPoly_SetBgActor(play, &play->colCtx.dyna, &this->dyna.actor, sp28);
...
s32 func_808F9958(EnHorseGameCheck* this, PlayState* play) {
    MM_Gfx_DrawDListOpa(play, object_horse_game_check_DL_0014B0);
    MM_Gfx_DrawDListOpa(play, object_horse_game_check_DL_0013A0);
    return true;
}
