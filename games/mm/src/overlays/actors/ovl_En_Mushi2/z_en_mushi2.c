...
s32 func_80A68860(EnMushi2* this, PlayState* play) {
    ...
    s32 bgId;
    CollisionPoly* sp3C;
    f32 temp_f0 = MM_BgCheck_EntityRaycastFloor5(&play->colCtx, &sp3C, &bgId, &this->actor, &this->actor.world.pos);
    WaterBox* waterBox;
    f32 sp30;
    ...
    while (bean != NULL) {
        if (bean->id == ACTOR_OBJ_BEAN) {
            ...
            if (((params == ENOBJBEAN_GET_C000_1) || (params == ENOBJBEAN_GET_C000_2)) &&
                ...
                temp_f0 = MM_Math3D_Dist2DSq(this->actor.world.pos.x, this->actor.world.pos.z, bean->world.pos.x,
                                          bean->world.pos.z);
...
s32 func_80A68C5C(Vec3f* arg0, Vec3f* arg1) {
    f32 temp_f0 = MM_Math3D_Vec3fMagnitude(arg0);

    if (temp_f0 < 0.005f) {
        MM_Math_Vec3f_Copy(arg0, &gZeroVec3f);
        return false;
    } else {
...
s32 func_80A68CE4(Vec3f* arg0, Vec3f* arg1, f32 arg2) {
    ...
    MM_Math_Vec3f_Diff(arg1, arg0, &sp34);
    temp_f0 = MM_Math3D_Vec3fMagnitudeSq(&sp34);
    temp_f2 = arg2 + 0.01f;
    if (temp_f0 <= SQ(temp_f2)) {
        MM_Math_Vec3f_Copy(arg0, arg1);
        return 1;
    }
...
s32 func_80A68DD4(EnMushi2* this, PlayState* play) {
    ...
    if ((this->actor.xzDistToPlayer < 32.0f) && (this->actor.playerHeightRel > -10.0f) &&
        ...
        sp24 = MM_Math_SinS(sp2E);
        if (MM_Math3D_Dist2DSq((sp24 * 16.0f) + player->actor.world.pos.x,
                            (MM_Math_CosS(sp2E) * 16.0f) + player->actor.world.pos.z, this->actor.world.pos.x,
...
void func_80A68F24(EnMushi2* this) {
    ...
    MM_Matrix_MultVec3f(&D_80A6B9A0, &this->unk_310);
    MM_Matrix_MultVec3f(&D_80A6B9AC, &this->unk_31C);
    MM_Matrix_MultVec3f(&D_80A6B9B8, &this->unk_328);
}
...
s32 func_80A691EC(EnMushi2* this, CollisionPoly* floorPoly, f32 arg2) {
    ...
    if (arg2 > 0.0f) {
        ...
        MM_Math_Vec3f_Copy(&sp4C, &this->unk_31C);
    ...
    MM_Math3D_Vec3f_Cross(&this->unk_310, &sp4C, &sp40);
    MM_Math3D_Vec3f_Cross(&sp4C, &sp40, &sp64);

    if (func_80A68C5C(&sp64, &sp58) && func_80A68C5C(&sp40, &sp34)) {
        MM_Math_Vec3f_Copy(&this->unk_31C, &sp4C);
        MM_Math_Vec3f_Copy(&this->unk_310, &sp58);
        MM_Math_Vec3f_Copy(&this->unk_328, &sp34);
        this->unk_30C |= 0x40;
        return sp30;
    }
...
void func_80A69424(EnMushi2* this, PlayState* play) {
    MM_Actor_UpdateBgCheckInfo(play, &this->actor, 8.0f, 9.0f, 0.0f,
...
s32 func_80A69468(EnMushi2* this, PlayState* play) {
    ...
    MM_Math_Vec3f_Sum(&sp50, &this->actor.prevPos, &sp68);
    ...
    if (MM_BgCheck_EntityLineTest1(&play->colCtx, &this->actor.prevPos, &posB, &this->unk_33C, &this->poly, true, true,
...
s32 func_80A6958C(EnMushi2* this, PlayState* play) {
    ...
    if (MM_BgCheck_EntityLineTest1(&play->colCtx, &posA, &posB, &this->unk_33C, &this->poly, true, true, true, true,
                                &this->polyBgId)) {
        this->unk_30C |= 0xA;
        return true;
    }
...
s32 func_80A6969C(EnMushi2* this, PlayState* play) {
    ...
    MM_Math_Vec3f_Sum(&sp38, &this->actor.world.pos, &posA);
...
void func_80A697C4(EnMushi2* this, PlayState* play) {
    ...
    if (this->unk_30C & 4) {
        MM_Math_Vec3f_Copy(&this->actor.world.pos, &this->unk_33C);
        ...
        MM_Math_Vec3f_Copy(&this->actor.world.pos, &this->actor.prevPos);
        MM_Math_Vec3f_Copy(&this->unk_33C, &this->actor.prevPos);
        this->poly = poly;
        this->polyBgId = bgId;
    }
}
...
void func_80A69ADC(Actor* thisx) {
    ...
    if (this->unk_358 < 1.0f) {
        ...
        sp40 = Math3D_PlaneF(this->unk_328.x, this->unk_328.y, this->unk_328.z,
                             ...
                             &bean->dyna.actor.world.pos);
        sp3C = MM_Math3D_Dist1D(sp44, sp40);

        if (fabsf(sp3C) > 0.1f) {
            this->unk_360 = (MM_Rand_ZeroOne() * 3000.0f * (this->unk_358 - 1.0f)) + (((sp40 / sp3C) - 1.0f) * -1500.0f);
            this->unk_364 = 0;
            if (MM_Rand_ZeroOne() < this->unk_358) {
                this->unk_366 = (sp44 >= 0.0f) ? 2000 : -2000;
            } else {
                this->unk_366 = ((s32)MM_Rand_Next() > 0) ? 2000 : -2000;
            }
            this->unk_366 += TRUNCF_BINANG(((MM_Rand_ZeroOne() * (1.0f - this->unk_358)) - 0.5f) * 0x400);
        } else {
            this->unk_360 = 0.0f;
            this->unk_364 = -0x8000;
            this->unk_366 = 0;
...
void func_80A69CE0(Actor* thisx) {
    ...
    this->unk_360 = MM_Rand_ZeroOne() * 1500.0f;
    this->unk_364 = 0;
...
void func_80A69D3C(EnMushi2* this) {
    ...
    if ((this->unk_34C != NULL) && (this->unk_358 > 0.999f)) {
        ...
        sp3C = Math3D_PlaneF(this->unk_328.x, this->unk_328.y, this->unk_328.z,
                             func_80A69AA8(this->unk_328.x, this->unk_328.y, this->unk_328.z, &this->actor.world.pos),
                             &this->unk_34C->dyna.actor.world.pos);
        sp38 = MM_Math3D_Dist1DSq(sp40, sp3C);
        ...
        func_80A68F9C(this, MM_Math_SinS(this->unk_364) * this->unk_360);
    }
}
...
void MM_func_80A69F5C(Actor* thisx, PlayState* play) {
    EnMushi2* this = (EnMushi2*)thisx;
    s32 i;

    for (i = 0; i < 7; i++) {
        MM_EffectSsBubble_Spawn(play, &this->actor.world.pos, -10.0f, 10.0f, 10.0f, (MM_Rand_ZeroOne() * 0.09f) + 0.05f);
    }
}
...
void EnMushi2_Init(Actor* thisx, PlayState* play) {
    ...
    this->actor.shape.rot.y += MM_Rand_S16Offset(-0x7D0, 0xFA0);
    ...
    this->unk_358 = 0.0f;
    this->unk_36A = MM_Rand_S16Offset(240, 40);
    this->unk_30C = 1;

    if (sp3C != 0) {
        MM_func_80A69F5C(&this->actor, play);
        this->actor.world.rot.y = MM_Rand_Next() >> 0x10;
        func_80A6AE14(this);
    } else {
        func_80A6A300(this);
    }
...
void func_80A6A300(EnMushi2* this) {
    ...
    this->unk_370 = MM_Rand_S16Offset(-1000, 2000);
...
void func_80A6A36C(EnMushi2* this, PlayState* play) {
    ...
    if ((this->actor.floorHeight < this->actor.world.pos.y) &&
        ...
        MM_Math_ScaledStepToS(&this->actor.shape.rot.x, 0, 0x1770);
        this->actor.shape.rot.z += MM_Rand_S16Offset(-2000, 4000);
    }
...
void func_80A6A508(Actor* thisx) {
    ...
    if (this->unk_36A > 100) {
        this->unk_35C = MM_Rand_ZeroOne() + 1.0f;
    } else {
        this->unk_35C = (MM_Rand_ZeroOne() * 0.8f) + 1.5f;
    }

    this->unk_368 = MM_Rand_S16Offset(10, 30);
    if (this->unk_34C == NULL) {
        func_80A69CE0(thisx);
    } else {
        func_80A69ADC(thisx);
...
void func_80A6A5C0(EnMushi2* this, PlayState* play) {
    ...
    func_80A69D3C(this);
    MM_Math_SmoothStepToF(&thisx->speed, this->unk_35C, 0.1f, 0.5f, 0.0f);
...
void func_80A6A794(EnMushi2* this) {
    if (this->unk_354 < SQ(40.0f)) {
        this->unk_368 = MM_Rand_S16Offset(2, 4);
    } else {
        this->unk_368 = MM_Rand_S16Offset(5, 10);
    }

    this->unk_35C = MM_Rand_ZeroOne() * 0.4f;
...
void func_80A6A824(EnMushi2* this, PlayState* play) {
    ...
    this->skelAnime.playSpeed = (MM_Rand_ZeroOne() * 0.8f) + (thisx->speed * 1.2f);
...
void func_80A6AAA4(EnMushi2* this) {
    ...
    this->unk_368 = MM_Rand_S16Offset(120, 50);
    this->unk_36E = 0;
    this->unk_370 = 0;
...
void func_80A6AB08(EnMushi2* this, PlayState* play) {
    ...
    Actor_MoveWithGravity(&this->actor);
    func_80A69424(this, play);
    MM_Math_StepToF(&this->actor.world.pos.y, this->actor.world.pos.y + this->actor.depthInWater, 2.8f);
    this->skelAnime.playSpeed = this->unk_368 * 0.018f;
    this->skelAnime.playSpeed = CLAMP(this->skelAnime.playSpeed, 0.1f, 1.9f);

    if (this->unk_368 > 80) {
        this->unk_36E += MM_Rand_S16Offset(-50, 100);
        this->unk_370 += MM_Rand_S16Offset(-300, 600);
    }
    ...
    MM_Math_ScaledStepToS(&this->actor.world.rot.z, 0, 0xBB8);
    this->actor.shape.rot.z = this->actor.world.rot.z;

    if ((this->actor.flags & ACTOR_FLAG_INSIDE_CULLING_VOLUME) && (MM_Rand_ZeroOne() < 0.03f)) {
        Vec3f sp3C;

        sp3C.x = this->actor.world.pos.x;
        sp3C.y = this->actor.world.pos.y + this->actor.depthInWater;
        sp3C.z = this->actor.world.pos.z;
        MM_EffectSsGRipple_Spawn(play, &sp3C, 40, 200, 4);
    }
...
void func_80A6AE7C(EnMushi2* this, PlayState* play) {
    ...
    this->actor.speed += (MM_Rand_ZeroOne() - 0.5f) * 0.16f;
    this->actor.speed *= 0.9f;
    this->actor.world.rot.y += TRUNCF_BINANG((MM_Rand_ZeroOne() - 0.5f) * 2000.0f);
    this->actor.gravity = -0.04f - (MM_Rand_ZeroOne() * 0.02f);
    this->actor.velocity.y *= 0.95f;
    Actor_MoveWithGravity(&this->actor);
    func_80A69424(this, play);
    temp_f2 = this->actor.scale.x - (1.0f / 20000.0f);
    MM_Actor_SetScale(&this->actor, CLAMP_MIN(temp_f2, 0.001f));
    if ((this->actor.flags & ACTOR_FLAG_INSIDE_CULLING_VOLUME) && (this->actor.depthInWater > 5.0f) &&
        (this->actor.depthInWater < 30.0f) && ((s32)(MM_Rand_Next() & 0x1FF) < this->unk_368)) {
        MM_EffectSsBubble_Spawn(play, &this->actor.world.pos, -5.0f, 5.0f, 5.0f,
                             ((MM_Rand_ZeroOne() * 4.0f) + 2.0f) * this->actor.scale.x);
    }
...
void func_80A6B0D8(EnMushi2* this, PlayState* play) {
    ...
    MM_Math_SmoothStepToF(&this->actor.speed, 0.0f, 0.4f, 1.2f, 0.0f);
    ...
    if ((this->actor.flags & ACTOR_FLAG_INSIDE_CULLING_VOLUME) && (this->unk_368 > 20) && (MM_Rand_ZeroOne() < 0.15f)) {
        Vec3f sp48;
        s32 sp44 = 0;
        ...
        func_800B0E48(play, &this->actor.world.pos, &sp48, &gZeroVec3f, &D_80A6B984[sp44], &D_80A6B98C[sp44],
                      (MM_Rand_ZeroOne() * 5.0f) + 8.0f, (MM_Rand_ZeroOne() * 5.0f) + 8.0f);
    }
...
void EnMushi2_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.update != NULL) {
        ...
        if (this->unk_34C != NULL) {
            ...
            this->unk_354 = MM_Math3D_Vec3fDistSq(&this->actor.world.pos, &this->unk_34C->dyna.actor.world.pos);
            if (this->unk_354 < this->unk_350) {
                f32 dist = MM_Math3D_DistPlaneToPos(COLPOLY_GET_NORMAL(this->unk_34C->dyna.actor.floorPoly->normal.x),
            ...
            MM_Math_StepToF(&this->unk_348, sp4C, 0.7f);
        }
