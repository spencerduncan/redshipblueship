...
void BgHakuginSwitch_Init(Actor* thisx, PlayState* play) {
    ...
    if (MM_Flags_GetSwitch(play, BGHAKUGINSWITCH_GET_SWITCH_FLAG(&this->dyna.actor))) {
        sp30 = true;
    } else {
        sp30 = false;
    }
    ...
    if (!BGHAKUGINSWITCH_GET_10(&this->dyna.actor)) {
        MM_Actor_ProcessInitChain(&this->dyna.actor, MM_sInitChain1);
        ...
        MM_Actor_ProcessInitChain(&this->dyna.actor, MM_sInitChain2);
...
void func_80B15B74(BgHakuginSwitch* this, PlayState* play) {
    ...
    if (sp24) {
        if (sp20 == 1) {
            MM_Flags_SetSwitch(play, BGHAKUGINSWITCH_GET_SWITCH_FLAG(&this->dyna.actor));
        } else if (sp20 == 0) {
            MM_Flags_UnsetSwitch(play, BGHAKUGINSWITCH_GET_SWITCH_FLAG(&this->dyna.actor));
        }
...
void func_80B15E78(BgHakuginSwitch* this, PlayState* play) {
    ...
    if (MM_Math_StepToF(&this->dyna.actor.world.pos.y, sp20->unk_4 + this->dyna.actor.home.pos.y, sp20->unk_C)) {
        if (MM_DynaPolyActor_IsPlayerOnTop(&this->dyna)) {
...
void func_80B160DC(BgHakuginSwitch* this, PlayState* play) {
    ...
    if (MM_Math_StepToF(&this->dyna.actor.world.pos.y, sp18->unk_0 + this->dyna.actor.home.pos.y, sp18->unk_8)) {
        func_80B15B1C(this, play);
...
void func_80B16244(BgHakuginSwitch* this, PlayState* play) {
    ...
    if ((BGHAKUGINSWITCH_GET_7(&this->dyna.actor) == BGHAKUGINSWITCH_GET_7_1) &&
        ...
        MM_Actor_ChangeCategory(play, &play->actorCtx, &this->dyna.actor, ACTORCAT_SWITCH);
    }
...
void func_80B16400(BgHakuginSwitch* this, PlayState* play) {
    if (MM_Math_StepToF(&this->dyna.actor.world.pos.y,
...
void func_80B165E0(BgHakuginSwitch* this, PlayState* play) {
    if (MM_Math_StepToF(&this->dyna.actor.world.pos.y, this->dyna.actor.home.pos.y, 6.0f)) {
        func_80B16244(this, play);
    }
}
...
void BgHakuginSwitch_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_1C0 != 0) {
        ...
        MM_Math_StepToF(&this->dyna.actor.shape.yOffset, 0.0f, 2.0f * this->unk_1C8);
        this->unk_1C4 = 0.0f;
    }
}
...
void BgHakuginSwitch_Draw(Actor* thisx, PlayState* play) {
    ...
    MM_Gfx_DrawDListOpa(play, this->unk_1A8);
}
