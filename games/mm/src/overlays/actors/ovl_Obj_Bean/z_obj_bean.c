...
void MM_ObjBean_Init(Actor* thisx, PlayState* play);
void MM_ObjBean_Destroy(Actor* thisx, PlayState* play);
void MM_ObjBean_Update(Actor* thisx, PlayState* play);
...
void func_80936CF0(ObjBean* this, PlayState* play) {
    ...
    this->dyna.actor.floorHeight =
        MM_BgCheck_EntityRaycastFloor5(&play->colCtx, &this->dyna.actor.floorPoly, &bgId, &this->dyna.actor, &sp24);
}
...
s32 func_80936D58(ObjBean* this, PlayState* play) {
    ...
    MM_Matrix_MultVec3f(&D_80939018, &spAC);
    MM_Math_Vec3f_Sum(&this->dyna.actor.world.pos, &spAC, &spA0);
    MM_Math_Vec3f_Diff(&this->dyna.actor.world.pos, &spAC, &sp94);

    if (MM_BgCheck_EntityLineTest2(&play->colCtx, &spA0, &sp94, &sp88, &this->dyna.actor.floorPoly, true, true, true, true,
...
void func_80936F24(ObjBean* this) {
    ...
    this->unk_1AE += 0xFB;
    this->unk_1B0 += 0x64;
    MM_Math_StepToF(&this->unk_1C8, 2.0f, 0.1f);
    this->unk_1CC = (MM_Math_SinS(this->unk_1AC * 3) + MM_Math_SinS(this->unk_1AE * 3)) * this->unk_1C8;
    this->unk_1D0 = (MM_Math_CosS(this->unk_1AC * 4) + MM_Math_CosS(this->unk_1AE * 4)) * this->unk_1C8;
    this->dyna.actor.scale.z =
        ((MM_Math_SinS(this->unk_1B0 * 5) * 0.06f) + (MM_Math_SinS(this->unk_1AE * 8) * 0.01f) + 1.07f) * 0.1f;
    this->dyna.actor.scale.x = this->dyna.actor.scale.z;
    this->dyna.actor.scale.y = ((MM_Math_CosS(this->unk_1B0 * 10) * 0.2f) + 1.0f) * 0.1f;
    this->dyna.actor.shape.rot.y = (this->dyna.actor.home.rot.y + (s32)(MM_Math_SinS(this->unk_1AC * 3) * 1000.0f)) +
                                   (s32)(MM_Math_SinS(this->unk_1B0 * 2) * 2100.0f);
}
...
void func_80937160(ObjBean* this) {
    ...
    this->dyna.actor.scale.y = MM_Math_SinS(this->unk_1AC) * 0.16970563f;
    this->dyna.actor.scale.x = this->dyna.actor.scale.z = MM_Math_SinS(this->unk_1AE) * 0.10700001f;
    MM_Math_StepToF(&this->unk_1CC, 0.0f, 0.1f);
    MM_Math_StepToF(&this->unk_1D0, 0.0f, 0.1f);
    MM_Math_ScaledStepToS(&this->dyna.actor.shape.rot.y, this->dyna.actor.home.rot.y, 0x64);
}
...
void func_809372A8(ObjBean* this) {
    MM_Math_Vec3s_ToVec3f(&this->unk_1BC, this->pathPoints);
}
...
void func_809372D0(ObjBean* this) {
    ...
    MM_Math_Vec3s_ToVec3f(&sp38, &this->pathPoints[this->unk_1DC]);
    MM_Math_Vec3f_Diff(&sp38, &this->unk_1BC, &actor->velocity);

    sp34 = MM_Math3D_Vec3fMagnitude(&actor->velocity);
    ...
    MM_Math_StepToF(&actor->speed, temp_f2, temp_f12);

    if ((actor->speed + 0.05f) < sp34) {
        MM_Math_Vec3f_Scale(&actor->velocity, actor->speed / sp34);
        this->unk_1BC.x += actor->velocity.x;
        this->unk_1BC.y += actor->velocity.y;
        this->unk_1BC.z += actor->velocity.z;
    } else {
        MM_Math_Vec3f_Copy(&this->unk_1BC, &sp38);
...
s32 func_80937468(ObjBean* this, PlayState* play) {
    ...
    while (bgActor != NULL) {
        if ((bgActor->id == ACTOR_EN_HORSE) &&
            (MM_Math3D_Vec3fDistSq(&bgActor->world.pos, &this->dyna.actor.world.pos) < SQ(100.0f))) {
            return true;
        }
    ...
    while (bgActor != NULL) {
        if (bgActor->id == ACTOR_OBJ_BEAN) {
            ...
            if (!params2 && (bgActor->room == this->dyna.actor.room) && !OBJBEAN_GET_80(bgActor) &&
                ...
                (MM_Math3D_Vec3fDistSq(&bgActor->world.pos, &this->dyna.actor.world.pos) < SQ(10.0f))) {
                break;
            }
        }
        bgActor = bgActor->next;
...
void func_809375F4(ObjBean* this, PlayState* play) {
    ...
    for (i = 0; i < 36; i++) {
        temp_s1 += 0x4E20;
        temp_f20 = MM_Rand_ZeroOne() * 60.0f;

        spC4.x = (MM_Math_SinS(temp_s1) * temp_f20) + this->dyna.actor.world.pos.x;
        spC4.y = this->dyna.actor.world.pos.y;
        spC4.z = (MM_Math_CosS(temp_s1) * temp_f20) + this->dyna.actor.world.pos.z;

        spB8.x = MM_Math_SinS(temp_s1) * 3.5f;
        spB8.y = MM_Rand_ZeroOne() * 13.0f;
        spB8.z = MM_Math_CosS(temp_s1) * 3.5f;
        ...
        temp_s2 = (s32)(MM_Rand_ZeroOne() * 180.0f) + 30;
        ...
        MM_EffectSsKakera_Spawn(play, &spC4, &spB8, &spC4, phi_s3, phi_v0, 40, 3, 0, temp_s2, 0, 0, (temp_s2 >> 3) + 40,
...
void MM_ObjBean_Init(Actor* thisx, PlayState* play) {
    ...
    if ((sp2C == ENOBJBEAN_GET_C000_1) || (sp2C == ENOBJBEAN_GET_C000_2)) {
        ...
        if (sp2C == ENOBJBEAN_GET_C000_1) {
            MM_Collider_SetCylinder(play, &this->collider, &this->dyna.actor, &MM_sCylinderInit2);
        ...
        MM_Actor_ChangeCategory(play, &play->actorCtx, &this->dyna.actor, ACTORCAT_ITEMACTION);
        func_80937DD8(this);
    } else {
        ...
        MM_Collider_SetCylinder(play, &this->collider, &this->dyna.actor, &MM_sCylinderInit1);
        MM_Collider_UpdateCylinder(&this->dyna.actor, &this->collider);
        ...
        func_809372A8(this);
        func_80937238(this);
        MM_ActorShape_Init(&this->dyna.actor.shape, 0.0f, MM_ActorShadow_DrawCircle, 8.8f);
        func_80936CF0(this, play);

        if (!OBJBEAN_GET_80(&this->dyna.actor) &&
            MM_Flags_GetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_1(&this->dyna.actor, 0)) &&
            !MM_Flags_GetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_1(&this->dyna.actor, 1)) && func_800FE9B4(play)) {
            MM_Flags_SetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_1(&this->dyna.actor, 1));
        }

        if (OBJBEAN_GET_80(&this->dyna.actor) ||
            MM_Flags_GetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_1(&this->dyna.actor, 1))) {
            func_80938804(this);
        } else {
...
void func_80937B54(ObjBean* this) {
    MM_Math_StepToS(&this->unk_1EE, this->unk_1F0, this->unk_1F2);
    MM_Math_StepToS(&this->unk_1F4, this->unk_1F6, this->unk_1F8);
    this->unk_1FA += this->unk_1F4;
    this->unk_1FC = 6372.0f - (MM_Math_SinS(this->unk_1FA) * this->unk_1EE);
    this->dyna.actor.scale.y = MM_Math_SinS(this->unk_1FC) * 0.17434467f;
    this->dyna.actor.scale.x = this->dyna.actor.scale.z = MM_Math_CosS(this->unk_1FC) * 0.12207746f;
}
...
void func_80937C30(ObjBean* this) {
    ...
    this->unk_1EC = MM_Rand_S16Offset(12, 40);
    this->unk_1F0 = MM_Rand_S16Offset(200, 400);
    this->unk_1F2 = 20;
    this->unk_1F6 = MM_Rand_S16Offset(100, 800);
    this->unk_1F8 = 20;
}
...
void func_80937CE4(ObjBean* this) {
    ...
    this->unk_1EC = MM_Rand_S16Offset(30, 4);
    this->unk_1F0 = MM_Rand_S16Offset(2000, 1000);
    this->unk_1F2 = 200;
    this->unk_1F6 = MM_Rand_S16Offset(14000, 6000);
    this->unk_1F8 = 4000;
}
...
void func_80937D54(ObjBean* this) {
    ...
    if (this->unk_1EC == 14) {
        this->unk_1F0 = MM_Rand_S16Offset(200, 400);
        this->unk_1F6 = MM_Rand_S16Offset(100, 500);
        this->unk_1F8 = 2000;
    }
...
void func_80937DEC(ObjBean* this, PlayState* play) {
    ...
    if (this->unk_1FF && !MM_Flags_GetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_2(&this->dyna.actor, 1)) &&
        MM_Flags_GetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_2(&this->dyna.actor, 0)) && func_800FE9B4(play)) {
        MM_Flags_SetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_2(&this->dyna.actor, 1));
    }
    ...
    if (this->unk_1FF && MM_Flags_GetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_2(&this->dyna.actor, 0))) {
        this->unk_1FE |= 5;
        func_80937C30(this);
    } else {
        this->unk_1FE |= 1;
    ...
    if (MM_Flags_GetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_1(&this->dyna.actor, 0))) {
        this->unk_1E4 = 5;
    } else {
        this->unk_1E4 = 0;
    }
...
void func_80937FC8(ObjBean* this, PlayState* play) {
    ...
    if (Actor_TalkOfferAccepted(&this->dyna.actor, &play->state)) {
        if (Player_GetExchangeItemAction(play) == PLAYER_IA_MAGIC_BEANS) {
            func_809383B4(this);
            MM_Flags_SetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_2(&this->dyna.actor, 0));
        }
...
void func_80938298(ObjBean* this, PlayState* play) {
    ...
    if (this->unk_1E0 >= 3) {
        this->unk_1E4 = 3;
        MM_Flags_SetSwitch(play, OBJBEAN_GET_SWITCH_FLAG_1(&this->dyna.actor, 0));
        this->unk_1E4 = 5;
        func_8093833C(this);
    } else if (this->unk_1E4 == 4) {
        CutsceneManager_Stop(this->dyna.actor.csId);
...
void func_80938444(ObjBean* this, PlayState* play) {
    s32 pad;
    s32 sp20 = MM_Math_StepToF(&this->dyna.actor.scale.y, 0.16672663f, 0.01f) & 1;

    sp20 &= MM_Math_StepToF(&this->dyna.actor.scale.x, 0.03569199f, 0.00113f);
...
void func_80938504(ObjBean* this, PlayState* play) {
    this->unk_1AC -= 2400;
    this->dyna.actor.scale.y = MM_Math_SinS(this->unk_1AC) * 0.17434467f;
    this->dyna.actor.scale.x = this->dyna.actor.scale.z = MM_Math_CosS(this->unk_1AC) * 0.12207746f;
...
void func_809385A8(ObjBean* this, PlayState* play) {
    ...
    this->unk_1AC += 16000;
    this->unk_1AE -= 200;
    sp22 = 6372.0f - (MM_Math_SinS(this->unk_1AC) * this->unk_1AE);
    this->dyna.actor.scale.y = MM_Math_SinS(sp22) * 0.17434467f;
    this->dyna.actor.scale.x = this->dyna.actor.scale.z = MM_Math_CosS(sp22) * 0.12207746f;
    if (this->unk_1AE < 0) {
        func_80937C30(this);
        func_80937FB0(this);
    }
...
void func_809388A8(ObjBean* this, PlayState* play) {
    ...
    if (this->unk_1DA == this->unk_1D8) {
        ...
        func_809372A8(this);
        func_8093892C(this);
    } else if (MM_DynaPolyActor_IsPlayerOnTop(&this->dyna)) {
...
void func_80938958(ObjBean* this, PlayState* play) {
    if (!MM_DynaPolyActor_IsPlayerAbove(&this->dyna)) {
        func_80938804(this);
    }
    func_80936F24(this);
}
...
void func_80938AD8(ObjBean* this, PlayState* play) {
    ...
    if (this->dyna.actor.xzDistToPlayer < 74.0f) {
        ...
        sin = MM_Math_SinS(this->dyna.actor.yawTowardsPlayer) * sp28;
        cos = MM_Math_CosS(this->dyna.actor.yawTowardsPlayer) * sp28;
...
void MM_ObjBean_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->dyna.actor.draw != NULL) {
        ...
        func_80936CF0(this, play);
        this->dyna.actor.shape.shadowDraw = MM_ActorShadow_DrawCircle;
    ...
    MM_Actor_SetFocus(&this->dyna.actor, 6.0f);
}
...
void func_80938F50(Actor* thisx, PlayState* play) {
    ...
    MM_Gfx_DrawDListXlu(play, object_mamenoki_DL_002208);
}
