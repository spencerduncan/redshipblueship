...
static AnimationInfoS MM_sAnimationInfo[ENSCOPENUTS_ANIM_MAX] = {
...
void func_80BCAC40(EnScopenuts* this, PlayState* play) {
    ...
    for (i = 0; i < 36; i++) {
        sp54.x = MM_Rand_Centered() * 10.0f;
        sp54.y = 2.0f * MM_Rand_Centered();
        sp54.z = MM_Rand_Centered() * 10.0f;
        MM_EffectSsHahen_Spawn(play, &sp60, &sp54, &D_80BCCCE4, 0, 150, GAMEPLAY_KEEP, 16, D_80BCCCDC[i & 1]);
    }
}
...
void func_80BCAFA8(EnScopenuts* this, PlayState* play) {
    ...
    if ((screenPos.x >= 130.0f) && (screenPos.x < (SCREEN_WIDTH - 130.0f)) && (screenPos.y >= 90.0f)) {
        if (screenPos.y < (SCREEN_HEIGHT - 90.0f)) {
            ...
            SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_10);
...
void func_80BCB078(EnScopenuts* this, PlayState* play) {
    ...
    if (this->path != NULL) {
        ...
        MM_Math_SmoothStepToS(&this->actor.world.rot.y, sp30.y, 10, 0x12C, 0);
...
void func_80BCB1C8(EnScopenuts* this, PlayState* play) {
    this->unk_350 *= 0.92f;
    MM_Actor_SetScale(&this->actor, this->unk_350);
...
void func_80BCB230(EnScopenuts* this, PlayState* play) {
    ...
    if ((((this->actor.playerHeightRel < 50.0f) && (this->actor.playerHeightRel > -50.0f)) ? true : false) &&
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_3);
        ...
        if ((this->animIndex == ENSCOPENUTS_ANIM_4) || (this->animIndex == ENSCOPENUTS_ANIM_18)) {
            ...
            SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_17);
        } else if (this->animIndex == ENSCOPENUTS_ANIM_2) {
            this->animIndex = ENSCOPENUTS_ANIM_16;
            this->collider.dim.height = 32;
            Actor_PlaySfx(&this->actor, NA_SE_EN_NUTS_UP);
            SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_16);
            ...
            if (DECR(this->unk_34E) == 0) {
                ...
                this->collider.dim.height = 32;
                SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_2);
            }
            ...
            this->collider.dim.height = 32;
            SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_18);
        }
    }
}
...
void func_80BCB4DC(EnScopenuts* this, PlayState* play) {
    if (this->skelAnime.curFrame == this->skelAnime.endFrame) {
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_0);
    }
}
...
void func_80BCB52C(EnScopenuts* this, PlayState* play) {
    ...
    if (Actor_TalkOfferAccepted(&this->actor, &play->state)) {
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_4);
    ...
    if (talkState == TEXT_STATE_EVENT) {
        if (MM_Message_ShouldAdvance(play)) {
            if (this->unk_328 & 1) {
                ...
                SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_8);
            ...
            switch (play->msgCtx.choiceIndex) {
                case 0:
                    if (gSaveContext.save.saveInfo.playerData.rupees < this->unk_358) {
                        ...
                        play->msgCtx.msgMode = MSGMODE_TEXT_CLOSING;
                        play->msgCtx.stateTimer = 4;
                        MM_Rupees_ChangeBy(-this->unk_358);
...
void func_80BCBA00(EnScopenuts* this, PlayState* play) {
    ...
    if (curFrame == endFrame) {
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_19);
        Actor_PlaySfx(&this->actor, NA_SE_EN_NUTS_DOWN);
        this->unk_328 &= ~2;
        this->unk_34E = 50;
        this->unk_328 |= 8;
...
void func_80BCBD28(EnScopenuts* this, PlayState* play) {
    ...
    if (curFrame == endFrame) {
        MM_Math_SmoothStepToS(&this->unk_34C, 0x1C71, 3, 0x100, 0);
        this->unk_340 += this->unk_34C;
        this->actor.shape.yOffset = 1500.0f;
    }

    MM_Math_SmoothStepToS(&this->actor.shape.rot.y, this->unk_372, 3, 0x7D0, 0);
    this->actor.world.rot.y = this->actor.shape.rot.y;
    ...
    if ((this->actor.home.pos.y + 22.5f) < this->actor.world.pos.y) {
        ...
        SubS_ChangeAnimationByInfoS(&this->skelAnime, MM_sAnimationInfo, ENSCOPENUTS_ANIM_9);
        Actor_PlaySfx(&this->actor, NA_SE_EN_AKINDONUTS_HIDE);
        func_80BCAC40(this, play);
...
void func_80BCBFFC(EnScopenuts* this, PlayState* play) {
    ...
    if (this->path != NULL) {
        ...
        if (this->unk_334 < 6) {
            ...
            MM_Math_SmoothStepToS(&this->actor.world.rot.y, sp38.y, 10, 0x5DC, 0);
        }
...
void EnScopenuts_TransformLimbDraw(PlayState* play, s32 limbIndex, Actor* thisx) {
    ...
    if (((this->unk_35A == 1) || (this->unk_35A == 2)) &&
        ...
        MM_Matrix_Scale(this->unk_35C, this->unk_360, this->unk_364, MTXMODE_APPLY);
    }
    ...
    if ((this->animIndex == ENSCOPENUTS_ANIM_9) &&
        ((limbIndex == BUSINESS_SCRUB_LIMB_RIGHT_HAND_BAG) || (limbIndex == BUSINESS_SCRUB_LIMB_LEFT_HAND_BAG) ||
         (limbIndex == BUSINESS_SCRUB_LIMB_LEFT_ARM_BAG))) {
        MM_Matrix_Scale(this->unk_368, this->unk_368, this->unk_368, MTXMODE_APPLY);
    }
