...
void __osDevMgrMain(void* arg) {
    ...
    while (true) {
        MM_osRecvMesg(devMgr->cmdQueue, (OSMesg*)&ioMesg, OS_MESG_BLOCK);
        ...
        readblock1:
            ...
            MM_osSendMesg(ioMesg->hdr.retQueue, (OSMesg)ioMesg, OS_MESG_NOBLOCK);
            ...
            MM_osSendMesg(devMgr->acsQueue, NULL, OS_MESG_NOBLOCK);
            ...
            switch (ioMesg->hdr.type) {
                ...
                case 16:
                    ...
                    break;
                case 10:
                    MM_osSendMesg(ioMesg->hdr.retQueue, ioMesg, OS_MESG_NOBLOCK);
                    ret = -1;
                    break;
                default:
                    ret = -1;
