 ...
 *
 * MM_DEFINE_OBJECT_UNSET and DEFINE_OBJECT_SIZE_ZERO are needed to define empty entries from the original game
 * 
 * MM_DEFINE_OBJECT_UNSET is used to declare a placeholder enum value which maps to an entry with MM_zeroes in `MM_gObjectTable`
 *    - Argument 0: Enum value for this object
 * 
 * DEFINE_OBJECT_SIZE_ZERO is used to declare a placeholder enum value which maps to a MM_zero-size entry in `MM_gObjectTable`, with no corresponding segment in the rom.
 *    - Argument 0: Name of the object segment in spec
 *    - Argument 1: Enum value for this object
 */
/* 0x000 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_0)
...
/* 0x01B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_1B)
/* 0x01C */ DEFINE_OBJECT(object_test3, OBJECT_TEST3)
/* 0x01D */ DEFINE_OBJECT(object_famos, OBJECT_FAMOS)
/* 0x01E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_1E)
/* 0x01F */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_1F)
/* 0x020 */ DEFINE_OBJECT(object_st, OBJECT_ST)
/* 0x021 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_21)
/* 0x022 */ DEFINE_OBJECT(object_thiefbird, OBJECT_THIEFBIRD)
/* 0x023 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_23)
/* 0x024 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_24)
/* 0x025 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_25)
/* 0x026 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_26)
/* 0x027 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_27)
/* 0x028 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_28)
/* 0x029 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_29)
/* 0x02A */ DEFINE_OBJECT(object_bombf, OBJECT_BOMBF)
/* 0x02B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_2B)
/* 0x02C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_2C)
/* 0x02D */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_2D)
/* 0x02E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_2E)
/* 0x02F */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_2F)
/* 0x030 */ DEFINE_OBJECT(object_am, OBJECT_AM)
/* 0x031 */ DEFINE_OBJECT(object_dekubaba, OBJECT_DEKUBABA)
/* 0x032 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_32)
/* 0x033 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_33)
/* 0x034 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_34)
/* 0x035 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_35)
/* 0x036 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_36)
/* 0x037 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_37)
/* 0x038 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_38)
/* 0x039 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_39)
/* 0x03A */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_3A)
/* 0x03B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_3B)
/* 0x03C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_3C)
/* 0x03D */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_3D)
...
/* 0x041 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_41)
/* 0x042 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_42)
/* 0x043 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_43)
/* 0x044 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_44)
/* 0x045 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_45)
/* 0x046 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_46)
/* 0x047 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_47)
/* 0x048 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_48)
/* 0x049 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_49)
/* 0x04A */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_4A)
/* 0x04B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_4B)
/* 0x04C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_4C)
/* 0x04D */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_4D)
/* 0x04E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_4E)
/* 0x04F */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_4F)
/* 0x050 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_50)
/* 0x051 */ DEFINE_OBJECT(object_bb, OBJECT_BB)
/* 0x052 */ DEFINE_OBJECT(object_death, OBJECT_DEATH)
/* 0x053 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_53)
/* 0x054 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_54)
/* 0x055 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_55)
/* 0x056 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_56)
/* 0x057 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_57)
/* 0x058 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_58)
/* 0x059 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_59)
/* 0x05A */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_5A)
/* 0x05B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_5B)
/* 0x05C */ DEFINE_OBJECT(object_f40_obj, OBJECT_F40_OBJ)
/* 0x05D */ DEFINE_OBJECT(object_po_composer, OBJECT_PO_COMPOSER)
/* 0x05E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_5E)
/* 0x05F */ DEFINE_OBJECT(object_hata, OBJECT_HATA)
/* 0x060 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_60)
/* 0x061 */ DEFINE_OBJECT(object_wood02, OBJECT_WOOD02)
/* 0x062 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_62)
/* 0x063 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_63)
/* 0x064 */ DEFINE_OBJECT(object_trap, OBJECT_TRAP)
/* 0x065 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_65)
/* 0x066 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_66)
/* 0x067 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_67)
/* 0x068 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_68)
/* 0x069 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_69)
/* 0x06A */ DEFINE_OBJECT(object_vm, OBJECT_VM)
/* 0x06B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_6B)
/* 0x06C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_6C)
/* 0x06D */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_6D)
/* 0x06E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_6E)
/* 0x06F */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_6F)
/* 0x070 */ DEFINE_OBJECT(object_efc_star_field, OBJECT_EFC_STAR_FIELD)
/* 0x071 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_71)
/* 0x072 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_72)
/* 0x073 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_73)
/* 0x074 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_74)
/* 0x075 */ DEFINE_OBJECT(object_rd, OBJECT_RD)
/* 0x076 */ DEFINE_OBJECT(object_yukimura_obj, OBJECT_YUKIMURA_OBJ)
/* 0x077 */ MM_DEFINE_OBJECT_UNSET(OBJECT_HEAVY_OBJECT)
/* 0x078 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_78)
/* 0x079 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_79)
/* 0x07A */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_7A)
/* 0x07B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_7B)
/* 0x07C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_7C)
/* 0x07D */ DEFINE_OBJECT(object_horse_link_child, OBJECT_HORSE_LINK_CHILD)
/* 0x07E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_7E)
/* 0x07F */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_7F)
/* 0x080 */ DEFINE_OBJECT(object_syokudai, OBJECT_SYOKUDAI)
/* 0x081 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_81)
/* 0x082 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_82)
/* 0x083 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_83)
/* 0x084 */ DEFINE_OBJECT(object_efc_tw, OBJECT_EFC_TW)
/* 0x085 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_85)
...
/* 0x089 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_89)
/* 0x08A */ DEFINE_OBJECT(object_bdoor, OBJECT_BDOOR)
/* 0x08B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_8B)
/* 0x08C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_8C)
/* 0x08D */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_8D)
...
/* 0x093 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_93)
/* 0x094 */ DEFINE_OBJECT(object_gi_nuts, OBJECT_GI_NUTS)
/* 0x095 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_95)
...
/* 0x09A */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_9A)
/* 0x09B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_9B)
/* 0x09C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_9C)
...
/* 0x0A3 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_A3)
/* 0x0A4 */ DEFINE_OBJECT(object_gi_magicpot, OBJECT_GI_MAGICPOT)
/* 0x0A5 */ DEFINE_OBJECT(object_gi_bomb_1, OBJECT_GI_BOMB_1)
/* 0x0A6 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_A6)
/* 0x0A7 */ DEFINE_OBJECT(object_ma2, OBJECT_MA2)
/* 0x0A8 */ DEFINE_OBJECT(object_gi_purse, OBJECT_GI_PURSE)
/* 0x0A9 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_A9)
/* 0x0AA */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_AA)
/* 0x0AB */ DEFINE_OBJECT(object_rr, OBJECT_RR)
/* 0x0AC */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_AC)
/* 0x0AD */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_AD)
/* 0x0AE */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_AE)
/* 0x0AF */ DEFINE_OBJECT(object_gi_arrow, OBJECT_GI_ARROW)
/* 0x0B0 */ DEFINE_OBJECT(object_gi_bomb_2, OBJECT_GI_BOMB_2)
/* 0x0B1 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_B1)
/* 0x0B2 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_B2)
...
/* 0x0B8 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_B8)
/* 0x0B9 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_B9)
/* 0x0BA */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_BA)
/* 0x0BB */ DEFINE_OBJECT(object_ny, OBJECT_NY)
/* 0x0BC */ DEFINE_OBJECT(object_fr, OBJECT_FR)
/* 0x0BD */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_BD)
/* 0x0BE */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_BE)
...
/* 0x0C4 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_C4)
/* 0x0C5 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_C5)
/* 0x0C6 */ DEFINE_OBJECT(object_gi_bean, OBJECT_GI_BEAN)
/* 0x0C7 */ DEFINE_OBJECT(object_gi_fish, OBJECT_GI_FISH)
/* 0x0C8 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_C8)
/* 0x0C9 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_C9)
/* 0x0CA */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_CA)
/* 0x0CB */ DEFINE_OBJECT(object_gi_longsword, OBJECT_GI_LONGSWORD)
/* 0x0CC */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_CC)
/* 0x0CD */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_CD)
/* 0x0CE */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_CE)
/* 0x0CF */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_CF)
/* 0x0D0 */ DEFINE_OBJECT(object_zo, OBJECT_ZO)
/* 0x0D1 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_D1)
/* 0x0D2 */ DEFINE_OBJECT(object_umajump, OBJECT_UMAJUMP)
/* 0x0D3 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_D3)
/* 0x0D4 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_D4)
...
/* 0x0DB */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_DB)
/* 0x0DC */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_DC)
...
/* 0x0E1 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_E1)
...
/* 0x0E8 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_E8)
/* 0x0E9 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_E9)
/* 0x0EA */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_EA)
/* 0x0EB */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_EB)
...
/* 0x0F6 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_F6)
...
/* 0x0FA */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_FA)
/* 0x0FB */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_FB)
...
/* 0x101 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_101)
...
/* 0x105 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_105)
/* 0x106 */ DEFINE_OBJECT(object_stream, OBJECT_STREAM)
/* 0x107 */ DEFINE_OBJECT(object_mm, OBJECT_MM)
/* 0x108 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_108)
/* 0x109 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_109)
/* 0x10A */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_10A)
/* 0x10B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_10B)
/* 0x10C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_10C)
/* 0x10D */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_10D)
/* 0x10E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_10E)
/* 0x10F */ DEFINE_OBJECT(object_js, OBJECT_JS)
/* 0x110 */ DEFINE_OBJECT(object_cs, OBJECT_CS)
/* 0x111 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_111)
/* 0x112 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_112)
/* 0x113 */ DEFINE_OBJECT(object_gi_soldout, OBJECT_GI_SOLDOUT)
/* 0x114 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_114)
/* 0x115 */ DEFINE_OBJECT(object_mag, OBJECT_MAG)
/* 0x116 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_116)
/* 0x117 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_117)
/* 0x118 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_118)
/* 0x119 */ DEFINE_OBJECT(object_gi_golonmask, OBJECT_GI_GOLONMASK)
/* 0x11A */ DEFINE_OBJECT(object_gi_zoramask, OBJECT_GI_ZORAMASK)
/* 0x11B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_11B)
/* 0x11C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_11C)
/* 0x11D */ DEFINE_OBJECT(object_ka, OBJECT_KA)
/* 0x11E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_11E)
/* 0x11F */ DEFINE_OBJECT(object_zg, OBJECT_ZG)
/* 0x120 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_120)
/* 0x121 */ DEFINE_OBJECT(object_gi_m_arrow, OBJECT_GI_M_ARROW)
/* 0x122 */ DEFINE_OBJECT(object_ds2, OBJECT_DS2)
/* 0x123 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_123)
/* 0x124 */ DEFINE_OBJECT(object_fish, OBJECT_FISH)
/* 0x125 */ DEFINE_OBJECT(object_gi_sutaru, OBJECT_GI_SUTARU)
/* 0x126 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_126)
...
/* 0x12D */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_12D)
/* 0x12E */ DEFINE_OBJECT(object_gla, OBJECT_GLA)
/* 0x12F */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_12F)
/* 0x130 */ DEFINE_OBJECT(object_geldb, OBJECT_GELDB)
/* 0x131 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_131)
...
/* 0x136 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_136)
/* 0x137 */ DEFINE_OBJECT(object_gi_insect, OBJECT_GI_INSECT)
/* 0x138 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_138)
/* 0x139 */ DEFINE_OBJECT(object_gi_ghost, OBJECT_GI_GHOST)
/* 0x13A */ DEFINE_OBJECT(object_gi_soul, OBJECT_GI_SOUL)
/* 0x13B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_13B)
/* 0x13C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_13C)
/* 0x13D */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_13D)
/* 0x13E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_13E)
...
/* 0x147 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_147)
/* 0x148 */ DEFINE_OBJECT(object_gi_sword_1, OBJECT_GI_SWORD_1)
/* 0x149 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_149)
/* 0x14A */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_14A)
...
/* 0x150 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_150)
/* 0x151 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_151)
/* 0x152 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_152)
...
/* 0x159 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_159)
...
/* 0x168 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_168)
...
/* 0x16E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_16E)
...
/* 0x177 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_177)
...
/* 0x17B */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_17B)
/* 0x17C */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_17C)
/* 0x17D */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_17D)
...
/* 0x183 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_183)
...
/* 0x193 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_193)
/* 0x194 */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_194)
...
/* 0x22D */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_22D)
/* 0x22E */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_22E)
/* 0x22F */ MM_DEFINE_OBJECT_UNSET(OBJECT_UNSET_22F)
