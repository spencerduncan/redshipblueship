...
s32 MM_osJamMesg(OSMesgQueue* mq, OSMesg msg, s32 flag);
s32 MM_osRecvMesg(OSMesgQueue* mq, OSMesg* msg, s32 flags);

void MM_osSetEventMesg(OSEvent e, OSMesgQueue* mq, OSMesg m);
