...
| P8 | O6 tooling: the static negation probe and the CI grow-check | O6 (`:673`) | baseline is clean in both dialects (§1.2, §2.3); nothing locks it -- IN FLIGHT (wave 5, lane K8): the CI grow-check over both engines and the static negation probe; starts after the multiplicity contract (lane K4) merges |
